...
declare global {
    interface Window {
        __PAWSCORD_API_BASE__?: string;
        require?: (module: string) => unknown;
    }
}

declare const process: { versions?: { electron?: string } } | undefined;
...
// 🔥 NEW: Media files for ayrı URL (her zaman production)
...
export const GOOGLE_WEB_CLIENT_ID =
    ...
    '774757987258-poa0elqqapnab8eud3tol3h2pilcqe71.apps.googleusercontent.com';
