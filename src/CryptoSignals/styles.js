...
const S = {
    ...
    fileTabBtnBoss: {
        background: 'linear-gradient(135deg, #f0b232 0%, #da373c 50%, #f0b232 100%)',
        borderColor: '#f0b232',
        color: '#fff',
        animation: 'boss-glow 2s ease-in-out infinite alternate',
        textShadow: '0 0 8px rgba(240,178,50,0.6)',
    },
    fileTabBtnBossActive: {
        background: 'linear-gradient(135deg, #f0b232 0%, #da373c 50%, #f0b232 100%)',
        borderColor: '#fff',
        color: '#fff',
        boxShadow: '0 4px 20px rgba(240,178,50,0.5), 0 0 30px rgba(218,55,60,0.3)',
        textShadow: '0 0 10px rgba(240,178,50,0.8)',
    },
    modeBtn: {
        flex: 1,
        padding: '10px 16px',
...
if (typeof document !== 'undefined' && !document.getElementById('crypto-signals-v4-styles')) {
    ...
    sheet.textContent = `
        ...
        @keyframes boss-glow {
            0% { box-shadow: 0 0 8px rgba(240,178,50,0.3), 0 0 16px rgba(218,55,60,0.1); }
            100% { box-shadow: 0 0 16px rgba(240,178,50,0.6), 0 0 30px rgba(218,55,60,0.3); }
        }
    `;
