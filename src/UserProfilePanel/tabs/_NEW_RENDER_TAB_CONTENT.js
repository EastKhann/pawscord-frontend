...
const renderTabContent = () => {
    switch (activeTab) {
        ...
        case 'sounds':
            return (
                <SoundSettingsTab
                    handleSoundSettingsUpdate={handleSoundSettingsUpdate}
        ...
        case 'gdpr':
            return (
                <GDPRTab
                    ...
                    gdprExports={gdprExports}
                    requestGDPRExport={requestGDPRExport}
                />
            );
        case 'developer':
            return (
                <DeveloperTab botAccounts={botAccounts} oauthApps={oauthApps} webhooks={webhooks} />
            );
        case 'inventory':
            return (
                <InventoryTab
