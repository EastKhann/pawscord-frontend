        ...
        switch (activeCategory) {
            ...
            case 'security':
                await Promise.all([
                    ...
                    security.fetchEmailVerificationStatus(),
                ]);
                break;
            case 'privacy':
            ...
            case 'advanced':
                await Promise.all([
                    data.fetchGDPRExports(),
                    advanced.fetchOAuthApps(),
                    advanced.fetchWebhooks(),
                    advanced.fetchBotAccounts(),
                ]);
                break;
            case 'social':
            ...
            case 'customization':
                await Promise.all([
                    settings.fetchThemes(),
                    advanced.fetchInventory(),
                    advanced.fetchNicknameHistory(),
                    advanced.fetchServerOrder(),
                ]);
                break;
            case 'appearance':
                await Promise.all([settings.fetchThemes(), settings.fetchLanguages()]);
                break;
            case 'notifications':
                break;
            case 'language':
