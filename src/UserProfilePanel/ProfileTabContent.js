...
import LanguageTab from '../components/UserSettingsModal/tabs/LanguageTab';
...
const ProfileTabContent = ({ activeTab, api, isOwnProfile, user }) => {
    ...
    switch (activeTab) {
        ...
        case 'notifications':
            return (
                <NotificationsTab
                    handleNotificationSettingsUpdate={api.handleNotificationSettingsUpdate}
        ...
        case 'sounds':
            return (
                <SoundSettingsTab
                    handleSoundSettingsUpdate={api.handleSoundSettingsUpdate}
                    soundSettings={api.soundSettings}
                />
            );
        case 'premium':
        ...
        case 'status':
            return (
                <CustomStatusTab
                    ...
                    setCustomStatus={api.setCustomStatus}
                    updateCustomStatus={api.updateCustomStatus}
                />
            );
        case 'gdpr':
            return (
                <GDPRTab
                    exportRequested={api.exportRequested}
                    gdprExports={api.gdprExports}
                    requestGDPRExport={api.requestGDPRExport}
                />
            );
        case 'developer':
            return (
                <DeveloperTab
                    botAccounts={api.botAccounts}
                    oauthApps={api.oauthApps}
