...
const A2_QUESTIONS = [
    ...
    },
    {
        ...
        explanation: {
            ...
            translation: 'Yarın erken kalkmama gerek yok nkü Sunar günü.',
        },
    },
    ...
    },
    {
        ...
        explanation: {
            ...
            rule: "Hayat tecrübelerini sorarken 'Never ... yaptın mı?' anlamında 'Ever' kullanılır.",
            tips: "Soru cümlelerinde 'ever' kullanılır.",
            examples: ['Have you ever eaten sushi?'],
            translation: "Never Londra'da bulundun mu?",
        },
    },
...
const EXTRA_A2_QUESTIONS = [
    ...
    // --- COMPARATIVES (IRREGULAR - BAD) ---
    {
        ...
        explanation: {
            ...
            rule: "'Bad' (kötü) sıfatı düzensizdir. 'Bekleer' olmaz, 'Worse' (daha kötü) olur.",
    ...
    // --- CONJUNCTIONS (BECAUSE) ---
    {
        ...
        explanation: {
            ...
            rule: "Sebep bildirmek için 'because' (nkü) kullanılır.",
            tips: 'Sonuç (Okula gitmedim) <- Sebep (Hastaydım)',
            examples: ['I am happy because I passed the exam.'],
            translation: 'Okula gitmedim nkü hastaydım.',
        },
    },
    ...
    // --- PREPOSITIONS (BY BUS) ---
    {
        ...
        explanation: {
            ...
            tips: 'By car, By bus, By plane. (İstisna: On foot - yürmemberrek)',
    ...
    // --- PHRASAL VERBS (TURN OFF) ---
    {
        ...
        explanation: {
            ...
            tips: 'Turn on (Openmak) / Turn off (Closemak)',
