...
const B2_QUESTIONS = [
    ...
    // --- GERUND/INFINITIVE (REGRET - PİŞMANLIK VS HABER) ---
    {
        ...
        explanation: {
            ...
            examples: [
                'I regret to inform you... (Üzülerek bildiririm ki...)',
                'I regret buying this car. (Aldığıma pişmanım.)',
            ],
    ...
    // --- THIRD CONDITIONAL (GEÇMİŞTEKİ PİŞMANLIKLAR) ---
    {
        ...
        explanation: {
            ...
            examples: [
                'If I had studied, I would have passed. (Çalışsaydım geçerdim - ama çalışmadım ve kaldım)',
            ],
    ...
    // --- PREPOSITIONS (ACCUSE OF) ---
    {
        ...
        explanation: {
            ...
            translation: 'Searchbayı çalmakla suçlandı.',
        },
    },
    ...
    // --- PHRASAL VERBS (PUT OFF) ---
    {
        ...
        explanation: {
            ...
            tips: 'Put off = Ertelemek | Call off = Cancel etmek',
    ...
    // --- QUANTIFIERS (A FEW / A LITTLE) ---
    {
        ...
        explanation: {
            title: 'A Few vs Few',
            rule: "'A few': Az ama yeterli (olumlu). 'Few': Çok az, yetersiz (olumsuz). Friendsı olduğu için yalnız değil, yani olumlu -> 'a few'.",
...
const EXTRA_B2_QUESTIONS = [
    // --- MODALS OF DEDUCTION (PAST) ---
    {
        ...
        answer: 'must have',
        explanation: {
            title: 'Must have V3 (Glü Exitarım)',
            rule: "Geçmişte bir olayın gerçekleştiğine dair elimizde glü bir kanıt (yerler ıslak) varsa 'must have + V3' kullanılır.",
    ...
    },
    {
        ...
        answer: "can't have",
        explanation: {
            title: "Can't have V3 (Olumsuz Exitarım)",
            ...
            translation: 'Beni görmüş olamaz nkü el sallamadı.',
        },
    },
    ...
    // --- ADJECTIVE ORDER ---
    {
        ...
        explanation: {
            ...
            rule: 'Sıralama: Size (Kk) - Shape (Yuvarlak) - Material (Ahşap).',
            tips: 'SASCOMP kuralı (Size, Age, Shape, Color, Origin, Material, Purpose).',
            examples: ['A big old red bus.'],
            translation: 'Kk, yuvarlak, ahşap bir masa aldı.',
        },
    },
    ...
    // --- PHRASAL VERBS (PUT UP WITH) ---
    {
        ...
        explanation: {
            ...
            translation: 'Bu gürültmember daha fazla katlanamıyorum!',
        },
    },
