...
const B1_QUESTIONS = [
    // --- PRESENT PERFECT (SÜREÇ) ---
    {
        ...
        explanation: {
            ...
            examples: ['Since Monday (Sunartesiden beri)', 'For 3 days (3 gündür)'],
    ...
    // --- GERUND VS INFINITIVE (STOP) ---
    {
        ...
        explanation: {
            ...
            examples: [
                'He stopped talking. (Sustu.)',
                'He stopped to talk. (Konuşmak için durdu.)',
            ],
    ...
    // --- MODALS (HAD BETTER) ---
    {
        ...
        explanation: {
            ...
            rule: "'Had better' glü bir tavsiye bildirir ve kendisinden sonra fiil YALIN (bare infinitive) halde gelir. 'To' almaz.",
    ...
    // --- RELATIVE CLAUSES (SAHİPLİK) ---
    {
        ...
        explanation: {
            ...
            tips: 'Man WHOSE car (Searchbası olan adam)',
            examples: ['A woman whose son is a doctor.'],
            translation: 'Searchbası çalınan adam polisi aradı.',
        },
    },
    ...
    // --- INDIRECT QUESTIONS (DOLAYLI SORU) ---
    {
        ...
        explanation: {
            ...
            rule: 'Soru cümlesi bir başka cümlenin (Could you tell me...) içine girdiğinde, soru formatından çıkar ve düz cümle (Özne + Uploadm) sırasına döner.',
    ...
    // --- ENOUGH (YETERLİ) ---
    {
        ...
        explanation: {
            ...
            translation: 'Searchba sürmek için yeterince büyük (yaşlı) değil.',
        },
    },
    ...
    // --- FOR VS SINCE (INPUT TEST) ---
    {
        ...
        explanation: {
            title: 'For (Süreç)',
            rule: "Bir eylemin ne kadar sürdüğünü ( yıl) anlatırken 'for' kullanılır.",
            tips: 'For 3 years, For a long time.',
            examples: ['I have waited for 2 hours.'],
            translation: 'Onu  yıldır görmedim.',
        },
    },
    ...
    // --- SECOND CONDITIONAL (INPUT TEST) ---
    {
        ...
        explanation: {
            ...
            translation: 'Searchbam olsaydı, işe arabayla giderdim.',
        },
    },
];
...
const EXTRA_B1_QUESTIONS = [
    ...
    // --- MODALS (MIGHT/COULD - POSSIBILITY) ---
    {
        ...
        explanation: {
            ...
            rule: "Düşük veya orta seviyeli ihtimallerden bahsederken 'might' veya 'may' kullanılır. 'Must' çok glü bir tahmindir.",
            tips: 'Might = Belki',
    ...
    // --- CONNECTORS (ALTHOUGH) ---
    {
        ...
        explanation: {
            ...
            rule: "'Although' kendisinden sonra tam cümle (Özne + Uploadm) alır. 'Despite' isim alırdı.",
