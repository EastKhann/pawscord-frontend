...
export const pronunciationList = [
    ...
    { text: 'How are you doing today?', difficulty: 'Sentence' },
    { text: 'I would like to order a coffee.', difficulty: 'Sentence' },
    { text: 'The quick brown fox jumps over the lazy dog.', difficulty: 'Sentence' },
    { text: 'Can you please repeat that?', difficulty: 'Sentence' },
    { text: 'I am learning to speak English fluently.', difficulty: 'Sentence' },
    { text: 'It is raining cats and dogs outside.', difficulty: 'Sentence' },
    { text: 'Actions speak louder than words.', difficulty: 'Sentence' },
    { text: 'I need to schedule a meeting for tomorrow.', difficulty: 'Sentence' },
    { text: 'What do you do for a living?', difficulty: 'Sentence' },
