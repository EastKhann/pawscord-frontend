...
export const LEVELS = [ // export ekledim ki başka yerden çekilebilsin
    ...
    { id: 'C2', name: 'C2 - Uzman', color: '#2f3136', icon: '🐉' }, // Yeni C2 Seviyesi (Dragon)
];
...
// =================================================================
    // === B1 SEVİYESİ (DETAYLI ÖĞRETİCİ MOD)
    // =================================================================
    const B1_QUESTIONS = [
    ...
    // =================================================================
    // === B2 SEVİYESİ (DETAYLI ÖĞRETİCİ MOD)
    // =================================================================
    const B2_QUESTIONS = [
...
// =================================================================
    // === C1 SEVİYESİ (DETAYLI ÖĞRETİCİ MOD)
    // =================================================================
    const C1_QUESTIONS = [

    // --- NEGATIVE INVERSION (DEVRİK CÜMLELER) ---
    {
        id: 501, level: 'C1', type: 'choice',
    ...
    // --- INVERSION (NOWHERE) ---
    {
        id: 517, level: 'C1', type: 'choice',
        question: "Nowhere _____ I seen such chaos.",
        options: ["have", "did", "was", "will"], // Düzeltilmiş options
        answer: "have",
        explanation: {
    ...
    // =================================================================
    // === C2 SEVİYESİ (DETAYLI ÖĞRETİCİ MOD)
    // =================================================================
    const C2_QUESTIONS = [

    // --- FIXED PHRASES / SUBJUNCTIVE ---
    {
        id: 601, level: 'C2', type: 'choice',
    ...
    // =================================================================
// === C1 SEVİYESİ (EKSTRA PAKET - DEVAMI)
// =================================================================
const EXTRA_C1_QUESTIONS = [

    // --- INVERSION (HARDLY / SCARCELY) ---
    {
        id: 536, level: 'C1', type: 'choice',
...
// Ana havuza ekleme komutu
QUESTIONS_DB.push(...EXTRA_C1_QUESTIONS);
// =================================================================
// === C2 SEVİYESİ (EKSTRA UZMAN PAKETİ - DÜZELTİLMİŞ ID)
// =================================================================
// Not: Ana C2 listesi 635'te bittiği için burası 636'dan başlar.

const EXTRA_C2_QUESTIONS = [

    // --- FIXED PHRASES / SUBJUNCTIVE ---
    {
        id: 636, level: 'C2', type: 'choice',
        question: "_____ it may, I will still support you.",
...
// Listeyi ana havuza ekleme kodu
...
// =================================================================
// === B2 SEVİYESİ (EKSTRA PAKET - DEVAMI)
// =================================================================
...
// =================================================================
// === A2 SEVİYESİ (EKSTRA TEMEL PAKET)
// =================================================================
...
// =================================================================
// === A1 SEVİYESİ (EKSTRA BAŞLANGIÇ PAKETİ)
// =================================================================
