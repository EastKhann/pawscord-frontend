...
vi.mock('../../UserProfilePanel/tabs/ProfileTab', () => ({
    default: () => <div data-testid="profile-tab" />,
}));
vi.mock('../../UserProfilePanel/tabs/SecurityTab', () => ({
    default: () => <div data-testid="security-tab" />,
}));
vi.mock('../../UserProfilePanel/tabs/BadgesTab', () => ({
    default: () => <div data-testid="badges-tab" />,
}));
vi.mock('../../UserProfilePanel/tabs/PrivacyTab', () => ({
    default: () => <div data-testid="privacy-tab" />,
}));
vi.mock('../../UserProfilePanel/tabs/FriendsTab', () => ({
    default: () => <div data-testid="friends-tab" />,
}));
vi.mock('../../UserProfilePanel/tabs/AppearanceTab', () => ({
    default: () => <div data-testid="appearance-tab" />,
}));
vi.mock('../../UserProfilePanel/tabs/NotificationsTab', () => ({
    default: () => <div data-testid="notifications-tab" />,
}));
vi.mock('../../UserProfilePanel/tabs/SoundSettingsTab', () => ({
    default: () => <div data-testid="sounds-tab" />,
}));
vi.mock('../../UserProfilePanel/tabs/PremiumTab', () => ({
    default: () => <div data-testid="premium-tab" />,
}));
vi.mock('../../UserProfilePanel/tabs/ActivityTab', () => ({
    default: () => <div data-testid="activity-tab" />,
}));
vi.mock('../../UserProfilePanel/tabs/DraftsTab', () => ({
    default: () => <div data-testid="drafts-tab" />,
}));
vi.mock('../../UserProfilePanel/tabs/BookmarksTab', () => ({
    default: () => <div data-testid="bookmarks-tab" />,
}));
vi.mock('../../UserProfilePanel/tabs/CustomStatusTab', () => ({
    default: () => <div data-testid="status-tab" />,
}));
vi.mock('../../UserProfilePanel/tabs/GDPRTab', () => ({
    default: () => <div data-testid="gdpr-tab" />,
}));
vi.mock('../../UserProfilePanel/tabs/DeveloperTab', () => ({
    default: () => <div data-testid="developer-tab" />,
}));
vi.mock('../../UserProfilePanel/tabs/InventoryTab', () => ({
    default: () => <div data-testid="inventory-tab" />,
}));
vi.mock('../../UserProfilePanel/tabs/EndorsementsTab', () => ({
    default: () => <div data-testid="endorsements-tab" />,
}));
vi.mock('../../UserProfilePanel/tabs/NicknameHistoryTab', () => ({
...
vi.mock('../../UserProfilePanel/ProfileHeader', () => ({
    default: (props) => (
        <div data-testid="profile-header" data-username={props.formData?.username} />
    ),
}));
        ...
        <div data-testid="profile-sidebar">
            <button
                ...
                onClick={() => {
                    ...
                    props.setActiveCategory('security');
                }}
            >
                Security
            </button>
            <button
                ...
                onClick={() => {
                    ...
                    props.setActiveCategory('social');
                }}
            >
                Friends
            </button>
            <button
                ...
                onClick={() => {
                    props.setActiveTab('badges');
                    props.setActiveCategory('account');
                }}
            >
                Badges
            </button>
...
vi.mock('../../components/LogoutModal', () => ({
    default: ({ isOpen }) => (isOpen ? <div data-testid="logout-modal" /> : null),
}));
