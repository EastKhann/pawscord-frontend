...
vi.mock('../../CryptoDashboard/PortfolioModal', () => ({
    default: ({ onClose }) => (
        <div data-testid="portfolio-modal">
            <button onClick={onClose}>close-portfolio</button>
        </div>
    ),
}));
...
const baseMock = {
    ...
    errorMsg: null,
    debugInfo: '',
    activeMode: 'balance_mode',
    setActiveMode: vi.fn(),
    activeTab: 'TUM_STRATEJILER',
    setActiveTab: vi.fn(),
    searchQuery: '',
    ...
    totalPages: 1,
    isPositionsTab: false,
    meta: {
        version: '3.0',
        export_date: '2025-01-01',
        balance_strategies: 50,
        winrate_strategies: 40,
        position_coins: [],
    },
    positionCoins: [],
    positionCoinStatus: {},
