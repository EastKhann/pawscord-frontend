const styles = {
    pageContainer: {
        minHeight: '100%', backgroundColor: '#0d0e10', color: '#dbdee1',
        padding: '20px', boxSizing: 'border-box'
    },
    header: {
        display: 'flex', justifyContent: 'space-between', alignItems: 'center',
        marginBottom: '15px', paddingBottom: '15px', borderBottom: '1px solid #0e1222',
    ...
    portfolioBtn: {
        backgroundColor: '#111214', border: '1px solid #f0b232', color: '#f0b232',
        padding: '8px 16px', borderRadius: '6px', cursor: 'pointer',
        fontWeight: 'bold', display: 'flex', alignItems: 'center', gap: '5px'
    },
    metaBar: {
        display: 'flex', gap: 20, flexWrap: 'wrap', padding: '8px 12px',
        backgroundColor: '#111214', borderRadius: 8, marginBottom: 15,
    ...
    searchBox: {
        ...
        borderRadius: 8, padding: '6px 12px', border: '1px solid #182135',
        flex: 1, maxWidth: 400
    },
    searchInput: {
    ...
    content: {},
    tableContainer: {
        overflowX: 'auto', borderRadius: 10, border: '1px solid #0e1222',
        backgroundColor: '#111214'
    },
    table: { width: '100%', borderCollapse: 'collapse', fontSize: '0.85em' },
    tableHeaderRow: { backgroundColor: '#0d0e10', borderBottom: '2px solid #182135' },
    tfBadge: {
        backgroundColor: '#1e2024', color: '#dbdee1', padding: '2px 6px',
    ...
    modalContent: {
        backgroundColor: '#17191c', padding: '25px', borderRadius: '12px',
        width: '90%', maxWidth: '400px', border: '1px solid #182135',
    ...
    input: {
        ...
        border: '1px solid #182135', backgroundColor: '#0d0e10', color: 'white',
        fontSize: '1.1em', outline: 'none', width: '100%'
    },
    maxBtn: {
        padding: '0 15px', backgroundColor: '#1e2024', border: '1px solid #182135',
    ...
    balanceCard: {
        backgroundColor: '#0d0e10', padding: '15px', borderRadius: '8px',
    ...
    holdingItem: {
        ...
        borderBottom: '1px solid #182135', alignItems: 'center'
    }
};
...
if (typeof document !== 'undefined') {
  ...
  td, th { padding: 8px 10px; text-align: center; border-bottom: 1px solid #0e1222; }
