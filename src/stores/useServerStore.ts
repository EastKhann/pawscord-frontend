...
export const selectTextChannels = (state: ServerStore) => state.channels.filter((c: any) => c.type === 'text' || !c.type);
/** Select voice channels only. */
export const selectVoiceChannels = (state: ServerStore) => state.channels.filter((c: any) => c.type === 'voice');
...
export const useServers = () => useServerStore((s) => s.servers);
export const useChannels = () => useServerStore((s) => s.channels);
