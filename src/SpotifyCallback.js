            ...
            <div style={styles.card}>
                ...
                {status === 'error' && (
                    <>
                        ...
                        <h2 style={{ color: '#f23f42' }}>Hata Oluştu</h2>
...
const styles = {
    container: {
        ...
        background: 'radial-gradient(ellipse at 15% 20%, rgba(29,185,84,0.12) 0%, transparent 50%), radial-gradient(ellipse at 85% 80%, rgba(88,101,242,0.08) 0%, transparent 48%), #0d0e10',
    ...
    card: {
        ...
        padding: '44px 40px', borderRadius: '22px', textAlign: 'center',
        border: '1px solid rgba(255,255,255,0.07)',
        boxShadow: '0 0 0 1px rgba(29,185,84,0.08), 0 32px 80px rgba(0,0,0,0.60), inset 0 1px 0 rgba(255,255,255,0.06)',
        maxWidth: '400px', width: '90%',
        animation: 'authCardIn 0.5s cubic-bezier(0.22,1,0.36,1)'
    },
    button: {
        marginTop: '20px', padding: '12px 28px', borderRadius: '13px', border: 'none',
        background: 'linear-gradient(135deg, #1db954, #17a346)', color: 'white', fontWeight: 'bold', cursor: 'pointer',
        fontSize: '15px', boxShadow: '0 4px 16px rgba(29,185,84,0.30)'
    }
};
