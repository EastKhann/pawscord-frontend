            ...
            <div style={styles.modal}>
                ...
                <div style={styles.content}>
                    ...
                    <div style={styles.info}>
                        ...
                        <div style={styles.infoItem}>
                            <span style={styles.infoLabel}>Rankdaki Pozisyon:</span>
                    ...
                    {position === 0 ? (
                        <div style={styles.ready}>
                            <p style={styles.readyText}>✅ Rank sende! Joining...</p>
                        </div>
                    ) : (
...
try {
    ...
    /* CSS rule injection may fail in some browsers */
}

VoiceWaitingRoom.propTypes = {
    channelName: PropTypes.string,
    maxUsers: PropTypes.array,
