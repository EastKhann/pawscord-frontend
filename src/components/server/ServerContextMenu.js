...
const ServerContextMenu = ({
    ...
    onCopyInvite,
    onDeleteServer,
    onChangeIcon, // 🔥 YENİ: Server ikonu değiştirme
    onChangePrivacy, // 🔥 YENİ: Gizlilik settingsı
    canMoveUp = true,
    canMoveDown = true,
    isMuted = false,
}) => {
    ...
    const menuItems = [
        {
            icon: FaCopy,
            label: t('serverMenu.copyInvite', 'Copy Invite Link'),
            action: onCopyInvite,
            show: true,
            color: '#5865f2',
        },
        ...
        {
            icon: FaImage,
            label: t('ui.server_ikonunu_change'),
            action: onChangeIcon,
            show: isOwner,
            color: '#f0b232',
        },
        {
            ...
            label: server.is_public ? t('ui.ozel_yap') : t('serverMenu.makePublic', 'Make Public'),
        ...
        },
        {
            ...
            label: isMuted
                ? t('serverMenu.unmuteNotifications', 'Unmute Notifications')
                : t('serverMenu.muteNotifications', 'Mute Notifications'),
        ...
        {
            icon: FaArrowUp,
            label: t('ui.yukari_tasi'),
            action: onMoveUp,
            show: canMoveUp,
        },
        {
            icon: FaArrowDown,
            label: t('ui.asagi_tasi'),
            action: onMoveDown,
            show: canMoveDown,
        },
        {
        ...
        {
            icon: FaCog,
            label: t('serverMenu.serverSettings', 'Server Settings'),
            action: onServerSettings,
            show: isOwner,
        },
        {
            icon: FaTrash,
            label: t('serverMenu.deleteServer', 'Delete Server'),
        ...
        {
            icon: FaSignOutAlt,
            label: t('serverMenu.leaveServer', 'Leave Server'),
...
ServerContextMenu.propTypes = {
    ...
    onLeaveServer: PropTypes.func,
    onServerSettings: PropTypes.func,
    onMuteServer: PropTypes.func,
    onUnmuteServer: PropTypes.func,
    onMoveUp: PropTypes.func,
    onMoveDown: PropTypes.func,
    onCopyInvite: PropTypes.func,
