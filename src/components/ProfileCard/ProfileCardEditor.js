                        ...
                        <div className="appearance-tab">
                            ...
                            <div className="form-group">
                                ...
                                <input
                                    ...
                                    placeholder={t('profileCard.backgroundUrl', 'https://...')}

                                    value={e.formData.banner}

                                    onChange={handleBannerChange}

                                    aria-label={t('profileCard.bannerUrl', 'Banner URL')}
                            ...
                            <div className="form-group">
                                ...
                                <div className="color-picker">
                                    ...
                                    <input
                                        ...
                                        aria-label={t('profileCard.bannerColor', 'Banner color')}
                            ...
                            <div className="form-group">
                                ...
                                <textarea
                                    ...
                                    aria-label={t('profileCard.bioInput', 'Bio')}
                        ...
                        <div className="badges-tab">
                            ...
                            <p className="badges-hint">
                                ...
                                {t(
                                    ...
                                    t('profileCardEditor.badgeHint', 'Select up to 3 badges to display on your profile')
                            ...
                            {e.formData.links.length < 5 && (
                                ...
                                <div className="add-link-form">
                                    ...
                                    <input
                                        ...
                                        placeholder={t('profileCard.badgeName', 'Name (optional)')}

                                        value={e.newLink.name}

                                        onChange={handleLinkNameChange}

                                        aria-label={t('profileCard.linkName', 'Link name (optional)')}
                                    ...
                                    <input
                                        ...
                                        placeholder={t('profileCard.badgeUrl', 'URL')}

                                        value={e.newLink.url}

                                        onChange={handleLinkUrlChange}

                                        aria-label={t('profileCard.linkUrl', 'Link URL')}
