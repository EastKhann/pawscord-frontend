...
const styles = {
    container: { backgroundColor: '#17191c', borderRadius: '8px', padding: '20px', color: '#dbdee1' },
    loading: {
        display: 'flex', flexDirection: 'column', alignItems: 'center',
        justifyContent: 'center', gap: '16px', padding: '60px', color: '#b5bac1'
    },
    ...
    timer: {
        ...
        backgroundColor: '#111214', borderRadius: '4px', fontSize: '13px', color: '#b5bac1'
    },
    statsGrid: { display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '12px', marginBottom: '20px' },
    statCard: {
        display: 'flex', alignItems: 'center', gap: '12px',
        padding: '16px', backgroundColor: '#111214', borderRadius: '8px'
    },
    statInfo: { display: 'flex', flexDirection: 'column' },
    statValue: { fontSize: '20px', fontWeight: '700', color: '#fff' },
    statLabel: { fontSize: '11px', color: '#949ba4', textTransform: 'uppercase' },
    tabs: {
        display: 'flex', gap: '8px', marginBottom: '16px',
        borderBottom: '1px solid #182135', paddingBottom: '12px'
    },
    tab: {
        display: 'flex', alignItems: 'center', gap: '8px', padding: '8px 16px',
        backgroundColor: 'transparent', border: 'none', borderRadius: '4px',
        color: '#949ba4', fontSize: '14px', cursor: 'pointer', transition: 'all 0.2s'
    },
    ...
    challengeCard: {
        ...
        backgroundColor: '#111214', borderRadius: '8px', transition: 'transform 0.2s'
    },
    challengeIcon: {
        width: '48px', height: '48px', display: 'flex', alignItems: 'center',
        justifyContent: 'center', backgroundColor: '#0d0e10', borderRadius: '12px', fontSize: '20px'
    },
    ...
    challengeDescription: { margin: '0 0 8px', fontSize: '13px', color: '#b5bac1' },
    progressContainer: { display: 'flex', alignItems: 'center', gap: '8px' },
    progressBar: {
        flex: 1, height: '6px', backgroundColor: '#0d0e10', borderRadius: '3px', overflow: 'hidden'
    },
    progressFill: { height: '100%', backgroundColor: '#5865f2', borderRadius: '3px', transition: 'width 0.3s' },
    progressText: { fontSize: '12px', color: '#949ba4', minWidth: '45px', textAlign: 'right' },
    ...
    pointsBadge: {
        ...
        fontSize: '12px', color: '#f0b232', fontWeight: '600'
    },
    rewardBadge: {
        display: 'flex', alignItems: 'center', gap: '4px', padding: '4px 8px',
        backgroundColor: 'rgba(88, 101, 242, 0.2)', borderRadius: '12px',
        fontSize: '11px', color: '#dbdee1'
    },
    ...
    earnedReward: {
        display: 'flex', alignItems: 'center', gap: '8px', padding: '8px 12px',
        backgroundColor: '#111214', borderRadius: '16px', fontSize: '13px', color: '#dbdee1'
    },
    summaryCard: {
        padding: '20px',
    ...
    summaryLabel: { fontSize: '11px', color: '#b5bac1', textTransform: 'uppercase' },
    totalProgressBar: {
        height: '8px', backgroundColor: 'rgba(0, 0, 0, 0.3)', borderRadius: '4px', overflow: 'hidden'
    },
    totalProgressFill: { height: '100%', backgroundColor: '#23a559', borderRadius: '4px', transition: 'width 0.3s' }
};
