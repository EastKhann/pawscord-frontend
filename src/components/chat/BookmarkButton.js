...
export const BookmarkButton = memo(
    ({ messageId, isBookmarked = false, fetchWithAuth, apiBaseUrl, onUpdate }) => {
 ...
 */
export const StarButton = memo(
    ({ messageId, isStarred = false, fetchWithAuth, apiBaseUrl, onUpdate }) => {
        const { t } = useTranslation();
 ...
 */
export const ReadLaterButton = memo(
    ({ messageId, isReadLater = false, fetchWithAuth, apiBaseUrl, onUpdate }) => {
        const { t } = useTranslation();
        ...
        const handleToggle = useCallback(
            async (e) => {
                ...
                try {
                    ...
                    logger.error('Read later error:', error);
                } finally {
                    setLoading(false);
                }
            },
