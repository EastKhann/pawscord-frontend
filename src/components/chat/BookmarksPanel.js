...
const BookmarksPanel = ({ apiBaseUrl, fetchWithAuth, username }) => {
    ...
    const [categories, setCategories] = useState(['All', 'Important', 'To-do', 'Inspiration']);
        ...
        <div style={styles.container}>
            ...
            <div style={styles.categories}>
                {categories.map((cat) => (
                    ...
                    >
                        {cat === 'Important' && <FaStar style={styles.categoryIcon} />}
                        {cat === 'All' && <FaFolder style={styles.categoryIcon} />}
                        {cat}
                    </button>
                ))}
            </div>
