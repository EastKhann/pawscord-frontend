                ...
                <div className="card-header">
                    ...
                    <label className="toggle-switch">
                        <input
                            ...
                            aria-label={t('noiseTab.noiseSuppressionToggle', 'Toggle noise suppression')}
                        />
                    ...
                    <div className="card-header">
                        ...
                        <label className="toggle-switch">
                            <input
                                ...
                                aria-label={t('noiseTab.echoCancellationToggle', 'Toggle echo cancellation')}
                            />
                            <span className="slider"></span>
                        </label>
                        {settings.echo_cancellation && (
                            <div className="level-selector">
                                <select
                                    ...
                                    aria-label={t('noiseTab.echoCancellationLevel', 'Select echo cancellation level')}
                                >
                        ...
                        <div className="card-header">
                            ...
                            <label className="toggle-switch">
                                <input
                                    ...
                                    aria-label={t('noiseTab.noiseGateToggle', 'Toggle noise gate')}
                                />
                                <span className="slider"></span>
                            </label>
                        </div>
                            ...
                            <div className="gate-settings">
                                <div className="gate-slider">
                                    ...
                                    <input
                                        ...
                                        aria-label={t('noiseTab.noiseGateThreshold', 'Noise gate threshold')}
                                    />
                                ...
                                <div className="gate-timing">
                                    <div className="timing-item">
                                        ...
                                        <select
                                            ...
                                            aria-label={t('noiseTab.attackDuration', 'Select attack duration')}
                                        >
                                    ...
                                    <div className="timing-item">
                                        ...
                                        <select
                                            ...
                                            aria-label={t('noiseTab.releaseDuration', 'Select release duration')}
                                        >
                        ...
                        <div className="card-header">
                            ...
                            <label className="toggle-switch">
                                <input
                                    ...
                                    aria-label={t('noiseTab.agcToggle', 'Toggle automatic gain control')}
                                />
                                <span className="slider"></span>
                            </label>
                        </div>
                        ...
                        <div className="card-header">
                            ...
                            <label className="toggle-switch">
                                <input
                                    ...
                                    aria-label={t('noiseTab.highPassToggle', 'Toggle high pass filter')}
                                />
                                <span className="slider"></span>
                            </label>
                        </div>
                        ...
                        {settings.high_pass_filter && (
                            <div className="frequency-selector">
                                ...
                                <select
                                    ...
                                    aria-label={t('noiseTab.highPassFrequency', 'Select high pass filter frequency')}
                                >
