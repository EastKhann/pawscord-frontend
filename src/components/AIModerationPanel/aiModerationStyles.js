export const getStyles = (isMobile) => ({
  ...
  switch: (on) => ({ width: '56px', height: '32px', background: on ? 'linear-gradient(135deg, #23a559, #4caf50)' : 'rgba(255,255,255,0.2)', borderRadius: '16px', position: 'relative', cursor: 'pointer', transition: 'all 0.3s ease', border: '2px solid rgba(88,101,242,0.3)' }),
  ...
  actionBtn: (type) => ({ padding: '8px 16px', borderRadius: '6px', fontSize: '14px', fontWeight: '500', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '6px', transition: 'all 0.2s ease', minHeight: '36px', background: type === 'delete' ? 'rgba(218,55,60,0.2)' : type === 'timeout' ? 'rgba(240,183,50,0.2)' : 'rgba(67,181,129,0.2)', color: type === 'delete' ? '#da373c' : type === 'timeout' ? '#f0b732' : '#23a559', border: `1px solid ${type === 'delete' ? 'rgba(218,55,60,0.4)' : type === 'timeout' ? 'rgba(240,183,50,0.4)' : 'rgba(67,181,129,0.4)'}` }),
  saveBtn: { width: '100%', padding: '16px', background: 'linear-gradient(135deg, #5865f2, #5865f2)', border: 'none', borderRadius: '12px', color: 'white', fontSize: '16px', fontWeight: '600', cursor: 'pointer', marginTop: '24px', transition: 'all 0.2s ease', minHeight: '48px' },
});
