...
const LazyImage = ({
    ...
    useEffect(() => {
        ...
        const observer = new IntersectionObserver(
            ...
            {
                rootMargin: '100px', // 100px önceden upload
                threshold: 0.01,
            }
        );
    ...
    const blurPlaceholder =
        'data:image/svg+xml,%3Csvg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"%3E%3Crect fill="%232b2d31" width="100" height="100"/%3E%3C/svg%3E';
...
LazyImage.propTypes = {
    ...
    showBlurPlaceholder: PropTypes.bool,
};
