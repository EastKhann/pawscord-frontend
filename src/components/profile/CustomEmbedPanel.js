...
const CustomEmbedPanel = ({ serverId, onClose }) => {
    ...
    const deleteEmbed = async (id) => {
        ...
        if (!(await confirmDialog(t('embed.deleteConfirm', 'Are you sure you want to delete this embed?')))) return;
        ...
        >
            ...
            >
                ...
                <div className="custom-embed-header">
                    ...
                    <h2>📝 {t('embed.title', 'Custom Embed Creator')}</h2>
                ...
                <div className="custom-embed-content">
                    ...
                    <button
                        ...
                        aria-label={t('embed.toggleEditor', 'Toggle embed editor')}
                        ...
                        <div className="embed-editor">
                            ...
                            <div className="editor-form">
                                    ...
                                    <div className="form-row">
                                        ...
                                        <div className="form-group">
                                            ...
                                            <input
                                                ...
                                                aria-label={t('embed.authorName', 'Author name')}
                                        ...
                                        <div className="form-group">
                                            ...
                                            <label>{t('embed.iconUrl', 'Icon URL')}</label>
                                            ...
                                            <input
                                                ...
                                                placeholder={t('customEmbed.imageUrl', 'https://')}

                                                aria-label={t('embed.authorIcon', 'Author icon URL')}
                                ...
                                <div className="form-section">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input
                                            ...
                                            aria-label={t('embed.titleInput', 'Embed title')}
                                    ...
                                    <div className="form-group">
                                        ...
                                        <textarea
                                            ...
                                            placeholder={t('embed.description', 'Embed description')}

                                            aria-label={t('embed.descriptionInput', 'Embed description')}
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input
                                            ...
                                            aria-label={t('embed.colorPicker', 'Embed color')}
                                ...
                                <div className="form-section">
                                    ...
                                    <h3>{t('embed.images', 'Images')}</h3>

                                    <div className="form-row">

                                        <div className="form-group">

                                            <label>{t('embed.thumbnailUrl', 'Thumbnail URL')}</label>
                                            ...
                                            <input
                                                ...
                                                placeholder={t('customEmbed.thumbnailUrl', 'https://')}

                                                aria-label={t('embed.thumbnailUrl', 'Thumbnail URL')}
                                        ...
                                        <div className="form-group">
                                            ...
                                            <label>{t('embed.imageUrl', 'Large Image URL')}</label>
                                            ...
                                            <input
                                                ...
                                                placeholder={t('customEmbed.authorIconUrl', 'https://')}

                                                aria-label={t('embed.imageUrlInput', 'Large image URL')}
                                ...
                                <div className="form-section">
                                    ...
                                    <div className="section-header">
                                        ...
                                        <button
                                            ...
                                            aria-label={t('embed.addField', 'Add field')}
                                        ...
                                        <div key={`item-${idx}`} className="field-item">
                                            ...
                                            <div className="field-inputs">
                                                ...
                                                <button
                                                    ...
                                                    aria-label={t('embed.removeField', 'Remove field')}
                                    ...
                                    <div className="form-row">
                                        ...
                                        <div className="form-group">
                                            ...
                                            <input
                                                ...
                                                placeholder={t('customEmbed.footerText', 'Footer text')}

                                                aria-label={t('embed.footerText', 'Footer text')}
                                        ...
                                        <div className="form-group">
                                            ...
                                            <input
                                                ...
                                                placeholder={t('customEmbed.footerIconUrl', 'https://')}

                                                aria-label={t('embed.footerIcon', 'Footer icon URL')}
                    ...
                    {loading ? (
                        ...
                        <div className="empty-state">
                            ...
                            <p>{t('embed.noEmbeds', 'No saved embeds yet')}</p>
                                ...
                                <div key={embed.id} className="embed-card">
                                    ...
                                    <div className="embed-actions">
                                        ...
                                        <select
                                            ...
                                            aria-label={t('embed.channelSelect', 'Select channel')}

                                        >

                                            <option value="">{t('embed.selectChannel', 'Select channel')}</option>
                                        ...
                                        <button
                                            ...
                                            aria-label={t('embed.sendEmbed', 'Send embed')}
                                        ...
                                        <button
                                            ...
                                            aria-label={t('embed.deleteEmbed', 'Delete embed')}
