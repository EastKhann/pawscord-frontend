const styles = {
    ...
    balance: { display: 'flex', alignItems: 'center', gap: '8px', backgroundColor: '#111214', padding: '8px 16px', borderRadius: '20px', fontSize: '16px', fontWeight: '600' },
    ...
    categoryBtn: { background: 'none', border: 'none', color: '#949ba4', padding: '10px 16px', borderRadius: '6px', cursor: 'pointer', fontSize: '14px', fontWeight: '600', display: 'flex', alignItems: 'center', gap: '8px', whiteSpace: 'nowrap', transition: 'all 0.2s' },
    ...
    itemCard: { backgroundColor: '#111214', borderRadius: '8px', padding: '12px', cursor: 'pointer', transition: 'transform 0.2s', position: 'relative', overflow: 'hidden' },
    itemImage: { width: '100%', height: '150px', objectFit: 'cover', borderRadius: '6px', marginBottom: '8px' },
    itemPlaceholder: { width: '100%', height: '150px', backgroundColor: '#0d0e10', borderRadius: '6px', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '8px' },
    ...
    limitedBadge: { position: 'absolute', top: '12px', right: '12px', backgroundColor: '#f23f42', color: '#fff', padding: '4px 8px', borderRadius: '4px', fontSize: '10px', fontWeight: 'bold' },
    ...
    detailModal: { backgroundColor: '#111214', borderRadius: '12px', padding: '32px', maxWidth: '500px', width: '90%', position: 'relative', textAlign: 'center' },
    ...
    detailPlaceholder: { width: '100%', height: '300px', backgroundColor: '#0d0e10', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '20px' },
    detailName: { fontSize: '28px', fontWeight: 'bold', marginBottom: '12px' },
    detailRarity: { display: 'inline-block', padding: '6px 12px', backgroundColor: '#0d0e10', borderRadius: '6px', fontSize: '12px', fontWeight: 'bold', marginBottom: '16px' },
    detailDescription: { fontSize: '14px', color: '#dbdee1', lineHeight: '1.6', marginBottom: '24px' },
    detailPrice: { display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '12px', marginBottom: '24px', color: '#f0b232' },
    purchaseBtn: { width: '100%', padding: '14px', backgroundColor: '#23a559', border: 'none', borderRadius: '6px', color: '#fff', fontSize: '16px', fontWeight: '600', cursor: 'pointer', transition: 'background 0.2s' },
