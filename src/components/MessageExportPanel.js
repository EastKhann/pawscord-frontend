                ...
                <div style={styles.content}>
                    {!downloadUrl ? (
                        <>
                            ...
                            {processing && (
                                <div style={styles.progress}>
                                    ...
                                    <p style={{ fontSize: '12px', color: '#888' }}>Bu işlem birkaç dakika sürebilir</p>
                                </div>
                            )}
                        </>
                    ) : (
                        <div style={styles.success}>
                            ...
                            <p>Dosyanız hazır ve indirilebilir durumda.</p>
                            <button onClick={downloadExport} style={styles.downloadBtn}>
