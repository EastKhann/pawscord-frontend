...
const SignalNotification = () => {
    ...
    useEffect(() => {
        ...
        if (globalData.type === 'chat_message_handler' && globalData.username === '⚡ Signal Bot') {
            ...
            const newNotif = {
                title: t('ui.yeni_kripto_sinyali'),
                coin: coinLine.replace('🪙', '').replace(/\*/g, '').trim(),
                direction: dirLine.includes('LONG') ? t('ui.yukselis_long') : 'FALL (SHORT)',
                ...
                <div style={styles.details}>
                    ...
                    <span
                        style={{
                            ...
                            backgroundColor: notification.isLong
                                ? 'rgba(35, 165, 89, 0.2)'
                                : 'rgba(240, 71, 71, 0.2)',
