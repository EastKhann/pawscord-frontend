...
export const QuickReactionsPanel = ({ onClose }) => {
    ...
    return (
        ...
        <div className="feature-panel quick-reactions">
            ...
            <div className="panel-header"><h3>{'🎯'} Hızlı Tepkwithr</h3><button onClick={onClose} className="close-btn">✕</button></div>
        ...
        <div className="feature-panel message-stats">
            ...
            <div className="panel-content">
                ...
                {loading ? <div className="loading">{t("common.loading")}</div>{t('stats')}<>
                    ...
                    <div className="stat-info"><p>{'📈'} Günlük ortalama: <strong>{stats.avg_daily}</strong> message</p></div>
...
export const ServerInsightsPanel = ({ serverId, onClose }) => {
    ...
    return (
        ...
        <div className="feature-panel server-insights">
            ...
            <div className="panel-header"><h3>{'📈'} Server İstatistikleri</h3><button onClick={onClose} className="close-btn">✕</button></div>
