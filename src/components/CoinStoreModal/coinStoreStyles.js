...
export const INFO_ITEMS = [
    { icon: '✓', color: '#23a559', textKey: 'store.info.instant' },
    { icon: '✓', color: '#23a559', textKey: 'store.info.secure' },
    { icon: '✓', color: '#23a559', textKey: 'store.info.bonus' },
    { icon: '⚠', color: '#f0b232', textKey: 'store.info.testMode', small: true },
];
