export const THEME_PRESETS = [
  { name: 'Discord Purple', primary: '#5865f2', accent: '#4752c4', bg: '#111214' },
  ...
  { name: 'Golden Yellow', primary: '#f0b232', accent: '#f57c00', bg: '#2d2819' },
  { name: 'Dark Red', primary: '#f23f42', accent: '#c03537', bg: '#2d1e1f' },
  { name: 'Cyber Purple', primary: '#5865f2', accent: '#8e44ad', bg: '#251f2d' }
];

export const styles = {
  container: { width: '100%', height: '100%', backgroundColor: '#17191c', display: 'flex', flexDirection: 'column' },
  header: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '16px 20px', borderBottom: '1px solid #0b0e1b', backgroundColor: '#111214' },
  title: { margin: 0, color: '#fff', fontSize: '20px', fontWeight: '600', display: 'flex', alignItems: 'center', gap: '10px' },
  headerActions: { display: 'flex', gap: '12px' },
  previewButton: { backgroundColor: '#1e2024', color: '#fff', border: 'none', padding: '10px 20px', borderRadius: '4px', cursor: 'pointer', fontWeight: '500' },
  ...
  section: { backgroundColor: '#111214', borderRadius: '8px', padding: '20px', marginBottom: '16px' },
  ...
  bioTextarea: { width: '100%', padding: '12px', backgroundColor: '#0d0e10', border: '1px solid #0b0e1b', borderRadius: '4px', color: '#fff', fontSize: '14px', resize: 'vertical', minHeight: '100px', fontFamily: 'inherit' },
  ...
  previewContent: { backgroundColor: '#111214', borderRadius: '0 0 8px 8px', padding: '60px 20px 20px', position: 'relative' },
