...
export const styles = {
  ...
  modal: { backgroundColor: '#111214', borderRadius: '12px', width: '900px', maxHeight: '90vh', overflow: 'hidden', display: 'flex', flexDirection: 'column' },
  header: { display: 'flex', alignItems: 'center', padding: '20px', borderBottom: '1px solid #182135' },
  headerLeft: { display: 'flex', alignItems: 'center', flex: 1 },
  title: { margin: 0, color: '#fff', fontSize: '20px' },
  coinsDisplay: { display: 'flex', alignItems: 'center', gap: '6px', color: '#fff', marginRight: '20px', background: '#1e2024', padding: '6px 12px', borderRadius: '20px' },
  ...
  tab: { background: '#1e2024', border: 'none', color: '#b5bac1', padding: '8px 16px', borderRadius: '6px', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '6px' },
  ...
  actionBtn: { background: '#1e2024', border: 'none', color: '#fff', padding: '10px', borderRadius: '6px', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px' },
  saveBtn: { background: '#23a559', border: 'none', color: '#000', padding: '12px', borderRadius: '6px', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px', fontWeight: 'bold' },
  customizeSection: { flex: 1 },
  categoryTabs: { display: 'flex', flexWrap: 'wrap', gap: '8px', marginBottom: '15px' },
  catBtn: { background: '#1e2024', border: 'none', color: '#b5bac1', padding: '8px 12px', borderRadius: '6px', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '6px', fontSize: '12px' },
  ...
  itemCard: { background: '#1e2024', borderRadius: '8px', padding: '12px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px', cursor: 'pointer', position: 'relative' },
  ...
  buyBtn: { position: 'absolute', bottom: '8px', right: '8px', background: '#f0b232', border: 'none', color: '#000', padding: '4px 8px', borderRadius: '4px', cursor: 'pointer', fontSize: '10px', display: 'flex', alignItems: 'center', gap: '4px' },
  presetsGrid: { display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '15px', width: '100%' },
  presetCard: { background: '#1e2024', borderRadius: '10px', padding: '15px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '10px' },
