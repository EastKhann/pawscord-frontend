...
function ChangelogPanel({ apiBaseUrl, fetchWithAuth }) {
    ...
    const filteredChanges =
        selectedType === 'all' ? changes : changes.filter((c) => c.change_type === selectedType);
                                    ...
                                    >
                                        ...
                                        <div className="change-content">
                                            <div className="change-header">
                                                <span
                                                    className={`change-badge ${change.change_type}`}
                                                >
                                                    {change.change_type.toUpperCase()}
                                                </span>
                                                {change.model_name && (
                                                    <span className="change-model">
                                                        {change.model_name}
                                                    </span>
                                                )}
                                                {change.version && (
