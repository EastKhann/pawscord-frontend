        ...
        <div style={styles.overlay} {...overlayProps}>
            <div style={styles.modal} {...dialogProps}>
                ...
                <form onSubmit={handleSubmit} style={styles.body}>
                    <p style={{ color: '#b5bac1', fontSize: '0.9em' }}>
...
const styles = {
    ...
    modal: { backgroundColor: '#17191c', width: '400px', borderRadius: '8px', overflow: 'hidden', boxShadow: '0 10px 30px rgba(0,0,0,0.5)' },
    header: { padding: '15px 20px', backgroundColor: '#111214', display: 'flex', justifyContent: 'space-between', alignItems: 'center', color: 'white' },
    ...
    input: { padding: '10px', borderRadius: '4px', border: '1px solid #0b0e1b', backgroundColor: '#0d0e10', color: 'white', outline: 'none' },
    saveBtn: { padding: '10px', backgroundColor: '#3ba55c', color: 'white', border: 'none', borderRadius: '4px', cursor: 'pointer', fontWeight: 'bold' },
    clearBtn: { padding: '10px', backgroundColor: '#f23f42', color: 'white', border: 'none', borderRadius: '4px', cursor: 'pointer', fontWeight: 'bold' }
};
