export const styles = {
    ...
    createSection: { backgroundColor: '#111214', borderRadius: '8px', padding: '20px', marginBottom: '24px' },
    sectionTitle: { fontSize: '16px', fontWeight: '600', marginBottom: '16px' },
    exportTypeSelector: { display: 'flex', gap: '12px' },
    select: { flex: 1, padding: '10px', backgroundColor: '#0d0e10', border: '1px solid #444', borderRadius: '6px', color: '#fff', fontSize: '14px' },
    ...
    empty: { textAlign: 'center', padding: '60px 20px', color: '#dbdee1' },
    jobsList: { display: 'flex', flexDirection: 'column', gap: '12px' },
    jobCard: { backgroundColor: '#111214', borderRadius: '8px', padding: '16px', display: 'flex', alignItems: 'center', gap: '16px' },
    ...
    jobMeta: { fontSize: '12px', color: '#949ba4', marginBottom: '8px' },
    progressBar: { position: 'relative', height: '20px', backgroundColor: '#0d0e10', borderRadius: '10px', overflow: 'hidden', marginTop: '8px' },
    ...
    fileSize: { fontSize: '12px', color: '#949ba4', marginTop: '4px' },
    ...
    downloadBtn: { padding: '8px 12px', backgroundColor: '#23a559', border: 'none', borderRadius: '6px', color: '#fff', cursor: 'pointer', fontSize: '14px' },
    deleteBtn: { padding: '8px 12px', backgroundColor: '#f23f42', border: 'none', borderRadius: '6px', color: '#fff', cursor: 'pointer', fontSize: '14px' },
