...
const useContentScanner = (fetchWithAuth, apiBaseUrl, messageId) => {
    ...
    const fetchResults = async () => {
        ...
        try {
            ...
            toast.error(t('contentScanner.loadFailed'));
        } finally {
            setLoading(false);
        }
    };
    ...
    const exportResults = async () => {
        try {
            ...
            a.click();
            a.remove();
            toast.success(t('contentScanner.exported'));
        } catch (error) {
            toast.error(t('contentScanner.exportFailed'));
        }
    };
    ...
    const reviewResult = async (resultId, action) => {
        try {
            ...
            toast.success(t('contentScanner.reviewSuccess'));
            fetchResults();
        } catch (error) {
            toast.error(t('contentScanner.reviewFailed'));
        }
    };
