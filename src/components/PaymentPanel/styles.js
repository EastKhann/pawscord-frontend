...
const styles = {
    ...
    balanceCard: {
        backgroundColor: '#111214', borderRadius: '12px', padding: '40px',
    ...
    bonus: {
        fontSize: '10px', color: '#23a559', fontWeight: 'bold',
    ...
    paymentMethodCard: {
        padding: '20px', background: '#111214', border: '2px solid #182135',
    ...
    pmBadge: {
        display: 'inline-block', padding: '4px 12px', background: '#1e2024',
        borderRadius: '12px', fontSize: '11px', color: '#23a559', fontWeight: '600'
    },
    paymentInfo: {
        background: '#111214', borderRadius: '12px', padding: '16px', marginBottom: '16px'
    },
    paymentInfoRow: {
        display: 'flex', justifyContent: 'space-between', padding: '8px 0',
        fontSize: '14px', color: '#b5bac1', borderBottom: '1px solid #182135'
    },
    ...
    label: {
        ...
        marginBottom: '8px', color: '#dbdee1'
    },
    select: {
        width: '100%', padding: '10px', backgroundColor: '#111214',
        border: '1px solid #444', borderRadius: '4px', color: '#fff', fontSize: '14px'
    },
    purchaseBtn: {
        width: '100%', padding: '14px', backgroundColor: '#23a559',
    ...
    input: {
        padding: '10px', backgroundColor: '#111214',
        border: '1px solid #444', borderRadius: '4px', color: '#fff', fontSize: '14px'
    },
    ...
    transaction: {
        backgroundColor: '#111214', borderRadius: '6px', padding: '16px',
