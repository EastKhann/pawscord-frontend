const styles = {
  ...
  fileAttachment: { display: 'flex', alignItems: 'center', padding: '14px 16px', backgroundColor: '#111214', borderRadius: '8px', marginTop: '8px', border: '1px solid #3a3d44', maxWidth: '450px', transition: 'all 0.2s ease', cursor: 'default' },
  ...
  fileDetails: { color: '#b5bac1', fontSize: '12px' },
  ...
  loadingMedia: { padding: '12px', color: '#949ba4', fontSize: '13px' },
  ...
  transcriptionText: { flex: 1, fontSize: '13px', lineHeight: '1.5', color: '#dbdee1', fontStyle: 'italic' },
  transcribeButton: { marginTop: '8px', padding: '6px 12px', backgroundColor: 'rgba(88, 101, 242, 0.15)', border: '1px solid rgba(88, 101, 242, 0.4)', borderRadius: '6px', color: '#5865f2', fontSize: '12px', cursor: 'pointer', transition: 'all 0.2s', display: 'inline-flex', alignItems: 'center', gap: '6px' },
  transcribingLoader: { marginTop: '8px', padding: '6px 12px', color: '#949ba4', fontSize: '12px', fontStyle: 'italic' },
};
