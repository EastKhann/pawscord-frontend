const styles = {
    ...
    tabs: {
        display: 'flex', padding: '0 20px', borderBottom: '1px solid #0b0e1b', gap: '5px'
    },
    tab: {
    ...
    statCard: {
        backgroundColor: '#0d0e10', borderRadius: '8px', padding: '20px',
        display: 'flex', alignItems: 'center', gap: '15px'
    },
    statIcon: { fontSize: '32px' },
    statContent: { flex: 1 },
    statLabel: { color: '#b5bac1', fontSize: '12px', marginBottom: '5px' },
    statValue: { color: '#fff', fontSize: '24px', fontWeight: 'bold' },
    statSubtitle: { color: '#80848e', fontSize: '11px', marginTop: '3px' },
    section: { backgroundColor: '#0d0e10', borderRadius: '8px', padding: '20px' },
    ...
    activityItem: {
        ...
        backgroundColor: '#111214', borderRadius: '6px'
    },
    activityIcon: { color: '#5865f2', marginRight: '12px', fontSize: '18px' },
    activityLabel: { flex: 1, color: '#b5bac1', fontSize: '14px' },
    activityValue: { color: '#fff', fontSize: '16px', fontWeight: 'bold' },
    list: { display: 'flex', flexDirection: 'column', gap: '8px' },
    listItem: {
        display: 'flex', justifyContent: 'space-between', padding: '10px',
        backgroundColor: '#111214', borderRadius: '6px', color: '#b5bac1', fontSize: '14px'
    },
    ...
    pieLabel: { flex: 1, color: '#b5bac1', fontSize: '14px' },
    ...
    growthCard: {
        backgroundColor: '#0d0e10', borderRadius: '8px', padding: '15px',
        display: 'flex', flexDirection: 'column', gap: '8px'
    },
    growthLabel: { color: '#b5bac1', fontSize: '12px' },
    growthValue: {
    ...
    deviceCard: {
        ...
        backgroundColor: '#111214', padding: '20px', borderRadius: '8px'
    },
    deviceInfo: { display: 'flex', flexDirection: 'column', gap: '4px' },
    deviceLabel: { color: '#b5bac1', fontSize: '12px' },
