...
const DJModal = ({ onClose, ws, roomSlug }) => {
    ...
    const { overlayProps, dialogProps } = useModalA11y({ onClose, label: 'DJ Room' });
    ...
    // Socket Signalleri (CinemaModal with benzer mantık)
        ...
        <div style={styles.overlay} {...overlayProps}>
            <div style={styles.modal} {...dialogProps}>
                ...
                <div style={styles.queueList}>
                    <h4>Rankdakwithr ({queue.length})</h4>
                    {queue.map((link, i) => (
                        <div key={`item-${i}`} style={styles.queueItem}>
