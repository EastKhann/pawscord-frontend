    ...
    return (
        <div style={styles.container}>
            <div style={styles.playerWrapper}>
                ...
                {!isReady && !error && (
                    <div style={styles.statusOverlay}>
                        ...
                        <p className="mt-10">{t('common.loading')}</p>
                    </div>
                )}
                ...
                <Suspense fallback={<div>Oynatıcı yükleniyor...</div>}>
                    <ReactPlayer
                        ...
                        onError={() => {
                            setError(t('ui.video_oynatilamadi'));
                            setIsReady(true);
                        }}
                        onPlay={() => {
            ...
            <div style={styles.controls}>
                ...
                >
                    {playing ? <FaPause /> : <FaPlay className="ml-2" />}
                </button>

                <form onSubmit={handleLoadUrl} style={styles.urlForm}>
                    <FaLink className="icon-chat" />
