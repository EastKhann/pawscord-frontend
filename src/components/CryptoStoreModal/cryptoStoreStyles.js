const styles = {
    ...
    modal: { backgroundColor: '#111214', width: '100%', maxWidth: '600px', maxHeight: '90vh', borderRadius: '12px', overflow: 'hidden', border: '1px solid #0b0e1b', display: 'flex', flexDirection: 'column' },
    header: { padding: '20px', backgroundColor: '#0d0e10', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexShrink: 0 },
    ...
    balanceBar: { padding: '10px 12px', backgroundColor: '#111214', color: 'white', borderBottom: '1px solid #0b0e1b', flexShrink: 0, display: 'flex', justifyContent: 'space-between', alignItems: 'center' },
    tabs: { display: 'flex', borderBottom: '1px solid #0b0e1b', backgroundColor: '#0d0e10', flexShrink: 0 },
    ...
    itemCard: { backgroundColor: '#0d0e10', padding: '15px', borderRadius: '8px', textAlign: 'center', border: '1px solid #0b0e1b', display: 'flex', flexDirection: 'column', alignItems: 'center', color: 'white', minHeight: '180px' },
    ...
    ownedBtn: { marginTop: 'auto', padding: '12px', backgroundColor: '#1e2024', color: '#aaa', border: 'none', borderRadius: '4px', width: '100%', fontSize: '0.9em', minHeight: '44px' },
