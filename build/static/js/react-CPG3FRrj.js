...
const _TwitchVideoElement = class _TwitchVideoElement extends (globalThis.HTMLElement ?? class {
}) {
  constructor() {
    super();
    ...
    __privateAdd(this, _onMessage, /* @__PURE__ */ __name(async (event) => {
      var _a, _b, _c, _d;
...
sendCommand_fn = /* @__PURE__ */ __name(function(command, params) {
  if (!__privateGet(this, _iframe).contentWindow) return;
  const message = {
    eventName: command,
    params,
...
__name(_TwitchVideoElement, "TwitchVideoElement");
__publicField(_TwitchVideoElement, "getTemplateHTML", getTemplateHTML);
__publicField(_TwitchVideoElement, "shadowRootOptions", { mode: "open" });
__publicField(_TwitchVideoElement, "observedAttributes", ["autoplay", "controls", "loop", "muted", "playsinline", "preload", "src"]);
let TwitchVideoElement = _TwitchVideoElement;
...
__name(filterParams, "filterParams");
