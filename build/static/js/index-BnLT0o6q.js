...
let AxiosError$1 = (_a = class extends Error {
  static from(error, code, config, request, response, customProps) {
    const axiosError = new _a(error.message, code || error.code, config, request, response);
...
let CanceledError$1 = (_c = class extends AxiosError$1 {
  /**
...
let CancelToken$1 = (_e = class {
  ...
  static source() {
    let cancel;
    const token = new _e(/* @__PURE__ */ __name(function executor(c) {
      cancel = c;
    }, "executor"));
    return {
      token,
