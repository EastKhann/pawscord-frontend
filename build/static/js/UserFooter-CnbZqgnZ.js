...
import { a5 as FaDownload, az as FaCog } from "./icons-vendor-2VDeY8fW.js";
import { P as PRODUCTION_URL } from "./index-DGqPEDt8.js";
const GLASS_BG = "rgba(30, 31, 34, 0.85)";
...
const styles = {
  ...
  roomItem: {
    ...
    fontSize: "15px",
    // Oda isimleri biraz daha büyük (okunabilirlik)
    fontWeight: "500"
  },
  channelContent: {
    display: "flex",
  ...
  modalOverlay: {
    ...
    // Arkaplanı biraz daha karart
    display: "flex",
    alignItems: "center",
    justifyContent: "center",
    zIndex: 99999,
    // 🔥 Sidebar'ın üstünde görünsün
    backdropFilter: "blur(5px)"
    // Arka planı bulanıklaştır
  },
  selectionModalContent: {
    backgroundColor: "#313338",
    // Yarı saydam değil, içerik okunsun
    padding: "24px",
    borderRadius: "12px",
    width: "320px",
    maxWidth: "90%",
...
const UserFooter = /* @__PURE__ */ __name(({
  currentUserProfile,
  currentUsername,
  ...
  onUpdateClick
  // 🔥 YENİ: Güncelleme butonu click handler
}) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.bottomSection, children: [
    updateAvailable && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Güncelleme Mevcut!" })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.userPanel, onClick: onProfileClick, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.userInfo, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: styles.usernameText, children: currentUsername || "Yükleniyor..." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: styles.statusText, children: [
          "#",
          friendCode
        ] })
      ] }),
...
const UserFooter$1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: UserFooter
