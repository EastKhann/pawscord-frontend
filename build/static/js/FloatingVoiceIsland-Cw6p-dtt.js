import{d as e,r,cy as H,cA as R}from"./react-core-CecKX_Gm.js";const P=({islandState:f,onDrag:w,onResize:p,children:y,isMobile:a,headerActions:g})=>{const m=r.useRef(null),[d,o]=r.useState(!1),[i,v]=r.useState(!1),[z,s]=r.useState(!1),[S,b]=r.useState("");r.useEffect(()=>{b("island-enter");const t=setTimeout(()=>b(""),600);return()=>clearTimeout(t)},[]);const l=f||{x:a?10:window.innerWidth/2-175,y:a?60:window.innerHeight*.15,width:a?window.innerWidth-20:350,height:a?200:280},k=a?[200,150]:[320,220],E=[window.innerWidth-20,window.innerHeight-80],x=()=>{v(!i)},u=a?180:220,h=50,C=i?u:l.width,I=i?h:l.height;return e.createElement(e.Fragment,null,e.createElement("style",null,`
