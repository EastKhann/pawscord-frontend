...
const HlsVideoMixin = /* @__PURE__ */ __name((superclass) => {
  ...
  return _a = class extends superclass {
    constructor() {
      ...
      __privateAdd(this, _toggleHlsLoad, /* @__PURE__ */ __name(() => {
        var _a2, _b, _c;
    ...
    async load() {
      ...
      if (Hls.isSupported()) {
        ...
        switch (this.nativeEl.preload) {
          case "none": {
            const loadSourceOnPlay = /* @__PURE__ */ __name(() => this.api.startLoad(), "loadSourceOnPlay");
          ...
          case "metadata": {
            ...
            const increaseBufferOnPlay = /* @__PURE__ */ __name(() => {
        ...
        const switchRendition = /* @__PURE__ */ __name((event) => {
        ...
        const removeAllMediaTracks = /* @__PURE__ */ __name(() => {
  ...
  }, _airplaySourceEl = new WeakMap(), _config = new WeakMap(), _HlsVideo_instances = new WeakSet(), destroy_fn = /* @__PURE__ */ __name(function() {
    var _a2, _b;
  ...
  }, "#destroy"), _toggleHlsLoad = new WeakMap(), // This is a pattern to update property values that are set before
  ...
  }, "#upgradeProperty"), __name(_a, "HlsVideo"), __publicField(_a, "shadowRootOptions", { ...superclass.shadowRootOptions }), __publicField(_a, "getTemplateHTML", /* @__PURE__ */ __name((attrs, props = {}) => {
