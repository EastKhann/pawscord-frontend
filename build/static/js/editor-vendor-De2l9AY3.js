...
import { r as reactExports, a as React, j as jsxRuntimeExports, f as ReactDOM } from "./react-core-BiY6fgAJ.js";
import { s as shimExports, w as withSelectorExports } from "./chart-vendor-4kC5cP2G.js";
...
OrderedMap.prototype = {
  ...
  prepend: /* @__PURE__ */ __name(function(map2) {
  ...
  append: /* @__PURE__ */ __name(function(map2) {
    map2 = OrderedMap.from(map2);
    if (!map2.size) return this;
  ...
  // appear in `map`.
  subtract: /* @__PURE__ */ __name(function(map2) {
    var result = this;
    map2 = OrderedMap.from(map2);
...
Mark$1.none = [];
const _ReplaceError = class _ReplaceError extends Error {
};
__name(_ReplaceError, "ReplaceError");
let ReplaceError = _ReplaceError;
...
const _ResolvedPos = class _ResolvedPos {
  /**
  @internal
  */
...
let ResolvedPos = _ResolvedPos;
const _ResolveCache = class _ResolveCache {
  constructor() {
    this.elts = [];
    this.i = 0;
  }
...
let ResolveCache = _ResolveCache;
const resolveCacheSize = 12, resolveCache = /* @__PURE__ */ new WeakMap();
const _NodeRange = class _NodeRange {
  /**
...
const _TextNode = class _TextNode extends Node {
  /**
  @internal
  */
...
const _ContentMatch = class _ContentMatch {
  /**
  @internal
  */
...
let ContentMatch = _ContentMatch;
ContentMatch.empty = new ContentMatch(true);
const _TokenStream = class _TokenStream {
...
let NodeType$1 = (_b = class {
  ...
  */
  static compile(nodes, schema) {
    let result = /* @__PURE__ */ Object.create(null);
    nodes.forEach((name, spec) => result[name] = new _b(name, schema, spec));
...
const _MarkType = class _MarkType {
  /**
  @internal
  */
...
const _DOMParser = class _DOMParser {
  /**
...
const _ParseContext = class _ParseContext {
...
let ParseContext = _ParseContext;
...
const _DOMSerializer = class _DOMSerializer {
  /**
...
let DOMSerializer = _DOMSerializer;
...
const _MapResult = class _MapResult {
  /**
  @internal
  */
...
let MapResult = _MapResult;
const _StepMap = class _StepMap {
  /**
...
let StepMap = _StepMap;
StepMap.empty = new StepMap([]);
const _Mapping = class _Mapping {
  /**
...
let Mapping = _Mapping;
const stepsByID = /* @__PURE__ */ Object.create(null);
const _Step = class _Step {
  /**
...
__name(_Step, "Step");
let Step = _Step;
const _StepResult = class _StepResult {
  /**
  @internal
  */
...
const _AddMarkStep = class _AddMarkStep extends Step {
  /**
  Create a mark step.
  */
...
let AddMarkStep = _AddMarkStep;
Step.jsonID("addMark", AddMarkStep);
const _RemoveMarkStep = class _RemoveMarkStep extends Step {
  /**
...
let RemoveMarkStep = _RemoveMarkStep;
Step.jsonID("removeMark", RemoveMarkStep);
const _AddNodeMarkStep = class _AddNodeMarkStep extends Step {
  /**
...
let AddNodeMarkStep = _AddNodeMarkStep;
Step.jsonID("addNodeMark", AddNodeMarkStep);
const _RemoveNodeMarkStep = class _RemoveNodeMarkStep extends Step {
  /**
  Create a mark-removing step.
  */
  constructor(pos, mark) {
...
let RemoveNodeMarkStep = _RemoveNodeMarkStep;
Step.jsonID("removeNodeMark", RemoveNodeMarkStep);
const _ReplaceStep = class _ReplaceStep extends Step {
  /**
...
let ReplaceStep = _ReplaceStep;
Step.jsonID("replace", ReplaceStep);
const _ReplaceAroundStep = class _ReplaceAroundStep extends Step {
  /**
...
let ReplaceAroundStep = _ReplaceAroundStep;
...
__name(canAppendWithSubstitutedLinebreaks, "canAppendWithSubstitutedLinebreaks");
...
__name(deleteRange$1, "deleteRange$1");
...
const _AttrStep = class _AttrStep extends Step {
  /**
...
let AttrStep = _AttrStep;
Step.jsonID("attr", AttrStep);
const _DocAttrStep = class _DocAttrStep extends Step {
  /**
  Construct an attribute step.
  */
...
let DocAttrStep = _DocAttrStep;
Step.jsonID("docAttr", DocAttrStep);
let TransformError = (_c = class extends Error {
}, __name(_c, "TransformError"), _c);
...
const _SelectionRange = class _SelectionRange {
  /**
  Create a range.
  */
  constructor($from, $to) {
...
let SelectionRange = _SelectionRange;
...
const _TextSelection = class _TextSelection extends Selection {
  /**
...
let TextSelection = _TextSelection;
Selection.jsonID("text", TextSelection);
const _TextBookmark = class _TextBookmark {
...
let TextBookmark = _TextBookmark;
const _NodeSelection = class _NodeSelection extends Selection {
  /**
...
let NodeSelection = _NodeSelection;
NodeSelection.prototype.visible = false;
Selection.jsonID("node", NodeSelection);
const _NodeBookmark = class _NodeBookmark {
  constructor(anchor) {
    this.anchor = anchor;
  }
  map(mapping) {
...
let NodeBookmark = _NodeBookmark;
const _AllSelection = class _AllSelection extends Selection {
  /**
...
let AllSelection = _AllSelection;
...
__name(selectionToInsertionEnd$1, "selectionToInsertionEnd$1");
const UPDATED_SEL = 1, UPDATED_MARKS = 2, UPDATED_SCROLL = 4;
const _Transaction = class _Transaction extends Transform {
  /**
  @internal
  */
  constructor(state) {
...
__name(bind, "bind");
const _FieldDesc = class _FieldDesc {
...
const _EditorState = class _EditorState {
  /**
  @internal
  */
  constructor(config) {
...
const _PluginKey = class _PluginKey {
  /**
  Create a plugin key.
  */
...
let PluginKey = _PluginKey;
const deleteSelection$1 = /* @__PURE__ */ __name((state, dispatch) => {
...
const joinBackward$1 = /* @__PURE__ */ __name((state, dispatch, view) => {
...
const joinTextblockBackward$1 = /* @__PURE__ */ __name((state, dispatch, view) => {
  let $cursor = atBlockStart(state, view);
  if (!$cursor)
    return false;
  let $cut = findCutBefore($cursor);
  return $cut ? joinTextblocksAround(state, $cut, dispatch) : false;
}, "joinTextblockBackward$1");
const joinTextblockForward$1 = /* @__PURE__ */ __name((state, dispatch, view) => {
  let $cursor = atBlockEnd(state, view);
  if (!$cursor)
    return false;
  let $cut = findCutAfter($cursor);
  return $cut ? joinTextblocksAround(state, $cut, dispatch) : false;
}, "joinTextblockForward$1");
...
const selectNodeBackward$1 = /* @__PURE__ */ __name((state, dispatch, view) => {
...
const joinForward$1 = /* @__PURE__ */ __name((state, dispatch, view) => {
  let $cursor = atBlockEnd(state, view);
  if (!$cursor)
    return false;
  let $cut = findCutAfter($cursor);
...
const selectNodeForward$1 = /* @__PURE__ */ __name((state, dispatch, view) => {
  let { $head, empty: empty2 } = state.selection, $cut = $head;
  if (!empty2)
    return false;
  if ($head.parent.isTextblock) {
...
const joinUp$1 = /* @__PURE__ */ __name((state, dispatch) => {
...
const joinDown$1 = /* @__PURE__ */ __name((state, dispatch) => {
...
const lift$1 = /* @__PURE__ */ __name((state, dispatch) => {
...
const newlineInCode$1 = /* @__PURE__ */ __name((state, dispatch) => {
...
__name(defaultBlockAt$1, "defaultBlockAt$1");
const exitCode$1 = /* @__PURE__ */ __name((state, dispatch) => {
  let { $head, $anchor } = state.selection;
  if (!$head.parent.type.spec.code || !$head.sameParent($anchor))
    return false;
...
const createParagraphNear$1 = /* @__PURE__ */ __name((state, dispatch) => {
...
const liftEmptyBlock$1 = /* @__PURE__ */ __name((state, dispatch) => {
  let { $cursor } = state.selection;
...
__name(wrapInList$1, "wrapInList$1");
...
__name(wrapRangeInList, "wrapRangeInList");
...
__name(liftListItem$1, "liftListItem$1");
...
__name(sinkListItem$1, "sinkListItem$1");
const domIndex = /* @__PURE__ */ __name(function(node) {
...
const parentNode = /* @__PURE__ */ __name(function(node) {
  let parent = node.assignedSlot || node.parentNode;
  return parent && parent.nodeType == 11 ? parent.host : parent;
}, "parentNode");
let reusedRange = null;
const textRange = /* @__PURE__ */ __name(function(node, from2, to) {
  let range = reusedRange || (reusedRange = document.createRange());
  range.setEnd(node, to == null ? node.nodeValue.length : to);
  range.setStart(node, from2 || 0);
  return range;
}, "textRange");
const clearReusedRange = /* @__PURE__ */ __name(function() {
  reusedRange = null;
}, "clearReusedRange");
const isEquivalentPosition = /* @__PURE__ */ __name(function(node, off, targetNode, targetOff) {
...
const selectionCollapsed = /* @__PURE__ */ __name(function(domSel) {
...
const _ViewDesc = class _ViewDesc {
...
let ViewDesc = _ViewDesc;
const _WidgetViewDesc = class _WidgetViewDesc extends ViewDesc {
...
let WidgetViewDesc = _WidgetViewDesc;
const _CompositionViewDesc = class _CompositionViewDesc extends ViewDesc {
...
let CompositionViewDesc = _CompositionViewDesc;
const _MarkViewDesc = class _MarkViewDesc extends ViewDesc {
...
let MarkViewDesc = _MarkViewDesc;
const _NodeViewDesc = class _NodeViewDesc extends ViewDesc {
...
let NodeViewDesc = _NodeViewDesc;
...
const _TextViewDesc = class _TextViewDesc extends NodeViewDesc {
...
let TextViewDesc = _TextViewDesc;
const _TrailingHackViewDesc = class _TrailingHackViewDesc extends ViewDesc {
  parseRule() {
    return { ignore: true };
  }
  matchesHack(nodeName) {
...
let TrailingHackViewDesc = _TrailingHackViewDesc;
const _CustomNodeViewDesc = class _CustomNodeViewDesc extends NodeViewDesc {
...
let CustomNodeViewDesc = _CustomNodeViewDesc;
...
const OuterDecoLevel = /* @__PURE__ */ __name(function(nodeName) {
  if (nodeName)
...
__name(rm, "rm");
const _ViewTreeUpdater = class _ViewTreeUpdater {
...
let ViewTreeUpdater = _ViewTreeUpdater;
...
function maybeWrapTrusted(html) {
  ...
  if (!trustedTypes)
    return html;
  if (!_policy)
    _policy = trustedTypes.defaultPolicy || trustedTypes.createPolicy("ProseMirrorClipboard", { createHTML: /* @__PURE__ */ __name((s) => s, "createHTML") });
  return _policy.createHTML(html);
}
__name(maybeWrapTrusted, "maybeWrapTrusted");
...
const _InputState = class _InputState {
  constructor() {
    this.shiftKey = false;
    this.mouseDown = null;
...
editHandlers.keypress = (view, _event) => {
  ...
  if (!(sel instanceof TextSelection) || !sel.$from.sameParent(sel.$to)) {
    ...
    let deflt = /* @__PURE__ */ __name(() => view.state.tr.insertText(text).scrollIntoView(), "deflt");
...
const _MouseDown = class _MouseDown {
...
__name(selectionBeforeUneditable, "selectionBeforeUneditable");
...
const _Dragging = class _Dragging {
...
let Dragging = _Dragging;
const dragCopyModifier = mac$2 ? "altKey" : "ctrlKey";
function dragMoves(view, event) {
  let moves = view.someProp("dragCopies", (test) => !test(event));
  return moves != null ? moves : !event[dragCopyModifier];
}
__name(dragMoves, "dragMoves");
...
const _WidgetType = class _WidgetType {
...
let WidgetType = _WidgetType;
const _InlineType = class _InlineType {
...
const _Decoration = class _Decoration {
  /**
  @internal
  */
...
let Decoration = _Decoration;
const none = [], noSpec = {};
const _DecorationSet = class _DecorationSet {
  /**
  @internal
  */
...
let DecorationSet = _DecorationSet;
DecorationSet.empty = new DecorationSet([], []);
DecorationSet.removeOverlap = removeOverlap;
const empty = DecorationSet.empty;
const _DecorationGroup = class _DecorationGroup {
  constructor(members) {
...
let DecorationGroup = _DecorationGroup;
...
const _SelectionState = class _SelectionState {
  constructor() {
...
let SelectionState = _SelectionState;
const _DOMObserver = class _DOMObserver {
...
function readDOMChange(view, from2, to, typeOver, addedNodes) {
  ...
  let mkTr = /* @__PURE__ */ __name((base2) => {
  ...
  if (inlineChange) {
    if ($from.pos == $to.pos) {
      ...
      let deflt = /* @__PURE__ */ __name(() => mkTr(view.state.tr.insertText(text, chFrom, chTo)), "deflt");
...
const _EditorView = class _EditorView {
  /**
...
__name(normalizeKeyName$1, "normalizeKeyName$1");
...
var __export$1 = /* @__PURE__ */ __name((target, all) => {
  for (var name in all)
...
var CommandManager = (_d = class {
  ...
  createCan(startTr) {
    ...
    return {
      ...formattedCommands,
      chain: /* @__PURE__ */ __name(() => this.createChain(tr2, dispatch), "chain")
    };
  }
  buildProps(tr2, shouldDispatch = true) {
    ...
    const props = {
      ...
      chain: /* @__PURE__ */ __name(() => this.createChain(tr2, shouldDispatch), "chain"),
      can: /* @__PURE__ */ __name(() => this.createCan(tr2), "can"),
      get commands() {
        return Object.fromEntries(
          Object.entries(rawCommands).map(([name, command2]) => {
...
}, __name(_d, "CommandManager"), _d);
var commands_exports = {};
__export$1(commands_exports, {
  blur: /* @__PURE__ */ __name(() => blur, "blur"),
  clearContent: /* @__PURE__ */ __name(() => clearContent, "clearContent"),
  clearNodes: /* @__PURE__ */ __name(() => clearNodes, "clearNodes"),
  command: /* @__PURE__ */ __name(() => command, "command"),
  createParagraphNear: /* @__PURE__ */ __name(() => createParagraphNear, "createParagraphNear"),
  cut: /* @__PURE__ */ __name(() => cut, "cut"),
  deleteCurrentNode: /* @__PURE__ */ __name(() => deleteCurrentNode, "deleteCurrentNode"),
  deleteNode: /* @__PURE__ */ __name(() => deleteNode, "deleteNode"),
  deleteRange: /* @__PURE__ */ __name(() => deleteRange, "deleteRange"),
  deleteSelection: /* @__PURE__ */ __name(() => deleteSelection, "deleteSelection"),
  enter: /* @__PURE__ */ __name(() => enter, "enter"),
  exitCode: /* @__PURE__ */ __name(() => exitCode, "exitCode"),
  extendMarkRange: /* @__PURE__ */ __name(() => extendMarkRange, "extendMarkRange"),
  first: /* @__PURE__ */ __name(() => first, "first"),
  focus: /* @__PURE__ */ __name(() => focus, "focus"),
  forEach: /* @__PURE__ */ __name(() => forEach, "forEach"),
  insertContent: /* @__PURE__ */ __name(() => insertContent, "insertContent"),
  insertContentAt: /* @__PURE__ */ __name(() => insertContentAt, "insertContentAt"),
  joinBackward: /* @__PURE__ */ __name(() => joinBackward, "joinBackward"),
  joinDown: /* @__PURE__ */ __name(() => joinDown, "joinDown"),
  joinForward: /* @__PURE__ */ __name(() => joinForward, "joinForward"),
  joinItemBackward: /* @__PURE__ */ __name(() => joinItemBackward, "joinItemBackward"),
  joinItemForward: /* @__PURE__ */ __name(() => joinItemForward, "joinItemForward"),
  joinTextblockBackward: /* @__PURE__ */ __name(() => joinTextblockBackward, "joinTextblockBackward"),
  joinTextblockForward: /* @__PURE__ */ __name(() => joinTextblockForward, "joinTextblockForward"),
  joinUp: /* @__PURE__ */ __name(() => joinUp, "joinUp"),
  keyboardShortcut: /* @__PURE__ */ __name(() => keyboardShortcut, "keyboardShortcut"),
  lift: /* @__PURE__ */ __name(() => lift, "lift"),
  liftEmptyBlock: /* @__PURE__ */ __name(() => liftEmptyBlock, "liftEmptyBlock"),
  liftListItem: /* @__PURE__ */ __name(() => liftListItem, "liftListItem"),
  newlineInCode: /* @__PURE__ */ __name(() => newlineInCode, "newlineInCode"),
  resetAttributes: /* @__PURE__ */ __name(() => resetAttributes, "resetAttributes"),
  scrollIntoView: /* @__PURE__ */ __name(() => scrollIntoView, "scrollIntoView"),
  selectAll: /* @__PURE__ */ __name(() => selectAll, "selectAll"),
  selectNodeBackward: /* @__PURE__ */ __name(() => selectNodeBackward, "selectNodeBackward"),
  selectNodeForward: /* @__PURE__ */ __name(() => selectNodeForward, "selectNodeForward"),
  selectParentNode: /* @__PURE__ */ __name(() => selectParentNode, "selectParentNode"),
  selectTextblockEnd: /* @__PURE__ */ __name(() => selectTextblockEnd, "selectTextblockEnd"),
  selectTextblockStart: /* @__PURE__ */ __name(() => selectTextblockStart, "selectTextblockStart"),
  setContent: /* @__PURE__ */ __name(() => setContent, "setContent"),
  setMark: /* @__PURE__ */ __name(() => setMark, "setMark"),
  setMeta: /* @__PURE__ */ __name(() => setMeta, "setMeta"),
  setNode: /* @__PURE__ */ __name(() => setNode, "setNode"),
  setNodeSelection: /* @__PURE__ */ __name(() => setNodeSelection, "setNodeSelection"),
  setTextDirection: /* @__PURE__ */ __name(() => setTextDirection, "setTextDirection"),
  setTextSelection: /* @__PURE__ */ __name(() => setTextSelection, "setTextSelection"),
  sinkListItem: /* @__PURE__ */ __name(() => sinkListItem, "sinkListItem"),
  splitBlock: /* @__PURE__ */ __name(() => splitBlock, "splitBlock"),
  splitListItem: /* @__PURE__ */ __name(() => splitListItem, "splitListItem"),
  toggleList: /* @__PURE__ */ __name(() => toggleList, "toggleList"),
  toggleMark: /* @__PURE__ */ __name(() => toggleMark, "toggleMark"),
  toggleNode: /* @__PURE__ */ __name(() => toggleNode, "toggleNode"),
  toggleWrap: /* @__PURE__ */ __name(() => toggleWrap, "toggleWrap"),
  undoInputRule: /* @__PURE__ */ __name(() => undoInputRule, "undoInputRule"),
  unsetAllMarks: /* @__PURE__ */ __name(() => unsetAllMarks, "unsetAllMarks"),
  unsetMark: /* @__PURE__ */ __name(() => unsetMark, "unsetMark"),
  unsetTextDirection: /* @__PURE__ */ __name(() => unsetTextDirection, "unsetTextDirection"),
  updateAttributes: /* @__PURE__ */ __name(() => updateAttributes, "updateAttributes"),
  wrapIn: /* @__PURE__ */ __name(() => wrapIn, "wrapIn"),
  wrapInList: /* @__PURE__ */ __name(() => wrapInList, "wrapInList")
});
var blur = /* @__PURE__ */ __name(() => ({ editor, view }) => {
...
var clearContent = /* @__PURE__ */ __name((emitUpdate = true) => ({ commands }) => {
  return commands.setContent("", { emitUpdate });
}, "clearContent");
var clearNodes = /* @__PURE__ */ __name(() => ({ state, tr: tr2, dispatch }) => {
  const { selection } = tr2;
...
var command = /* @__PURE__ */ __name((fn) => (props) => {
  return fn(props);
}, "command");
var createParagraphNear = /* @__PURE__ */ __name(() => ({ state, dispatch }) => {
  return createParagraphNear$1(state, dispatch);
}, "createParagraphNear");
var cut = /* @__PURE__ */ __name((originRange, targetPos) => ({ editor, tr: tr2 }) => {
  const { state } = editor;
...
var deleteCurrentNode = /* @__PURE__ */ __name(() => ({ tr: tr2, dispatch }) => {
  const { selection } = tr2;
...
var deleteNode = /* @__PURE__ */ __name((typeOrName) => ({ tr: tr2, state, dispatch }) => {
...
var deleteRange = /* @__PURE__ */ __name((range) => ({ tr: tr2, dispatch }) => {
...
var enter = /* @__PURE__ */ __name(() => ({ commands }) => {
...
var extendMarkRange = /* @__PURE__ */ __name((typeOrName, attributes = {}) => ({ tr: tr2, state, dispatch }) => {
...
var first = /* @__PURE__ */ __name((commands) => (props) => {
...
__name(isiOS, "isiOS");
var focus = /* @__PURE__ */ __name((position = null, options = {}) => ({ editor, view, tr: tr2, dispatch }) => {
  options = {
    scrollIntoView: true,
    ...options
  };
...
var forEach = /* @__PURE__ */ __name((items, fn) => (props) => {
  return items.every((item, index) => fn(item, { ...props, index }));
}, "forEach");
var insertContent = /* @__PURE__ */ __name((value, options) => ({ tr: tr2, commands }) => {
  return commands.insertContentAt({ from: tr2.selection.from, to: tr2.selection.to }, value, options);
}, "insertContent");
var removeWhitespaces = /* @__PURE__ */ __name((node) => {
...
var isFragment = /* @__PURE__ */ __name((nodeOrFragment) => {
  return !("type" in nodeOrFragment);
}, "isFragment");
var insertContentAt = /* @__PURE__ */ __name((position, value, options) => ({ tr: tr2, dispatch, editor }) => {
  var _a2;
  if (dispatch) {
    options = {
    ...
    let content;
    const emitContentError = /* @__PURE__ */ __name((error) => {
...
var joinBackward = /* @__PURE__ */ __name(() => ({ state, dispatch }) => {
  return joinBackward$1(state, dispatch);
}, "joinBackward");
var joinForward = /* @__PURE__ */ __name(() => ({ state, dispatch }) => {
  return joinForward$1(state, dispatch);
}, "joinForward");
var joinItemBackward = /* @__PURE__ */ __name(() => ({ state, dispatch, tr: tr2 }) => {
  try {
...
var joinItemForward = /* @__PURE__ */ __name(() => ({ state, dispatch, tr: tr2 }) => {
  try {
    const point = joinPoint(state.doc, state.selection.$from.pos, 1);
    if (point === null || point === void 0) {
      return false;
...
var joinTextblockBackward = /* @__PURE__ */ __name(() => ({ state, dispatch }) => {
  return joinTextblockBackward$1(state, dispatch);
}, "joinTextblockBackward");
var joinTextblockForward = /* @__PURE__ */ __name(() => ({ state, dispatch }) => {
...
var keyboardShortcut = /* @__PURE__ */ __name((name) => ({ editor, view, tr: tr2, dispatch }) => {
...
var lift = /* @__PURE__ */ __name((typeOrName, attributes = {}) => ({ state, dispatch }) => {
  const type = getNodeType(typeOrName, state.schema);
...
var liftListItem = /* @__PURE__ */ __name((typeOrName) => ({ state, dispatch }) => {
  const type = getNodeType(typeOrName, state.schema);
...
var resetAttributes = /* @__PURE__ */ __name((typeOrName, attributes) => ({ tr: tr2, state, dispatch }) => {
  let nodeType = null;
  let markType = null;
...
var scrollIntoView = /* @__PURE__ */ __name(() => ({ tr: tr2, dispatch }) => {
  if (dispatch) {
    tr2.scrollIntoView();
  }
  return true;
}, "scrollIntoView");
var selectAll = /* @__PURE__ */ __name(() => ({ tr: tr2, dispatch }) => {
  if (dispatch) {
...
var selectNodeBackward = /* @__PURE__ */ __name(() => ({ state, dispatch }) => {
  return selectNodeBackward$1(state, dispatch);
}, "selectNodeBackward");
var selectNodeForward = /* @__PURE__ */ __name(() => ({ state, dispatch }) => {
  return selectNodeForward$1(state, dispatch);
}, "selectNodeForward");
var selectParentNode = /* @__PURE__ */ __name(() => ({ state, dispatch }) => {
  return selectParentNode$1(state, dispatch);
}, "selectParentNode");
var selectTextblockEnd = /* @__PURE__ */ __name(() => ({ state, dispatch }) => {
  return selectTextblockEnd$1(state, dispatch);
}, "selectTextblockEnd");
var selectTextblockStart = /* @__PURE__ */ __name(() => ({ state, dispatch }) => {
...
var setContent = /* @__PURE__ */ __name((content, { errorOnInvalidContent, emitUpdate = true, parseOptions = {} } = {}) => ({ editor, tr: tr2, dispatch, commands }) => {
  const { doc: doc2 } = tr2;
...
__name(flattenExtensions, "flattenExtensions");
...
function buildAttributeSpec(extensionAttribute) {
  ...
  if (((_b2 = extensionAttribute == null ? void 0 : extensionAttribute.attribute) == null ? void 0 : _b2.validate) !== void 0) {
    spec.validate = extensionAttribute.attribute.validate;
  }
  return [extensionAttribute.name, spec];
}
__name(buildAttributeSpec, "buildAttributeSpec");
...
__name(sortExtensions, "sortExtensions");
...
var getNodeAtPosition = /* @__PURE__ */ __name((state, typeOrName, pos, maxDepth = 20) => {
...
var getTextContentFromNodes = /* @__PURE__ */ __name(($from, maxMatch = 500) => {
  let textBefore = "";
  const sliceEndPos = $from.parentOffset;
  $from.parent.nodesBetween(Math.max(0, sliceEndPos - maxMatch), sliceEndPos, (node, pos, parent, index) => {
    var _a2, _b2;
    const chunk = ((_b2 = (_a2 = node.type.spec).toText) == null ? void 0 : _b2.call(_a2, {
      node,
      pos,
      parent,
      index
...
var isAtEndOfNode = /* @__PURE__ */ __name((state, nodeType) => {
...
var isAtStartOfNode = /* @__PURE__ */ __name((state) => {
...
}, __name(_e, "_MappablePosition"), _e);
...
__name(getUpdatedPosition, "getUpdatedPosition");
function createMappablePosition(position) {
  return new MappablePosition(position);
}
__name(createMappablePosition, "createMappablePosition");
...
var setMark = /* @__PURE__ */ __name((typeOrName, attributes = {}) => ({ tr: tr2, state, dispatch }) => {
  const { selection } = tr2;
...
var setMeta = /* @__PURE__ */ __name((key, value) => ({ tr: tr2 }) => {
  tr2.setMeta(key, value);
  return true;
}, "setMeta");
var setNode = /* @__PURE__ */ __name((typeOrName, attributes = {}) => ({ state, dispatch, chain }) => {
  const type = getNodeType(typeOrName, state.schema);
...
var setNodeSelection = /* @__PURE__ */ __name((position) => ({ tr: tr2, dispatch }) => {
  if (dispatch) {
    const { doc: doc2 } = tr2;
...
var setTextDirection = /* @__PURE__ */ __name((direction, position) => ({ tr: tr2, state, dispatch }) => {
...
var setTextSelection = /* @__PURE__ */ __name((position) => ({ tr: tr2, dispatch }) => {
  if (dispatch) {
    const { doc: doc2 } = tr2;
...
var sinkListItem = /* @__PURE__ */ __name((typeOrName) => ({ state, dispatch }) => {
  const type = getNodeType(typeOrName, state.schema);
...
var splitBlock = /* @__PURE__ */ __name(({ keepMarks = true } = {}) => ({ tr: tr2, state, dispatch, editor }) => {
...
var splitListItem = /* @__PURE__ */ __name((typeOrName, overrideAttrs = {}) => ({ tr: tr2, state, dispatch, editor }) => {
  var _a2;
  const type = getNodeType(typeOrName, state.schema);
  const { $from, $to } = state.selection;
...
var joinListBackwards = /* @__PURE__ */ __name((tr2, listType) => {
...
var joinListForwards = /* @__PURE__ */ __name((tr2, listType) => {
  const list = findParentNode((node) => node.type === listType)(tr2.selection);
  if (!list) {
    return true;
  }
...
var toggleList = /* @__PURE__ */ __name((listTypeOrName, itemTypeOrName, keepMarks, attributes = {}) => ({ editor, tr: tr2, state, dispatch, chain, commands, can }) => {
...
var toggleMark = /* @__PURE__ */ __name((typeOrName, attributes = {}, options = {}) => ({ state, commands }) => {
...
var toggleNode = /* @__PURE__ */ __name((typeOrName, toggleTypeOrName, attributes = {}) => ({ state, commands }) => {
  const type = getNodeType(typeOrName, state.schema);
...
var toggleWrap = /* @__PURE__ */ __name((typeOrName, attributes = {}) => ({ state, commands }) => {
  const type = getNodeType(typeOrName, state.schema);
  const isActive2 = isNodeActive(state, type, attributes);
  if (isActive2) {
...
var unsetAllMarks = /* @__PURE__ */ __name(() => ({ tr: tr2, dispatch }) => {
  const { selection } = tr2;
  const { empty: empty2, ranges } = selection;
  if (empty2) {
    return true;
...
var unsetMark = /* @__PURE__ */ __name((typeOrName, options = {}) => ({ tr: tr2, state, dispatch }) => {
  var _a2;
  const { extendEmptyMarkRange = false } = options;
  const { selection } = tr2;
  const type = getMarkType(typeOrName, state.schema);
...
var unsetTextDirection = /* @__PURE__ */ __name((position) => ({ tr: tr2, state, dispatch }) => {
  const { selection } = state;
  let from2;
  let to;
  if (typeof position === "number") {
...
var updateAttributes = /* @__PURE__ */ __name((typeOrName, attributes = {}) => ({ tr: tr2, state, dispatch }) => {
  let nodeType = null;
  let markType = null;
  const schemaType = getSchemaTypeNameByName(
    typeof typeOrName === "string" ? typeOrName : typeOrName.name,
...
var wrapIn = /* @__PURE__ */ __name((typeOrName, attributes = {}) => ({ state, dispatch }) => {
  const type = getNodeType(typeOrName, state.schema);
  return wrapIn$1(type, attributes)(state, dispatch);
}, "wrapIn");
var wrapInList = /* @__PURE__ */ __name((typeOrName, attributes = {}) => ({ state, dispatch }) => {
  const type = getNodeType(typeOrName, state.schema);
...
}, __name(_f, "EventEmitter"), _f);
var InputRule = (_g = class {
  constructor(config) {
    var _a2;
...
}, __name(_g, "InputRule"), _g);
var inputRuleMatcherHandler = /* @__PURE__ */ __name((text, find2) => {
  if (isRegExp(find2)) {
...
}, __name(_h, "Extendable"), _h);
var Mark = (_i = class extends Extendable {
  constructor() {
    super(...arguments);
    this.type = "mark";
  }
...
var PasteRule = (_j = class {
  constructor(config) {
    this.find = config.find;
    this.handler = config.handler;
  }
}, __name(_j, "PasteRule"), _j);
var pasteRuleMatcherHandler = /* @__PURE__ */ __name((text, find2, event) => {
  if (isRegExp(find2)) {
...
function run2(config) {
  ...
  state.doc.nodesBetween(from2, to, (node, pos) => {
    ...
    if (((_b2 = (_a2 = node.type) == null ? void 0 : _a2.spec) == null ? void 0 : _b2.code) || !(node.isText || node.isTextblock || node.isInline)) {
      return;
    }
    const contentSize = (_e2 = (_d2 = (_c2 = node.content) == null ? void 0 : _c2.size) != null ? _d2 : node.nodeSize) != null ? _e2 : 0;
...
var createClipboardPasteEvent = /* @__PURE__ */ __name((text) => {
  var _a2;
...
function pasteRulesPlugin(props) {
  ...
  const processEvent = /* @__PURE__ */ __name(({
    state,
    from: from2,
    to,
    rule,
  ...
  get markViews() {
    ...
    return Object.fromEntries(
      markExtensions.filter((extension) => !!getExtensionField(extension, "addMarkView")).map((extension) => {
        ...
        const markView = /* @__PURE__ */ __name((mark, view, inline) => {
          ...
          return addMarkView()({
            ...
            extension,
            HTMLAttributes,
            updateAttributes: /* @__PURE__ */ __name((attrs) => {
...
}, __name(_k, "ExtensionManager"), _k);
ExtensionManager.resolve = resolveExtensions;
ExtensionManager.sort = sortExtensions;
ExtensionManager.flatten = flattenExtensions;
var extensions_exports = {};
__export$1(extensions_exports, {
  ClipboardTextSerializer: /* @__PURE__ */ __name(() => ClipboardTextSerializer, "ClipboardTextSerializer"),
  Commands: /* @__PURE__ */ __name(() => Commands, "Commands"),
  Delete: /* @__PURE__ */ __name(() => Delete, "Delete"),
  Drop: /* @__PURE__ */ __name(() => Drop, "Drop"),
  Editable: /* @__PURE__ */ __name(() => Editable, "Editable"),
  FocusEvents: /* @__PURE__ */ __name(() => FocusEvents, "FocusEvents"),
  Keymap: /* @__PURE__ */ __name(() => Keymap, "Keymap"),
  Paste: /* @__PURE__ */ __name(() => Paste, "Paste"),
  Tabindex: /* @__PURE__ */ __name(() => Tabindex, "Tabindex"),
  TextDirection: /* @__PURE__ */ __name(() => TextDirection, "TextDirection"),
  focusEventsPluginKey: /* @__PURE__ */ __name(() => focusEventsPluginKey, "focusEventsPluginKey")
});
var Extension = (_l = class extends Extendable {
  constructor() {
    super(...arguments);
    this.type = "extension";
  }
...
var Delete = Extension.create({
  ...
  onUpdate({ transaction, appendedTransactions }) {
    ...
    const callback = /* @__PURE__ */ __name(() => {
      ...
      if ((_d2 = (_c22 = (_b22 = (_a22 = this.editor.options.coreExtensionOptions) == null ? void 0 : _a22.delete) == null ? void 0 : _b22.filterTransaction) == null ? void 0 : _c22.call(_b22, transaction)) != null ? _d2 : transaction.getMeta("y-sync$")) {
        return;
      }
    ...
    if ((_c2 = (_b2 = (_a2 = this.editor.options.coreExtensionOptions) == null ? void 0 : _a2.delete) == null ? void 0 : _b2.async) != null ? _c2 : true) {
  ...
  addProseMirrorPlugins() {
    return [
      new Plugin({
        ...
        props: {
          handleDrop: /* @__PURE__ */ __name((_, e, slice2, moved) => {
...
var Keymap = Extension.create({
  name: "keymap",
  addKeyboardShortcuts() {
    const handleBackspace2 = /* @__PURE__ */ __name(() => this.editor.commands.first(({ commands }) => [
    ...
    const handleDelete2 = /* @__PURE__ */ __name(() => this.editor.commands.first(({ commands }) => [
      () => commands.deleteSelection(),
      () => commands.deleteCurrentNode(),
      () => commands.joinForward(),
      () => commands.selectNodeForward()
    ]), "handleDelete");
    const handleEnter = /* @__PURE__ */ __name(() => this.editor.commands.first(({ commands }) => [
  ...
  addProseMirrorPlugins() {
    return [
      new Plugin({
        ...
        props: {
          handlePaste: /* @__PURE__ */ __name((_view, e, slice2) => {
...
var NodePos = (_m = class {
  ...
  get children() {
    ...
    this.node.content.forEach((node, offset) => {
      ...
      const childNodePos = new _m($pos, this.editor, isBlock, isBlock ? node : null);
      if (isBlock) {
        childNodePos.actualDepth = this.depth + 1;
      }
      children.push(new _m($pos, this.editor, isBlock, isBlock ? node : null));
    });
    return children;
  }
  get firstChild() {
...
var Editor = (_n = class extends EventEmitter {
  constructor(options = {}) {
    super();
    this.css = null;
    ...
    this.options = {
      ...
      onMount: /* @__PURE__ */ __name(() => null, "onMount"),
      onUnmount: /* @__PURE__ */ __name(() => null, "onUnmount"),
      ...
      onDelete: /* @__PURE__ */ __name(() => null, "onDelete")
    };
    ...
    return new Proxy(
      {
        ...
        updateState: /* @__PURE__ */ __name((state) => {
          this.editorState = state;
        }, "updateState"),
        dispatch: /* @__PURE__ */ __name((tr2) => {
  ...
  createExtensionManager() {
    ...
    const coreExtensions = this.options.enableCoreExtensions ? [
      ...
      ClipboardTextSerializer.configure({
        blockSeparator: (_b2 = (_a2 = this.options.coreExtensionOptions) == null ? void 0 : _a2.clipboardTextSerializer) == null ? void 0 : _b2.blockSeparator
      }),
      Commands,
      FocusEvents,
      Keymap,
  ...
  get isDestroyed() {
    var _a2, _b2;
    return (_b2 = (_a2 = this.editorView) == null ? void 0 : _a2.isDestroyed) != null ? _b2 : true;
  }
...
__name(canInsertNode, "canInsertNode");
var markdown_exports = {};
__export$1(markdown_exports, {
  createAtomBlockMarkdownSpec: /* @__PURE__ */ __name(() => createAtomBlockMarkdownSpec, "createAtomBlockMarkdownSpec"),
  createBlockMarkdownSpec: /* @__PURE__ */ __name(() => createBlockMarkdownSpec, "createBlockMarkdownSpec"),
  createInlineMarkdownSpec: /* @__PURE__ */ __name(() => createInlineMarkdownSpec, "createInlineMarkdownSpec"),
  parseAttributes: /* @__PURE__ */ __name(() => parseAttributes, "parseAttributes"),
  parseIndentedBlocks: /* @__PURE__ */ __name(() => parseIndentedBlocks, "parseIndentedBlocks"),
  renderNestedMarkdownContent: /* @__PURE__ */ __name(() => renderNestedMarkdownContent, "renderNestedMarkdownContent"),
  serializeAttributes: /* @__PURE__ */ __name(() => serializeAttributes, "serializeAttributes")
});
...
function createAtomBlockMarkdownSpec(options) {
  ...
  const filterAttributes = /* @__PURE__ */ __name((attrs) => {
  ...
  return {
    parseMarkdown: /* @__PURE__ */ __name((token, h2) => {
    ...
    renderMarkdown: /* @__PURE__ */ __name((node) => {
...
__name(createAtomBlockMarkdownSpec, "createAtomBlockMarkdownSpec");
function createBlockMarkdownSpec(options) {
  ...
  return {
    ...
    renderMarkdown: /* @__PURE__ */ __name((node, h2) => {
      const filteredAttrs = filterAttributes(node.attrs || {});
      const attrs = serializeAttributes2(filteredAttrs);
      const attrString = attrs ? ` {${attrs}}` : "";
...
__name(createBlockMarkdownSpec, "createBlockMarkdownSpec");
...
__name(parseShortcodeAttributes, "parseShortcodeAttributes");
function serializeShortcodeAttributes(attrs) {
  return Object.entries(attrs).filter(([, value]) => value !== void 0 && value !== null).map(([key, value]) => `${key}="${value}"`).join(" ");
}
__name(serializeShortcodeAttributes, "serializeShortcodeAttributes");
...
__name(createInlineMarkdownSpec, "createInlineMarkdownSpec");
...
`;
      ...
      const nextIndent = ((_d2 = (_c2 = nextLine.match(/^(\s*)/)) == null ? void 0 : _c2[1]) == null ? void 0 : _d2.length) || 0;
...
__name(parseIndentedBlocks, "parseIndentedBlocks");
...
__name(renderNestedMarkdownContent, "renderNestedMarkdownContent");
...
__name(updateMarkViewAttributes, "updateMarkViewAttributes");
var Node3 = (_o = class extends Extendable {
  constructor() {
    super(...arguments);
    this.type = "node";
  }
...
var mergeRefs = /* @__PURE__ */ __name((...refs) => {
  return (node) => {
    refs.forEach((ref) => {
...
var Portals = /* @__PURE__ */ __name(({ contentComponent }) => {
...
var PureEditorContent = (_p = class extends React.Component {
  constructor(props) {
    var _a2;
    super(props);
...
}, __name(_p, "PureEditorContent"), _p);
...
var EditorStateManager = (_q = class {
...
}, __name(_q, "EditorStateManager"), _q);
...
__name(useEditorState, "useEditorState");
var isDev = false;
var isSSR = typeof window === "undefined";
var isNext = isSSR || Boolean(typeof window !== "undefined" && window.next);
var EditorInstanceManager = (_r = class {
  constructor(options) {
    this.editor = null;
  ...
  createEditor() {
    const optionsToApply = {
      ...
      onBeforeCreate: /* @__PURE__ */ __name((...args) => {
        var _a2, _b2;
        return (_b2 = (_a2 = this.options.current).onBeforeCreate) == null ? void 0 : _b2.call(_a2, ...args);
      }, "onBeforeCreate"),
      onBlur: /* @__PURE__ */ __name((...args) => {
        var _a2, _b2;
        return (_b2 = (_a2 = this.options.current).onBlur) == null ? void 0 : _b2.call(_a2, ...args);
      }, "onBlur"),
      onCreate: /* @__PURE__ */ __name((...args) => {
        var _a2, _b2;
        return (_b2 = (_a2 = this.options.current).onCreate) == null ? void 0 : _b2.call(_a2, ...args);
      }, "onCreate"),
      onDestroy: /* @__PURE__ */ __name((...args) => {
        var _a2, _b2;
        return (_b2 = (_a2 = this.options.current).onDestroy) == null ? void 0 : _b2.call(_a2, ...args);
      }, "onDestroy"),
      onFocus: /* @__PURE__ */ __name((...args) => {
        var _a2, _b2;
        return (_b2 = (_a2 = this.options.current).onFocus) == null ? void 0 : _b2.call(_a2, ...args);
      }, "onFocus"),
      onSelectionUpdate: /* @__PURE__ */ __name((...args) => {
        var _a2, _b2;
        return (_b2 = (_a2 = this.options.current).onSelectionUpdate) == null ? void 0 : _b2.call(_a2, ...args);
      }, "onSelectionUpdate"),
      onTransaction: /* @__PURE__ */ __name((...args) => {
        var _a2, _b2;
        return (_b2 = (_a2 = this.options.current).onTransaction) == null ? void 0 : _b2.call(_a2, ...args);
      }, "onTransaction"),
      onUpdate: /* @__PURE__ */ __name((...args) => {
        var _a2, _b2;
        return (_b2 = (_a2 = this.options.current).onUpdate) == null ? void 0 : _b2.call(_a2, ...args);
      }, "onUpdate"),
      onContentError: /* @__PURE__ */ __name((...args) => {
        var _a2, _b2;
        return (_b2 = (_a2 = this.options.current).onContentError) == null ? void 0 : _b2.call(_a2, ...args);
      }, "onContentError"),
      onDrop: /* @__PURE__ */ __name((...args) => {
        var _a2, _b2;
        return (_b2 = (_a2 = this.options.current).onDrop) == null ? void 0 : _b2.call(_a2, ...args);
      }, "onDrop"),
      onPaste: /* @__PURE__ */ __name((...args) => {
        var _a2, _b2;
        return (_b2 = (_a2 = this.options.current).onPaste) == null ? void 0 : _b2.call(_a2, ...args);
      }, "onPaste"),
      onDelete: /* @__PURE__ */ __name((...args) => {
        var _a2, _b2;
        return (_b2 = (_a2 = this.options.current).onDelete) == null ? void 0 : _b2.call(_a2, ...args);
      }, "onDelete")
    };
  ...
  onRender(deps) {
    return () => {
      ...
      if (this.editor && !this.editor.isDestroyed && deps.length === 0) {
        if (!_r.compareOptions(this.options.current, this.editor.options)) {
...
}, __name(_r, "_EditorInstanceManager"), _r);
function useEditor(options = {}, deps = []) {
  ...
  useEditorState({
    editor,
    selector: /* @__PURE__ */ __name(({ transactionNumber }) => {
...
var ReactNodeViewContext = reactExports.createContext({
  ...
  nodeViewContentRef: /* @__PURE__ */ __name(() => {
  }, "nodeViewContentRef")
});
var useReactNodeView = /* @__PURE__ */ __name(() => reactExports.useContext(ReactNodeViewContext), "useReactNodeView");
...
React.createContext({
  markViewContentRef: /* @__PURE__ */ __name(() => {
  }, "markViewContentRef")
});
var h = /* @__PURE__ */ __name((tag, attributes) => {
  if (tag === "slot") {
    return 0;
  }
...
var Blockquote = Node3.create({
  ...
  parseMarkdown: /* @__PURE__ */ __name((token, helpers) => {
...
`);
  ...
  addCommands() {
    return {
      setBlockquote: /* @__PURE__ */ __name(() => ({ commands }) => {
        return commands.wrapIn(this.name);
      }, "setBlockquote"),
      toggleBlockquote: /* @__PURE__ */ __name(() => ({ commands }) => {
        return commands.toggleWrap(this.name);
      }, "toggleBlockquote"),
      unsetBlockquote: /* @__PURE__ */ __name(() => ({ commands }) => {
...
var Bold = Mark.create({
  ...
  addCommands() {
    return {
      setBold: /* @__PURE__ */ __name(() => ({ commands }) => {
        return commands.setMark(this.name);
      }, "setBold"),
      toggleBold: /* @__PURE__ */ __name(() => ({ commands }) => {
        return commands.toggleMark(this.name);
      }, "toggleBold"),
      unsetBold: /* @__PURE__ */ __name(() => ({ commands }) => {
...
var Code = Mark.create({
  ...
  addCommands() {
    return {
      setCode: /* @__PURE__ */ __name(() => ({ commands }) => {
        return commands.setMark(this.name);
      }, "setCode"),
      toggleCode: /* @__PURE__ */ __name(() => ({ commands }) => {
        return commands.toggleMark(this.name);
      }, "toggleCode"),
      unsetCode: /* @__PURE__ */ __name(() => ({ commands }) => {
        return commands.unsetMark(this.name);
      }, "unsetCode")
    };
  },
...
\`\`\``;
  ...
  addCommands() {
    return {
      setCodeBlock: /* @__PURE__ */ __name((attributes) => ({ commands }) => {
        return commands.setNode(this.name, attributes);
      }, "setCodeBlock"),
      toggleCodeBlock: /* @__PURE__ */ __name((attributes) => ({ commands }) => {
  ...
  addKeyboardShortcuts() {
    return {
      ...
      "Shift-Tab": /* @__PURE__ */ __name(({ editor }) => {
        var _a2;
        if (!this.options.enableTabIndentation) {
          return false;
        }
...
var HardBreak = Node3.create({
  ...
  renderMarkdown: /* @__PURE__ */ __name(() => `  
`, "renderMarkdown"),
  parseMarkdown: /* @__PURE__ */ __name(() => {
    return {
      type: "hardBreak"
    };
  }, "parseMarkdown"),
  addCommands() {
    return {
      setHardBreak: /* @__PURE__ */ __name(() => ({ commands, chain, state, editor }) => {
...
var Heading = Node3.create({
  ...
  addCommands() {
    return {
      setHeading: /* @__PURE__ */ __name((attributes) => ({ commands }) => {
        if (!this.options.levels.includes(attributes.level)) {
          return false;
        }
        return commands.setNode(this.name, attributes);
      }, "setHeading"),
      toggleHeading: /* @__PURE__ */ __name((attributes) => ({ commands }) => {
        if (!this.options.levels.includes(attributes.level)) {
          return false;
        }
        return commands.toggleNode(this.name, "paragraph", attributes);
...
var Italic = Mark.create({
  ...
  addCommands() {
    return {
      setItalic: /* @__PURE__ */ __name(() => ({ commands }) => {
        return commands.setMark(this.name);
      }, "setItalic"),
      toggleItalic: /* @__PURE__ */ __name(() => ({ commands }) => {
        return commands.toggleMark(this.name);
      }, "toggleItalic"),
      unsetItalic: /* @__PURE__ */ __name(() => ({ commands }) => {
        return commands.unsetMark(this.name);
      }, "unsetItalic")
    };
  },
...
__name(registerGroup, "registerGroup");
...
__name(addToGroups, "addToGroups");
...
__name(flagsForToken, "flagsForToken");
...
const ta = /* @__PURE__ */ __name((state, input, next, flags, groups) => state.ta(input, next, flags, groups), "ta");
const tr = /* @__PURE__ */ __name((state, regexp, next, flags, groups) => state.tr(regexp, next, flags, groups), "tr");
const ts = /* @__PURE__ */ __name((state, input, next, flags, groups) => state.ts(input, next, flags, groups), "ts");
const tt = /* @__PURE__ */ __name((state, input, next, flags, groups) => state.tt(input, next, flags, groups), "tt");
const WORD = "WORD";
const UWORD = "UWORD";
...
function createTokenClass(type, props) {
  const _Token = class _Token extends MultiToken {
...
__name(createTokenClass, "createTokenClass");
...
const makeState = /* @__PURE__ */ __name((arg) => new State(arg), "makeState");
function init$1({
  groups
}) {
...
__name(initMultiToken, "initMultiToken");
...
__name(registerCustomProtocol, "registerCustomProtocol");
function init() {
  ...
  return new Plugin({
    ...
    props: {
      handleClick: /* @__PURE__ */ __name((view, pos, event) => {
        ...
        const target = (_b2 = link == null ? void 0 : link.target) != null ? _b2 : attrs.target;
...
function pasteHandler(options) {
  return new Plugin({
    ...
    props: {
      handlePaste: /* @__PURE__ */ __name((view, _event, slice2) => {
...
var BulletList = Node3.create({
  ...
  addCommands() {
    return {
      toggleBulletList: /* @__PURE__ */ __name(() => ({ commands, chain }) => {
...
var ListItem = Node3.create({
  ...
  renderMarkdown: /* @__PURE__ */ __name((node, h2, ctx) => {
...
__export(listHelpers_exports, {
  findListItemPos: /* @__PURE__ */ __name(() => findListItemPos, "findListItemPos"),
  getNextListDepth: /* @__PURE__ */ __name(() => getNextListDepth, "getNextListDepth"),
  handleBackspace: /* @__PURE__ */ __name(() => handleBackspace, "handleBackspace"),
  handleDelete: /* @__PURE__ */ __name(() => handleDelete, "handleDelete"),
  hasListBefore: /* @__PURE__ */ __name(() => hasListBefore, "hasListBefore"),
  hasListItemAfter: /* @__PURE__ */ __name(() => hasListItemAfter, "hasListItemAfter"),
  hasListItemBefore: /* @__PURE__ */ __name(() => hasListItemBefore, "hasListItemBefore"),
  listItemHasSubList: /* @__PURE__ */ __name(() => listItemHasSubList, "listItemHasSubList"),
  nextListIsDeeper: /* @__PURE__ */ __name(() => nextListIsDeeper, "nextListIsDeeper"),
  nextListIsHigher: /* @__PURE__ */ __name(() => nextListIsHigher, "nextListIsHigher")
});
var findListItemPos = /* @__PURE__ */ __name((typeOrName, state) => {
...
var getNextListDepth = /* @__PURE__ */ __name((typeOrName, state) => {
...
var hasListBefore = /* @__PURE__ */ __name((editorState, name, parentListTypes) => {
...
var hasListItemBefore = /* @__PURE__ */ __name((typeOrName, state) => {
  var _a2;
...
var listItemHasSubList = /* @__PURE__ */ __name((typeOrName, state, node) => {
  if (!node) {
    return false;
  }
  const nodeType = getNodeType(typeOrName, state.schema);
...
var handleBackspace = /* @__PURE__ */ __name((editor, name, parentListTypes) => {
...
var nextListIsDeeper = /* @__PURE__ */ __name((typeOrName, state) => {
...
var nextListIsHigher = /* @__PURE__ */ __name((typeOrName, state) => {
  const listDepth = getNextListDepth(typeOrName, state);
  const listItemPos = findListItemPos(typeOrName, state);
  if (!listItemPos || !listDepth) {
    return false;
...
var handleDelete = /* @__PURE__ */ __name((editor, name) => {
  if (!isNodeActive(editor.state, name)) {
    return false;
  }
...
var hasListItemAfter = /* @__PURE__ */ __name((typeOrName, state) => {
  var _a2;
  const { $anchor } = state.selection;
...
var ListKeymap = Extension.create({
  ...
  addKeyboardShortcuts() {
    return {
      ...
      "Mod-Delete": /* @__PURE__ */ __name(({ editor }) => {
        let handled = false;
        this.options.listTypes.forEach(({ itemName }) => {
          if (editor.state.schema.nodes[itemName] === void 0) {
            return;
      ...
      Backspace: /* @__PURE__ */ __name(({ editor }) => {
        let handled = false;
      ...
      "Mod-Backspace": /* @__PURE__ */ __name(({ editor }) => {
        let handled = false;
        this.options.listTypes.forEach(({ itemName, wrapperNames }) => {
          if (editor.state.schema.nodes[itemName] === void 0) {
            return;
...
__name(collectOrderedListItems, "collectOrderedListItems");
...
__name(buildNestedStructure, "buildNestedStructure");
...
__name(parseListItems, "parseListItems");
...
var OrderedList = Node3.create({
  ...
  markdownTokenizer: {
    name: "orderedList",
    level: "block",
    start: /* @__PURE__ */ __name((src) => {
      const match = src.match(/^(\s*)(\d+)\.\s+/);
      const index = match == null ? void 0 : match.index;
      return index !== void 0 ? index : -1;
    }, "start"),
    tokenize: /* @__PURE__ */ __name((src, _tokens, lexer) => {
      var _a2;
      const lines = src.split("\n");
  ...
  addCommands() {
    return {
      toggleOrderedList: /* @__PURE__ */ __name(() => ({ commands, chain }) => {
        if (this.options.keepAttributes) {
  ...
  addInputRules() {
    ...
    if (this.options.keepMarks || this.options.keepAttributes) {
      inputRule = wrappingInputRule({
        ...
        keepMarks: this.options.keepMarks,
        keepAttributes: this.options.keepAttributes,
        getAttributes: /* @__PURE__ */ __name((match) => ({ start: +match[1], ...this.editor.getAttributes(TextStyleName2) }), "getAttributes"),
        joinPredicate: /* @__PURE__ */ __name((match, node) => node.childCount + node.attrs.start === +match[1], "joinPredicate"),
        editor: this.editor
      });
    }
...
var TaskItem = Node3.create({
  ...
  addNodeView() {
    return ({ node, HTMLAttributes, getPos, editor }) => {
      ...
      const updateA11Y = /* @__PURE__ */ __name((currentNode) => {
        var _a2, _b2;
        checkbox.ariaLabel = ((_b2 = (_a2 = this.options.a11y) == null ? void 0 : _a2.checkboxLabel) == null ? void 0 : _b2.call(_a2, currentNode, checkbox.checked)) || `Task item checkbox for ${currentNode.textContent || "empty task item"}`;
      }, "updateA11Y");
      updateA11Y(node);
      ...
      return {
        dom: listItem,
        contentDOM: content,
        update: /* @__PURE__ */ __name((updatedNode) => {
...
var TaskList = Node3.create({
  ...
  markdownTokenizer: {
    ...
    tokenize(src, tokens, lexer) {
      const parseTaskListContent = /* @__PURE__ */ __name((content) => {
        const nestedResult = parseIndentedBlocks(
          content,
          {
            itemPattern: /^(\s*)([-+*])\s+\[([ xX])\]\s+(.*)$/,
            extractItemData: /* @__PURE__ */ __name((match) => ({
              indentLevel: match[1].length,
              mainContent: match[4],
              checked: match[3].toLowerCase() === "x"
            }), "extractItemData"),
            createToken: /* @__PURE__ */ __name((data, nestedTokens) => ({
              type: "taskItem",
              raw: "",
  ...
  addCommands() {
    return {
      toggleTaskList: /* @__PURE__ */ __name(() => ({ commands }) => {
  ...
  addKeyboardShortcuts() {
    return {
      "Mod-Shift-9": /* @__PURE__ */ __name(() => this.editor.commands.toggleTaskList(), "Mod-Shift-9")
    };
  }
});
Extension.create({
...
var Paragraph = Node3.create({
  ...
  addCommands() {
    return {
      setParagraph: /* @__PURE__ */ __name(() => ({ commands }) => {
...
var Strike = Mark.create({
  ...
  addCommands() {
    return {
      setStrike: /* @__PURE__ */ __name(() => ({ commands }) => {
        return commands.setMark(this.name);
      }, "setStrike"),
      toggleStrike: /* @__PURE__ */ __name(() => ({ commands }) => {
        return commands.toggleMark(this.name);
      }, "toggleStrike"),
      unsetStrike: /* @__PURE__ */ __name(() => ({ commands }) => {
        return commands.unsetMark(this.name);
      }, "unsetStrike")
    };
  },
...
var Text = Node3.create({
  name: "text",
  group: "inline",
  parseMarkdown: /* @__PURE__ */ __name((token) => {
    return {
      type: "text",
      text: token.text || ""
    };
  }, "parseMarkdown"),
  renderMarkdown: /* @__PURE__ */ __name((node) => node.text || "", "renderMarkdown")
});
var Underline = Mark.create({
  ...
  parseHTML() {
    return [
      ...
      },
      {
        style: "text-decoration",
        consuming: false,
        getAttrs: /* @__PURE__ */ __name((style2) => style2.includes("underline") ? {} : false, "getAttrs")
      }
    ];
  },
  renderHTML({ HTMLAttributes }) {
  ...
  addCommands() {
    return {
      setUnderline: /* @__PURE__ */ __name(() => ({ commands }) => {
        return commands.setMark(this.name);
      }, "setUnderline"),
      toggleUnderline: /* @__PURE__ */ __name(() => ({ commands }) => {
        return commands.toggleMark(this.name);
      }, "toggleUnderline"),
      unsetUnderline: /* @__PURE__ */ __name(() => ({ commands }) => {
        return commands.unsetMark(this.name);
      }, "unsetUnderline")
    };
  },
  addKeyboardShortcuts() {
    return {
      "Mod-u": /* @__PURE__ */ __name(() => this.editor.commands.toggleUnderline(), "Mod-u"),
      "Mod-U": /* @__PURE__ */ __name(() => this.editor.commands.toggleUnderline(), "Mod-U")
    };
  }
});
...
const _DropCursorView = class _DropCursorView {
...
let DropCursorView = _DropCursorView;
const _GapCursor = class _GapCursor extends Selection {
  /**
  Create a gap cursor.
  */
  constructor($pos) {
...
let GapCursor = _GapCursor;
GapCursor.prototype.visible = false;
GapCursor.findFrom = GapCursor.findGapCursorFrom;
Selection.jsonID("gapcursor", GapCursor);
const _GapBookmark = class _GapBookmark {
  constructor(pos) {
    this.pos = pos;
  }
  map(mapping) {
...
let GapBookmark = _GapBookmark;
function needsGap(type) {
  return type.isAtom || type.spec.isolating || type.spec.createGapCursor;
}
__name(needsGap, "needsGap");
...
RopeSequence.prototype.forEach = /* @__PURE__ */ __name(function forEach2(f, from2, to) {
  if (from2 === void 0) from2 = 0;
  if (to === void 0) to = this.length;
  if (from2 <= to) {
...
__name(_Item, "Item");
let Item = _Item;
const _HistoryState = class _HistoryState {
...
let HistoryState = _HistoryState;
...
Extension.create({
  ...
  addOptions() {
    return {
      limit: null,
      mode: "textSize",
      textCounter: /* @__PURE__ */ __name((text) => text.length, "textCounter"),
      wordCounter: /* @__PURE__ */ __name((text) => text.split(" ").filter((word) => word !== "").length, "wordCounter")
    };
  },
  addStorage() {
    return {
      characters: /* @__PURE__ */ __name(() => 0, "characters"),
      words: /* @__PURE__ */ __name(() => 0, "words")
    };
  },
  onBeforeCreate() {
  ...
  addProseMirrorPlugins() {
    ...
    return [
      new Plugin({
        ...
        filterTransaction: /* @__PURE__ */ __name((transaction, state) => {
          const limit = this.options.limit;
  ...
  addProseMirrorPlugins() {
    return [
      new Plugin({
        ...
        props: {
          decorations: /* @__PURE__ */ __name(({ doc: doc2, selection }) => {
...
__name(nodeEqualsType, "nodeEqualsType");
var TrailingNode = Extension.create({
  ...
  addProseMirrorPlugins() {
    ...
    return [
      new Plugin({
        key: plugin,
        appendTransaction: /* @__PURE__ */ __name((_, __, state) => {
        ...
        state: {
          init: /* @__PURE__ */ __name((_, state) => {
            const lastNode = state.tr.doc.lastChild;
            return !nodeEqualsType({ node: lastNode, types: disabledNodes });
          }, "init"),
          apply: /* @__PURE__ */ __name((tr2, value) => {
            if (!tr2.docChanged) {
              return value;
            }
