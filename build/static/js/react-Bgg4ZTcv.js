...
const _YoutubeVideoElement = class _YoutubeVideoElement extends (globalThis.HTMLElement ?? class {
}) {
  constructor() {
    super();
...
__name(_YoutubeVideoElement, "YoutubeVideoElement");
__publicField(_YoutubeVideoElement, "getTemplateHTML", getTemplateHTML);
__publicField(_YoutubeVideoElement, "shadowRootOptions", { mode: "open" });
__publicField(_YoutubeVideoElement, "observedAttributes", [
  "autoplay",
  "controls",
  "crossorigin",
  "loop",
...
let YoutubeVideoElement = _YoutubeVideoElement;
...
async function loadScript(src, globalName, readyFnName) {
  ...
  return loadScriptCache[src] = new Promise(function(resolve, reject) {
    ...
    script.src = src;
    const ready = /* @__PURE__ */ __name(() => resolve(self[globalName]), "ready");
...
__name(createPlayPromise, "createPlayPromise");
