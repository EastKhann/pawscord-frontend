...
const _TikTokVideoElement = class _TikTokVideoElement extends (globalThis.HTMLElement ?? class {
  ...
  constructor() {
    ...
    __privateAdd(this, _onMessage, /* @__PURE__ */ __name((event) => {
      var _a;
...
post_fn = /* @__PURE__ */ __name(function(type, value) {
  var _a;
...
__name(_TikTokVideoElement, "TikTokVideoElement");
