...
import { A as API_BASE_URL, t as toast } from "./index-DGqPEDt8.js";
import { b as useNavigate, L as Link } from "./router-vendor-DrLUSS4j.js";
import { A as FaArrowLeft, P as FaTrophy, I as FaRedo, S as FaCheckDouble, w as FaCheckCircle, x as FaTimesCircle } from "./icons-vendor-2VDeY8fW.js";
import "./media-vendor-BRMiuG2Y.js";
import "./state-vendor-BeEHnF_A.js";
import "./crypto-vendor-NANfm9jb.js";
import "./ui-vendor-iPoN0WGz.js";
const LEVELS = [
  // export ekledim ki başka yerden çekilebilsin
  { id: "A1", name: "A1 - Başlangıç", color: "#43b581", icon: "🌱" },
  { id: "A2", name: "A2 - Temel", color: "#faa61a", icon: "🚀" },
  { id: "B1", name: "B1 - Orta", color: "#f04747", icon: "🔥" },
  { id: "B2", name: "B2 - Orta Üst", color: "#9b59b6", icon: "💎" },
  { id: "C1", name: "C1 - İleri", color: "#e91e63", icon: "👑" },
  { id: "C2", name: "C2 - Uzman", color: "#2f3136", icon: "🐉" }
  // Yeni C2 Seviyesi (Dragon)
];
const QUESTIONS_DB = [];
const A1_QUESTIONS = [
  // =================================================================
...
QUESTIONS_DB.push(...A1_QUESTIONS);
const A2_QUESTIONS = [
...
QUESTIONS_DB.push(...A2_QUESTIONS);
const B1_QUESTIONS = [
...
QUESTIONS_DB.push(...B1_QUESTIONS);
const B2_QUESTIONS = [
...
QUESTIONS_DB.push(...B2_QUESTIONS);
const C1_QUESTIONS = [
  // --- NEGATIVE INVERSION (DEVRİK CÜMLELER) ---
  {
    id: 501,
    level: "C1",
    type: "choice",
    question: "Seldom _____ such a remarkable display of talent.",
    options: ["one sees", "has one seen", "one has seen", "sees one"],
    answer: "has one seen",
    explanation: {
      title: "Negative Inversion (Devrik Yapı)",
      rule: "'Seldom', 'Rarely', 'Never', 'Little' gibi olumsuzluk veya kısıtlama bildiren zarflar cümle başına geldiğinde, cümle devrik olur (Soru formatı gibi: Yardımcı Fiil + Özne).",
      tips: "Normal: One has seldom seen... | Devrik: Seldom HAS ONE seen...",
      examples: [
        "Never have I felt so lonely.",
        "Rarely do we see such beauty.",
        "Little did he know the truth."
      ],
      translation: "Böylesine olağanüstü bir yetenek gösterisi nadiren görülmüştür."
    }
  },
  {
    id: 502,
    level: "C1",
    type: "choice",
    question: "Not until I saw him _____ realize he was your brother.",
    options: ["I did", "did I", "that I", "I had"],
    answer: "did I",
    explanation: {
      title: "Inversion with 'Not Until'",
      rule: "'Not until' yapısı cümle başında kullanıldığında, devrik yapı (inversion) ANA cümlede (ikinci kısımda) gerçekleşir.",
      tips: "Not until [zaman/olay] + [Yardımcı Fiil + Özne + Fiil]",
      examples: [
        "Not until midnight did the noise stop.",
        "Not until she spoke did I recognize her."
      ],
      translation: "Onu görene kadar senin kardeşin olduğunu fark etmemiştim."
    }
  },
  // --- SUBJUNCTIVE (WOULD RATHER) ---
  {
    ...
    answer: "went",
    explanation: {
      title: "Would Rather (Özne Değişikliği)",
      rule: "'Would rather' kalıbında, eğer bir başkasının bir şey yapmasını istiyorsak (I -> You), şimdiki zaman veya gelecek için 'Past Simple' kullanılır.",
      tips: "Aynı özne: I would rather go. | Farklı özne: I would rather YOU went.",
      examples: [
        "I'd rather you didn't smoke here.",
        "My mom would rather I studied medicine."
      ],
      translation: "Şimdi eve gitmeni tercih ederim."
    }
  },
  // --- INVERTED CONDITIONAL TYPE 3 ---
  {
    ...
    level: "C1",
    type: "input",
    question: "_____ (be) it not for your help, I would have failed.",
    answer: "Had",
    explanation: {
      title: "Inverted Conditional (Type 3 - If'siz)",
      rule: "'If it hadn't been for...' (Olmasaydı...) kalıbının daha resmi, edebi ve 'If' kullanılmayan hali 'Had it not been for...' yapısıdır.",
      tips: "Type 2: Were it not for... | Type 3: Had it not been for...",
      examples: [
        "Had I known you were ill, I would have visited.",
        "Had it not been for the rain, we would have played."
      ],
      translation: "Senin yardımın olmasaydı (o zaman), başarısız olurdum."
    }
  },
  // --- PASSIVE REPORTING (PERFECT INFINITIVE) ---
  {
    id: 505,
    level: "C1",
    type: "choice",
    question: "The thief is believed _____ the country last week.",
    options: ["to leave", "to have left", "leaving", "having left"],
    answer: "to have left",
    explanation: {
      title: "Passive Reporting (Perfect Infinitive)",
      rule: "Edilgen çatıdan sonra gelen eylem, ana eylemden daha önce gerçekleşmişse 'to have + V3' kullanılır. İnanılma eylemi şimdi, kaçma eylemi geçmişte.",
      tips: "is believed (Şimdi) -> to have left (Geçmişte)",
      examples: [
        "She is said to have won the lottery. (Kazandığı söyleniyor)",
        "The fire is thought to have started in the kitchen."
      ],
      translation: "Hırsızın geçen hafta ülkeyi terk ettiğine inanılıyor."
    }
  },
  // --- CLEFT SENTENCES (VURGULAMA) ---
  {
    id: 506,
    level: "C1",
    type: "choice",
    question: "It was _____ John who broke the window.",
    options: ["him", "he", "-", "that"],
    answer: "-",
    explanation: {
      title: "Cleft Sentences (Vurgu)",
      rule: "'It was John who...' yapısında, vurgulanan öğe (John) zaten bellidir. Araya 'him' veya 'he' gibi ekstra zamir gelmez.",
      tips: "It is/was + [Vurgulanan Öğe] + that/who...",
      examples: [
        "It was my brother who called.",
        "It is the money that matters."
      ],
      translation: "Pencereyi kıran (başkası değil) John'du."
    }
  },
  {
    id: 507,
    level: "C1",
    type: "choice",
    question: "All I did _____ give him a chance.",
    options: ["was", "were", "is", "was to"],
    answer: "was to",
    explanation: {
      title: "Pseudo-Cleft Sentences",
      rule: "'All I did was (to) do...' yapısında 'to' kullanımı opsiyoneldir ancak şıklarda 'was to' en gramatik ve resmi olanıdır. 'Was' da kabul edilir ama 'was to' tam yapıdır.",
      tips: "All I want is to be happy.",
      examples: [
        "What I did was to tell the truth.",
        "All she needs is to sleep."
      ],
      translation: "Yaptığım tek şey ona bir şans vermekti."
    }
  },
  // --- SUBJUNCTIVE (ESSENTIAL / VITAL) ---
  {
    id: 508,
    level: "C1",
    type: "input",
    question: "It is essential that every student _____ (be) informed.",
    answer: "be",
    explanation: {
      title: "Subjunctive Mood",
      rule: "'It is essential, vital, important, mandatory that...' kalıplarından sonraki fiil, özne ne olursa olsun YALIN (bare) kullanılır. 'Is/Are' yerine 'Be' gelir.",
      tips: "That he GO (Goes değil) | That she BE (Is değil)",
      examples: [
        "I suggest that he see a doctor.",
        "It is vital that the machine be turned off."
      ],
      translation: "Her öğrencinin bilgilendirilmesi esastır."
    }
  },
  // --- VERB PATTERNS (OBJECT TO) ---
  {
    id: 509,
    level: "C1",
    type: "choice",
    question: "We objected _____ to work on Sunday.",
    options: ["to have", "to having", "having", "have"],
    answer: "to having",
    explanation: {
      title: "Object To + Gerund",
      rule: "'Object to' (itiraz etmek) kalıbındaki 'to' bir edattır (preposition), mastar eki değildir. Bu yüzden kendisinden sonra isim veya V-ing gelir.",
      tips: "Object to DOING something.",
      examples: [
        "I object to paying extra.",
        "She objects to being treated like a child."
      ],
      translation: "Pazar günü çalışmak zorunda olmaya itiraz ettik."
    }
  },
  // --- INVERSION (UNDER NO CIRCUMSTANCES) ---
  {
    ...
    level: "C1",
    type: "choice",
    question: "Under no circumstances _____ the door be opened.",
    options: ["should", "you should", "should you", "to"],
    answer: "should",
    explanation: {
      title: "Negative Inversion (Yasak)",
      rule: "'Under no circumstances' (hiçbir koşulda) yapısı başta ise cümle devrik olur. Pasif yapıdaki 'be opened' ile birleşince yardımcı fiil 'should' öne gelir.",
      tips: "Under no circumstances SHOULD X be done.",
      examples: [
        "Under no circumstances must you tell him.",
        "At no time did I say that."
      ],
      translation: "Kapı, hiçbir koşul altında açılmamalıdır."
    }
  },
  // --- PARTICIPLE CLAUSES ---
  {
    ...
    level: "C1",
    type: "choice",
    question: "_____ from the distance, the mountain looked blue.",
    options: ["Seen", "Seeing", "To see", "Having seen"],
    answer: "Seen",
    explanation: {
      title: "Past Participle Clause (Passive)",
      rule: "Cümlenin öznesi (the mountain) eylemi yapan değil, eyleme maruz kalan ise (görülen), Past Participle (V3) ile başlanır.",
      tips: "Uzun hali: When it was seen from...",
      examples: [
        "Written in 1920, the book is still popular.",
        "Built by Romans, the wall stands strong."
      ],
      translation: "Uzaktan bakıldığında (görüldüğünde) dağ mavi görünüyordu."
    }
  },
  {
    id: 512,
    level: "C1",
    type: "choice",
    question: "Not _____ what to do, she called the police.",
    options: ["know", "known", "knowing", "knew"],
    answer: "knowing",
    explanation: {
      title: "Present Participle Clause (Active)",
      rule: "Sebep bildiren cümlelerde (Because she didn't know...), aktif bir eylem söz konusuysa 'Not + V-ing' ile kısaltma yapılır.",
      tips: "Knowing the answer, he raised his hand.",
      examples: [
        "Not wanting to wake him, I left quietly.",
        "Feeling tired, I went to bed."
      ],
      translation: "Ne yapacağını bilemediği için polisi aradı."
    }
  },
  // --- MIXED CONDITIONALS ---
  {
    ...
    level: "C1",
    type: "input",
    question: "If you _____ (listen) to my advice, you wouldn't be in this mess now.",
    answer: "had listened",
    explanation: {
      title: "Mixed Conditional (Geçmiş Sebep, Şu Anki Sonuç)",
      rule: "Geçmişteki bir eylemin (had listened), şu anki sonucunu (wouldn't be) anlatırken Tip 3 ve Tip 2 karıştırılır.",
      tips: "If + Past Perfect (Geçmiş) -> Would + V1 (Şimdi)",
      examples: [
        "If I had eaten breakfast, I wouldn't be hungry now.",
        "If he had taken the job, he would be living in Paris."
      ],
      translation: "Tavsiyemi dinlemiş olsaydın, şu an bu pisliğin içinde olmazdın."
    }
  },
  // --- FUTURE IN THE PAST ---
  {
    ...
    level: "C1",
    type: "choice",
    question: "I was _____ to call you, but my phone died.",
    options: ["about", "thinking", "planning", "due"],
    answer: "about",
    explanation: {
      title: "Future in the Past (Was about to)",
      rule: "'Was/Were about to do' kalıbı, geçmişte 'tam yapmak üzereydim' anlamı katar.",
      tips: "I was about to leave. (Tam çıkmak üzereydim.)",
      examples: [
        "He was about to cry.",
        "We were about to start the meeting."
      ],
      translation: "Tam seni aramak üzereydim ama şarjım bitti."
    }
  },
  // --- WISH / IF ONLY (WOULD FOR ANNOYANCE) ---
  {
    id: 515,
    level: "C1",
    type: "choice",
    ...
    explanation: {
      title: "Wish + Would (Şikayet)",
      rule: "Bir başkasının yaptığı ve bizi rahatsız eden bir davranışı değiştirmesini isterken 'I wish ... would' kullanılır.",
      tips: "Kendi eylemlerimiz için 'would' kullanılmaz, başkası için kullanılır.",
      examples: [
        "I wish it would stop raining.",
        "I wish he would shut up."
      ],
      translation: "Keşke sözümü kesmeyi bıraksan! (Bırakmanı istiyorum)"
    }
  },
  // ... (Mevcut C1 sorularının altına ekle) ...
  // --- CLEFT SENTENCES (VURGULU CÜMLELER - WHAT) ---
  {
    id: 516,
    level: "C1",
    type: "choice",
    question: "_____ I really need right now is a long holiday.",
    options: ["That", "What", "Which", "All what"],
    answer: "What",
    explanation: {
      title: "Wh-Cleft Sentences",
      rule: "Cümleye vurgu yapmak için 'What' ile başlayan isim cümlecikleri kullanılır. 'İhtiyacım olan şey...' anlamını verir.",
      tips: "What + Subject + Verb + IS + ...",
      examples: ["What she said was true.", "What matters is your happiness."],
      translation: "Şu an gerçekten ihtiyacım olan şey uzun bir tatil."
    }
  },
  // --- INVERSION (NOWHERE) ---
  {
    ...
    level: "C1",
    type: "choice",
    question: "Nowhere _____ I seen such chaos.",
    options: ["have", "did", "was", "will"],
    // Düzeltilmiş options
    answer: "have",
    explanation: {
      title: "Negative Inversion (Nowhere)",
      rule: "'Nowhere' (hiçbir yerde) olumsuzluk bildiren bir yer zarfı olarak başa gelirse cümle devrik olur.",
      tips: "Nowhere HAVE I seen... (Görmedim)",
      examples: ["Nowhere else will you find this price."],
      translation: "Hiçbir yerde böyle bir kaos görmedim."
    }
  },
  // --- PARTICIPLE CLAUSES (REASON) ---
  {
    ...
    level: "C1",
    type: "choice",
    question: "_____ a teacher, he knows how to handle children.",
    options: ["Being", "Been", "To be", "Having"],
    answer: "Being",
    explanation: {
      title: "Participle Clause (Reason)",
      rule: "'Because he is a teacher' yerine kısaltma olarak 'Being a teacher' kullanılır. Sebep bildirir.",
      tips: "Being + Noun/Adjective = Olduğu için",
      examples: ["Being tired, I went to bed."],
      translation: "Öğretmen olduğu için çocuklarla nasıl başa çıkacağını biliyor."
    }
  },
  // --- FUTURE IN THE PAST ---
  {
    ...
    level: "C1",
    type: "choice",
    question: "I was _____ to leave when the phone rang.",
    options: ["thinking", "due", "about", "planning"],
    answer: "about",
    explanation: {
      title: "Be About To (Tam yapacakken)",
      rule: "'Be about to do something', bir şeyin hemen gerçekleşmek üzere olduğunu (o an) anlatır.",
      tips: "Was about to = Tam yapacaktım ki...",
      examples: ["I was about to call you."],
      translation: "Telefon çaldığında tam çıkmak üzereydim."
    }
  },
  // --- CONJUNCTIONS (ALBEIT) ---
  {
    ...
    level: "C1",
    type: "choice",
    question: "The journey was fascinating, _____ tiring.",
    options: ["despite", "although", "albeit", "even"],
    answer: "albeit",
    explanation: {
      title: "Albeit (Her ne kadar ... olsa da)",
      rule: "'Albeit', 'although it is/was' anlamına gelen oldukça resmi bir bağlaçtır. Genelde sıfatlar veya zarflarla kullanılır.",
      tips: "Fascinating, albeit tiring. (Yorucu olsa da büyüleyici)",
      examples: ["He accepted the job, albeit with some hesitation."],
      translation: "Yorucu olsa da, yolculuk büyüleyiciydi."
    }
  },
  // --- PASSIVE (TO BE DONE) ---
  {
    ...
    level: "C1",
    type: "choice",
    question: "There is a lot of work _____.",
    options: ["to do", "to be done", "doing", "being done"],
    answer: "to be done",
    explanation: {
      title: "Passive Infinitive",
      rule: "'There is something to be done' (Yapılması gereken bir şey var) kalıbı. 'To do' da kullanılabilir ancak 'to be done' işin kendisine odaklanır (edilgen).",
      tips: "Work to be done.",
      examples: ["There are bills to be paid."],
      translation: "Yapılacak (yapılması gereken) çok iş var."
    }
  },
  // --- MODALS (DARE) ---
  {
    ...
    options: ["do", "are", "dare", "have"],
    answer: "dare",
    explanation: {
      title: "Semi-Modal (Dare)",
      rule: "'How dare you' (Bu ne cüret/Nasıl cüret edersin) kalıplaşmış bir sitem ifadesidir.",
      tips: "Öfke veya şok belirtir.",
      examples: ["Don't you dare touch it!"],
      translation: "Benimle bu şekilde konuşmaya nasıl cüret edersin?"
    }
  },
  // --- INVERTED CONDITIONAL (SHOULD) ---
  {
    ...
    level: "C1",
    type: "input",
    question: "_____ (should) you need any help, please let me know.",
    answer: "Should",
    explanation: {
      title: "Inverted Type 1 (Should)",
      rule: "'If you should need' yerine 'If' atılır ve 'Should' başa gelir. Olasılığı düşük ama mümkün durumlarda nezaket için kullanılır.",
      tips: "Should you require... (İhtiyacınız olursa)",
      examples: ["Should it rain, we will cancel."],
      translation: "Olur da yardıma ihtiyacın olursa, lütfen bana haber ver."
    }
  },
  // --- PHRASAL VERBS (LOOK UP TO) ---
  {
    ...
    level: "C1",
    type: "choice",
    question: "I have always looked _____ to my father.",
    options: ["up", "down", "forward", "on"],
    answer: "up",
    explanation: {
      title: "Look Up To (Hayranlık Duymak)",
      rule: "'Look up to someone': Birine saygı duymak, örnek almak, hayran olmak.",
      tips: "Respect = Look up to",
      examples: ["Students look up to their teachers."],
      translation: "Babama her zaman hayranlık duymuşumdur."
    }
  },
  // --- ADJECTIVES (BOUND TO) ---
  {
    ...
    level: "C1",
    type: "choice",
    question: "It is _____ to rain later; look at the clouds.",
    options: ["bound", "due", "set", "about"],
    answer: "bound",
    explanation: {
      title: "Bound To (Kesin/Kaçınılmaz)",
      rule: "'Be bound to do something': Bir şeyin olmasının kaçınılmaz veya çok yüksek ihtimal olduğunu belirtir.",
      tips: "Certain to happen.",
      examples: ["He is bound to win."],
      translation: "Birazdan yağmur yağması kaçınılmaz (kesin gibi)."
    }
  },
  // --- SUBJUNCTIVE (LEST) ---
  {
    ...
    level: "C1",
    type: "choice",
    question: "He ran away lest he _____ be seen.",
    options: ["should", "would", "will", "might"],
    answer: "should",
    explanation: {
      title: "Lest (Olur da ... diye / Korkusuyla)",
      rule: "'Lest' eski ve edebi bir bağlaçtır. Kendisinden sonra genellikle 'should' veya subjunctive (yalın) fiil gelir.",
      tips: "Lest ... should ...",
      examples: ["Write it down lest you forget."],
      translation: "Görülür korkusuyla (görülmemek için) kaçtı."
    }
  },
  // --- CLEFT SENTENCES (IT IS...) ---
  {
    id: 527,
    level: "C1",
    type: "input",
    question: "It is because of the rain _____ we cancelled the trip.",
    answer: "that",
    explanation: {
      title: "Cleft Sentence (That)",
      rule: "'It is/was [Vurgulanan Kısım] THAT ...' yapısı. Sebebi vurguluyor.",
      tips: "It is John THAT came. It is because of X THAT Y happened.",
      examples: ["It was yesterday that I saw him."],
      translation: "Geziyi iptal etmemizin sebebi yağmurdu."
    }
  },
  // --- VERBS WITH PREPOSITIONS (RESIGN) ---
  {
    id: 528,
    level: "C1",
    type: "choice",
    question: "He resigned himself _____ his fate.",
    options: ["for", "in", "to", "with"],
    answer: "to",
    explanation: {
      title: "Resign Oneself To (Kabullenmek)",
      rule: "'Resign oneself to something': İstemediği bir durumu değiştiremeyeceğini anlayıp kabullenmek, boyun eğmek.",
      tips: "Resign TO fate.",
      examples: ["She resigned herself to a lonely life."],
      translation: "Kaderine boyun eğdi (razı oldu)."
    }
  },
  // --- NOUN CLAUSES ---
  {
    ...
    level: "C1",
    type: "choice",
    question: "_____ he is guilty or not is still unknown.",
    options: ["If", "Whether", "Unless", "That"],
    answer: "Whether",
    explanation: {
      title: "Whether vs If (Özne Konumu)",
      rule: "Cümlenin öznesi konumunda bir seçenek sunuluyorsa (Suçlu olup olmadığı...), 'If' kullanılamaz, 'Whether' zorunludur.",
      tips: "Whether... is unknown. (If başta olmaz)",
      examples: ["Whether we go depends on the weather."],
      translation: "Suçlu olup olmadığı hala bilinmiyor."
    }
  },
  // --- ADVERBIAL PHRASES (NO MATTER) ---
  {
    id: 530,
    level: "C1",
    type: "choice",
    question: "No matter _____ hard I try, I can't please him.",
    options: ["what", "how", "which", "when"],
    answer: "how",
    explanation: {
      title: "No Matter How + Adjective/Adverb",
      rule: "'Ne kadar ... olursa olsun' demek için 'No matter how + sıfat/zarf' kullanılır.",
      tips: "No matter how hard / No matter how fast.",
      examples: ["No matter how expensive it is, I'll buy it."],
      translation: "Ne kadar çabalasam da onu memnun edemiyorum."
    }
  },
  // --- PARTICIPLE (PERFECT) ---
  {
    ...
    level: "C1",
    type: "choice",
    question: "_____ all his money, he had to beg for food.",
    options: ["Lost", "Losing", "Having lost", "To lose"],
    answer: "Having lost",
    explanation: {
      title: "Perfect Participle (Aktif)",
      rule: "Bir eylem diğerinden önce tamamlanmışsa 'Having + V3' kullanılır. (Parasını kaybetmiş olduğu için...)",
      tips: "Having done X, he did Y.",
      examples: ["Having finished work, she went home."],
      translation: "Tüm parasını kaybettiği için yemek dilenmek zorunda kaldı."
    }
  },
  // --- DUMMY SUBJECT (IT) ---
  {
    ...
    level: "C1",
    type: "choice",
    question: "I find _____ hard to believe that he lied.",
    options: ["that", "it", "this", "so"],
    answer: "it",
    explanation: {
      title: "Preparatory 'It'",
      rule: "'Find/Make/Think + IT + Adjective + to do/that...' kalıbı. Gerçek nesne (that he lied) uzun olduğu için araya 'it' konur.",
      tips: "I find IT interesting...",
      examples: ["She made it clear that she disagreed."],
      translation: "Yalan söylediğine inanmayı zor buluyorum."
    }
  },
  // --- INVERSION (ONLY BY) ---
  {
    ...
    level: "C1",
    type: "input",
    question: "Only by guessing _____ (can/you) solve this puzzle.",
    answer: "can you",
    explanation: {
      title: "Inversion with 'Only By'",
      rule: "'Only by + V-ing' yapısı cümle başında ise ana cümle devrik olur (Yardımcı fiil + Özne).",
      tips: "Only by working hard WILL YOU succeed.",
      examples: ["Only by asking can you learn."],
      translation: "Bu bulmacayı ancak tahmin ederek çözebilirsin."
    }
  },
  // --- IDIOMATIC (THE FORMER/THE LATTER) ---
  {
    id: 534,
    level: "C1",
    type: "choice",
    question: "I like tea and coffee, but I prefer the _____.",
    options: ["later", "latter", "last", "late"],
    answer: "latter",
    explanation: {
      title: "The Former vs The Latter",
      rule: "İki şeyden bahsederken; 'The former' ilki (çay), 'The latter' ikincisi (kahve) demektir.",
      tips: "Latter (Sonuncusu/İkincisi) - Late ile karıştırma.",
      examples: ["Red and Blue. I choose the latter (Blue)."],
      translation: "Çay ve kahveyi severim ama ikincisini (kahveyi) tercih ederim."
    }
  },
  // --- MODALS (OUGHT TO HAVE) ---
  {
    ...
    level: "C1",
    type: "choice",
    question: "You _____ have checked the schedule before leaving.",
    options: ["must", "ought to", "can", "will"],
    answer: "ought to",
    explanation: {
      title: "Ought To Have V3",
      rule: "'Should have V3' ile aynıdır. Geçmişte yapılması gereken ama yapılmayan bir eylem için eleştiri/pişmanlık bildirir.",
      tips: "Ought to = Should",
      examples: ["We ought to have invited her."],
      translation: "Çıkmadan önce programı kontrol etmeliydin."
    }
  }
];
QUESTIONS_DB.push(...C1_QUESTIONS);
const C2_QUESTIONS = [
  // --- FIXED PHRASES / SUBJUNCTIVE ---
  {
    id: 601,
    level: "C2",
    type: "choice",
    question: "_____ it may, I will still support you.",
    options: ["Be", "Being", "Is", "Were"],
    answer: "Be",
    explanation: {
      title: "Fixed Subjunctive Phrase",
      rule: "'Be that as it may' kalıplaşmış, edebi ve ileri düzey bir bağlaçtır. 'Öyle olsa bile', 'Durum ne olursa olsun', 'Yine de' anlamına gelir.",
      tips: "Ezberlenmesi gereken 'Fixed Phrase'dir.",
      examples: [
        "Be that as it may, the law is the law.",
        "It is a difficult task. Be that as it may, we must try."
      ],
      translation: "Durum ne olursa olsun (öyle olsa bile), seni yine de destekleyeceğim."
    }
  },
  {
    id: 602,
    level: "C2",
    type: "choice",
    question: "_____ needs must.",
    options: ["When", "If", "As", "Where"],
    answer: "Needs",
    explanation: {
      title: "Idiomatic Expression",
      rule: "'Needs must when the devil drives' (Zorunluluk kanunu bozar / Mecburiyet insana her şeyi yaptırır) atasözünün kısaltılmış halidir: 'Needs must'.",
      tips: "Zorunluluk hallerinde kullanılır.",
      examples: ["I don't want to sell my car, but needs must."],
      translation: "Mecburiyet işte (yapacak bir şey yok)."
    }
  },
  // --- ELLIPTICAL CLAUSES (KISALTMA) ---
  {
    id: 603,
    level: "C2",
    type: "choice",
    question: "He was determined to finish the project, _____ the cost.",
    options: ["what", "whatever", "however", "whichever"],
    answer: "whatever",
    explanation: {
      title: "Elliptical Clause",
      rule: "'Whatever the cost' (may be) yapısının kısaltmasıdır. 'Bedeli ne olursa olsun' demektir.",
      tips: "Whatever the consequences... | Whatever the reason...",
      examples: [
        "I will do it, whatever the risk.",
        "Come, whatever the weather."
      ],
      translation: "Bedeli ne olursa olsun projeyi bitirmeye kararlıydı."
    }
  },
  // --- INVERTED CONDITIONAL (WERE IT NOT FOR) ---
  {
    ...
    level: "C2",
    type: "input",
    question: "Were it not _____ your assistance, I would have failed.",
    answer: "for",
    explanation: {
      title: "Inverted Conditional (Type 2)",
      rule: "'Were it not for...' (Olmasaydı...), 'If it weren't for' yapısının çok resmi ve edebi halidir. 'For' edatı olmadan kullanılamaz.",
      tips: "Were it not for X, Y would happen.",
      examples: [
        "Were it not for the sun, there would be no life.",
        "Were it not for his money, she wouldn't be with him."
      ],
      translation: "Senin yardımın olmasaydı (şu an), başarısız olurdum."
    }
  },
  // --- LITERARY INVERSION (LITTLE DID HE KNOW) ---
  {
    id: 605,
    level: "C2",
    type: "choice",
    question: "Little _____ that he was about to become famous.",
    options: ["he knew", "did he know", "he knows", "does he know"],
    answer: "did he know",
    explanation: {
      title: "Literary Inversion",
      rule: "'Little did he know' (Hiç bilmiyordu ki / Haberi yoktu ki...) kalıbı hikaye anlatımında sıkça kullanılır. 'Little' olumsuzluk kattığı için cümle devriktir.",
      tips: "Little did they realize... | Little did she suspect...",
      examples: [
        "Little did I know that this decision would change my life.",
        "Little does he care about the rules."
      ],
      translation: "Ünlü olmak üzere olduğundan hiç haberi yoktu."
    }
  },
  // --- INVERSION WITH 'SUCH' ---
  {
    ...
    level: "C2",
    type: "choice",
    question: "Such _____ the force of the explosion that the windows shattered.",
    options: ["was", "were", "is", "has been"],
    answer: "was",
    explanation: {
      title: "Inversion with Such",
      rule: "'Such was...' kalıbı, 'So great was...' anlamına gelir. Bir şeyin şiddetini, büyüklüğünü vurgulamak için kullanılır.",
      tips: "Such was his anger that... (Öfkesi o kadar büyüktü ki...)",
      examples: [
        "Such was the confusion that no one knew what to do.",
        "Such is life. (Hayat böyledir.)"
      ],
      translation: "Patlamanın şiddeti o kadardı ki pencereler tuzla buz oldu."
    }
  },
  // --- MANDATIVE SUBJUNCTIVE ---
  {
    ...
    level: "C2",
    type: "choice",
    question: "The judge ordered that the prisoner _____ released.",
    options: ["is", "be", "was", "to be"],
    answer: "be",
    explanation: {
      title: "Mandative Subjunctive",
      rule: "'Order', 'demand', 'insist', 'request' gibi fiillerden sonra gelen 'that' cümleciğinde fiil çekimsiz (yalın) kalır. Pasif yapıda 'be V3' olur.",
      tips: "He insisted that she COME. (Comes değil)",
      examples: [
        "I demand that he apologize.",
        "The law requires that you be 18."
      ],
      translation: "Yargıç, mahkumun serbest bırakılmasını emretti."
    }
  },
  // --- INVERTED CONDITIONAL TYPE 1 (SHOULD) ---
  {
    id: 608,
    level: "C2",
    type: "choice",
    question: "Should you _____ to contact me, I will be at the office.",
    options: ["need", "needed", "needs", "needing"],
    answer: "need",
    explanation: {
      title: "Inverted Type 1 (Should)",
      rule: "'If you should need' (Eğer ihtiyacın olursa - düşük ihtimal) yapısının devrik hali 'Should you need'dir. 'If' atılır, 'Should' başa gelir.",
      tips: "Should you require assistance... (Yardım gerekirse...)",
      examples: [
        "Should it rain, the event will be cancelled.",
        "Should you change your mind, let me know."
      ],
      translation: "Bana ulaşman gerekirse (olur da gerekirse), ofiste olacağım."
    }
  },
  // --- PHRASE: COME WHAT MAY ---
  {
    ...
    level: "C2",
    type: "choice",
    question: "_____ come what may, I shall never surrender.",
    options: ["Let", "Let's", "Lets", "Let it"],
    answer: "Let",
    explanation: {
      title: "Fixed Phrase",
      rule: "'Let come what may' veya sadece 'Come what may' (Ne olursa olsun / İnceldiği yerden kopsun) deyimsel bir yapıdır.",
      tips: "Gelecekten korkmadığını belirtir.",
      examples: ["I will tell the truth, come what may."],
      translation: "Ne olursa olsun, asla teslim olmayacağım."
    }
  },
  // --- INVERSION WITH 'SO' ---
  {
    ...
    level: "C2",
    type: "choice",
    question: "So _____ was he that he couldn't speak.",
    options: ["anger", "angrily", "angry", "angered"],
    answer: "angry",
    explanation: {
      title: "Inversion with So + Adjective",
      rule: "'He was so angry that...' cümlesini vurgulamak için 'So angry was he that...' şeklinde devrik yapabiliriz.",
      tips: "So + Sıfat + Yardımcı Fiil + Özne",
      examples: [
        "So beautiful was the song that everyone cried.",
        "So fast did he run that no one caught him."
      ],
      translation: "O kadar kızgındı ki konuşamadı."
    }
  },
  // --- IDIOM: SUFFICE IT TO SAY ---
  {
    id: 611,
    level: "C2",
    type: "choice",
    question: "Suffice it to _____ that he was late.",
    options: ["say", "tell", "speak", "talk"],
    answer: "say",
    explanation: {
      title: "Suffice it to say",
      rule: "'Suffice it to say' (Şunu söylemek yeterli olur ki / Uzun lafın kısası) çok yaygın bir C2 kalıbıdır.",
      tips: "Detaylara girmeden özet geçmek için kullanılır.",
      examples: ["Suffice it to say, we lost money."],
      translation: "Şunu söylemek yeterli olur ki, o geç kalmıştı."
    }
  },
  // --- EMPHASIS: NOT A WORD ---
  {
    ...
    level: "C2",
    type: "choice",
    question: "Not _____ word did he speak.",
    options: ["a", "one", "the", "single"],
    answer: "a",
    explanation: {
      title: "Emphatic Inversion",
      rule: "'Not a word' (tek bir kelime bile) yapısı cümle başında kullanıldığında devrik yapı gerektirir.",
      tips: "Not a soul was seen. (Tek bir kişi bile görülmedi)",
      examples: ["Not a tear did she shed."],
      translation: "Tek bir kelime bile etmedi."
    }
  },
  // --- PREPOSITION: BY DINT OF ---
  {
    id: 613,
    level: "C2",
    type: "choice",
    question: "He succeeded by _____ of hard work.",
    options: ["means", "dint", "way", "virtue"],
    answer: "dint",
    explanation: {
      title: "By dint of",
      rule: "'By dint of' (sayesinde, vasıtasıyla) kalıbı, genellikle yoğun çaba veya güç kullanımı gerektiren durumlar için kullanılır.",
      tips: "By means of = Vasıtasıyla | By virtue of = Nedeniyle (erdem)",
      examples: ["He got the job by dint of persistence."],
      translation: "Sıkı çalışması sayesinde başardı."
    }
  },
  // --- DOUBLE COMPARATIVE (THE... THE...) ---
  {
    ...
    level: "C2",
    type: "input",
    question: "The more you study, the _____ (smart) you become.",
    answer: "smarter",
    explanation: {
      title: "Double Comparative",
      rule: "'The + comparative, the + comparative' (Ne kadar ... o kadar ...) yapısı.",
      tips: "The more, the better.",
      examples: ["The older we grow, the wiser we become."],
      translation: "Ne kadar çok çalışırsan, o kadar zeki olursun."
    }
  },
  // --- PHRASAL VERB: BOIL DOWN TO ---
  {
    ...
    level: "C2",
    type: "choice",
    question: "It all boils _____ to money in the end.",
    options: ["up", "down", "over", "out"],
    answer: "down",
    explanation: {
      title: "Boil down to",
      rule: "'Boil down to' (sonuçta ...'ya dayanmak, mesele ...'dan ibaret olmak) anlamında kullanılır.",
      tips: "Özetle mesele şudur...",
      examples: ["The argument boils down to a misunderstanding."],
      translation: "Sonuçta her şey paraya dayanıyor."
    }
  },
  // ... (Mevcut C2 sorularının altına ekle) ...
  // --- ADVANCED CONDITIONALS (BUT FOR) ---
  {
    id: 616,
    level: "C2",
    type: "choice",
    question: "_____ for his prompt action, the fire would have spread.",
    options: ["If", "But", "Were", "Had"],
    answer: "But",
    explanation: {
      title: "But For (Olmasaydı)",
      rule: "'But for' kalıbı, 'If it hadn't been for' (O olmasaydı...) yapısının kısa ve ileri düzey halidir. Genellikle isim öbeği ile kullanılır.",
      tips: "But for + Noun (But for the rain...)",
      examples: ["But for your help, I would have failed."],
      translation: "Onun çevik müdahalesi olmasaydı, yangın yayılırdı."
    }
  },
  // --- IDIOMATIC SUBJUNCTIVE (FAR BE IT) ---
  {
    id: 617,
    level: "C2",
    type: "choice",
    question: "Far _____ it from me to criticize your decision.",
    options: ["be", "is", "was", "were"],
    answer: "be",
    explanation: {
      title: "Fixed Phrase (Far be it)",
      rule: "'Far be it from me to...' (Seni eleştirmek bana düşmez ama... / Haddi aşmak istemem ama...) kalıbında 'be' fiili subjunctive (yalın) olarak kalır.",
      tips: "Kalıp: Far BE it from me...",
      examples: ["Far be it from me to tell you what to do."],
      translation: "Kararını eleştirmek bana düşmez (haddim değil)."
    }
  },
  // --- CONCESSION (MUCH AS) ---
  {
    ...
    level: "C2",
    type: "choice",
    question: "_____ as I respect him, I cannot agree with his methods.",
    options: ["Even", "Though", "Much", "Despite"],
    answer: "Much",
    explanation: {
      title: "Much as + Sentence",
      rule: "'Much as' kalıbı 'Her ne kadar ... olsa da' (Although) anlamı katar. Genellikle sevgi, saygı, istek bildiren fiillerle kullanılır.",
      tips: "Much as I like... | Much as I want...",
      examples: ["Much as I would like to help, I am busy."],
      translation: "Ona her ne kadar saygı duysam da, yöntemlerine katılamıyorum."
    }
  },
  // --- PASSIVE CAUSATIVE WITH MAKE ---
  {
    id: 619,
    level: "C2",
    type: "choice",
    question: "The suspect was made _____ the document.",
    options: ["sign", "to sign", "signing", "signed"],
    answer: "to sign",
    explanation: {
      title: "Passive 'Make'",
      rule: "Aktif cümlede 'make someone DO something' (yalın) kullanılırken, Pasif cümlede 'be made TO DO something' (to infinitive) kullanılır.",
      tips: "Active: Make him go | Passive: He was made TO go.",
      examples: ["We were made to wait for hours."],
      translation: "Şüpheliye belge zorla imzalatıldı."
    }
  },
  // --- ABSOLUTE PHRASE (THERE BEING) ---
  {
    id: 620,
    level: "C2",
    type: "choice",
    question: "There _____ no taxis available, we had to walk home.",
    options: ["were", "being", "been", "to be"],
    answer: "being",
    explanation: {
      title: "Absolute Phrase (There being)",
      rule: "İki cümle arasında sebep-sonuç ilişkisi varsa ve özneler farklıysa, 'Because there were...' yerine 'There being...' yapısı kullanılabilir.",
      tips: "Resmi ve edebi bir kısaltmadır.",
      examples: ["The weather being fine, we went for a picnic."],
      translation: "Hiç taksi olmadığı için eve yürümek zorunda kaldık."
    }
  },
  // --- INVERSION (ON NO ACCOUNT) ---
  {
    ...
    level: "C2",
    type: "choice",
    question: "On no account _____ the switch be touched.",
    options: ["must", "you must", "should", "has"],
    answer: "must",
    explanation: {
      title: "Negative Inversion (On no account)",
      rule: "'On no account' (hiçbir sebeple/asla) başta ise cümle devrik olur. Cümlenin anlamı yasaklama içerdiği için 'must' veya 'should' uygundur.",
      tips: "On no account MUST/SHOULD + Subject...",
      examples: ["On no account are you to open the door."],
      translation: "Bu düğmeye hiçbir koşulda dokunulmamalıdır."
    }
  },
  // --- FUTURE IN THE PAST (WAS TO) ---
  {
    id: 622,
    level: "C2",
    type: "choice",
    question: "He was to _____ king, but he died young.",
    options: ["become", "becoming", "became", "have become"],
    answer: "become",
    explanation: {
      title: "Be to + Infinitive (Kader/Plan)",
      rule: "'Was/Were to do' yapısı, geçmişteki bir planı veya kaderi (olacaktı ama...) anlatmak için kullanılır.",
      tips: "He was to be king. (Kral olacaktı/Kaderinde vardı)",
      examples: ["They were to meet at 5, but he was late."],
      translation: "Kral olacaktı (kaderi böyleydi) ama genç yaşta öldü."
    }
  },
  // --- PHRASAL VERB (AMOUNT TO) ---
  {
    id: 623,
    level: "C2",
    type: "choice",
    question: "His explanation amounts _____ nothing more than an excuse.",
    options: ["for", "to", "with", "in"],
    answer: "to",
    explanation: {
      title: "Amount to",
      rule: "'Amount to', 'anlamına gelmek, ...'dan farksız olmak, eşdeğer olmak' demektir.",
      tips: "It amounts to the same thing. (Aynı kapıya çıkar.)",
      examples: ["Their silence amounts to a confession."],
      translation: "Yaptığı açıklama, bir bahaneden başka bir anlama gelmiyor."
    }
  },
  // --- INVERSION (NOT ONLY) ---
  {
    ...
    level: "C2",
    type: "choice",
    question: "Not only _____ late, but he also forgot his books.",
    options: ["he was", "was he", "he did", "did he"],
    answer: "was he",
    explanation: {
      title: "Inversion (Not Only)",
      rule: "'Not only' cümle başındaysa, ilk cümle devrik (soru formatında) olur.",
      tips: "Not only + Yardımcı Fiil + Özne",
      examples: ["Not only does she speak French, but also Spanish."],
      translation: "Sadece geç kalmadı, aynı zamanda kitaplarını da unuttu."
    }
  },
  // --- IDIOM (TO NAME BUT A FEW) ---
  {
    id: 625,
    level: "C2",
    type: "choice",
    question: "We sell apples, oranges, and bananas, to name _____ a few.",
    options: ["just", "only", "but", "so"],
    answer: "but",
    explanation: {
      title: "To name but a few",
      rule: "'To name but a few', 'Sadece birkaçını saymak gerekirse' veya 've daha niceleri' anlamında kullanılan resmi bir kalıptır.",
      tips: "Genellikle bir listenin sonunda kullanılır.",
      examples: ["Shakespeare wrote Hamlet, Macbeth, and Othello, to name but a few."],
      translation: "Elma, portakal ve muz satıyoruz; sadece birkaçını saymak gerekirse."
    }
  },
  // --- SUBJUNCTIVE (IF NEED BE) ---
  {
    ...
    level: "C2",
    type: "input",
    question: "I will work all night if need _____ (be).",
    answer: "be",
    explanation: {
      title: "If Need Be",
      rule: "'If need be' (Eğer gerekirse) kalıplaşmış bir Subjunctive ifadesidir. Fiil her zaman 'be' olarak kalır.",
      tips: "If necessary = If need be",
      examples: ["We can restart, if need be."],
      translation: "Eğer gerekirse tüm gece çalışırım."
    }
  },
  // --- NOUN CLAUSE (WHAT WITH) ---
  {
    id: 627,
    level: "C2",
    type: "choice",
    question: "_____ with the cold and the rain, we decided to stay indoors.",
    options: ["What", "As", "Since", "Because"],
    answer: "What",
    explanation: {
      title: "What with... (Sebebiyle)",
      rule: "'What with' yapısı, birden fazla olumsuz sebebi sıralarken '... yüzünden, ... da eklenince' anlamında kullanılır.",
      tips: "What with X and Y... (X ve Y yüzünden)",
      examples: ["What with work and the kids, I'm exhausted."],
      translation: "Soğuk ve yağmur da eklenince (yüzünden), içeride kalmaya karar verdik."
    }
  },
  // --- PARTICIPLE (NOT HAVING) ---
  {
    id: 628,
    level: "C2",
    type: "choice",
    question: "Not _____ the instructions, he failed to assemble the table.",
    options: ["read", "reading", "having read", "to read"],
    answer: "having read",
    explanation: {
      title: "Negative Perfect Participle",
      rule: "Eylem ana eylemden önce gerçekleşmediği için (okumamış olduğu için), 'Not having + V3' kullanılır.",
      tips: "Because he hadn't read -> Not having read",
      examples: ["Not having eaten breakfast, I was hungry."],
      translation: "Talimatları okumamış olduğu için masayı kuramadı."
    }
  },
  // --- IDIOM (TAKE FOR GRANTED) ---
  {
    ...
    level: "C2",
    type: "choice",
    question: "You shouldn't take your health _____ granted.",
    options: ["as", "for", "by", "with"],
    answer: "for",
    explanation: {
      title: "Take for granted",
      rule: "'Take something for granted': Bir şeyin değerini bilmemek, cepte görmek, garanti saymak.",
      tips: "Take [something] FOR granted.",
      examples: ["Don't take freedom for granted."],
      translation: "Sağlığını cepte görmemelisin (kıymetini bilmelisin)."
    }
  },
  // --- CLEFT SENTENCE (ALL THAT) ---
  {
    id: 630,
    level: "C2",
    type: "choice",
    question: "All _____ matters is that you are safe.",
    options: ["what", "that", "which", "it"],
    answer: "that",
    explanation: {
      title: "Pseudo-cleft (All that)",
      rule: "'All' kelimesinden sonra 'what' değil 'that' kullanılır (veya relative pronoun düşebilir).",
      tips: "All (that) I want... | All (that) matters...",
      examples: ["All I know is that he left."],
      translation: "Önemli olan tek şey senin güvende olman."
    }
  },
  // --- INVERSION (NOWHERE NEAR) ---
  {
    id: 631,
    level: "C2",
    type: "choice",
    question: "The movie was nowhere _____ as good as the book.",
    options: ["close", "nearly", "near", "like"],
    answer: "near",
    explanation: {
      title: "Nowhere near (Yanına bile yaklaşamaz)",
      rule: "'Nowhere near as ... as' yapısı, 'uzaktan yakından alakası yok / kıyaslanamaz bile' anlamında güçlü bir karşılaştırmadır.",
      tips: "It is nowhere near ready.",
      examples: ["He is nowhere near as rich as you think."],
      translation: "Film, kitabın yanına bile yaklaşamazdı (kitap kadar iyi değildi)."
    }
  },
  // --- ADJECTIVE POSITION ---
  {
    ...
    level: "C2",
    type: "choice",
    question: "The people _____ were asked to leave.",
    options: ["concerned", "involved", "present", "all above"],
    answer: "all above",
    explanation: {
      title: "Postpositive Adjectives",
      rule: "Bazı sıfatlar (concerned, involved, present) isimden sonra gelince anlamı değişir veya o ana özgü durumu belirtir. Burada hepsi gramatik olarak uyabilir.",
      tips: "People present (Oradaki insanlar) | People involved (Karışan insanlar)",
      examples: ["The person responsible will be punished."],
      translation: "İlgili/Oradaki kişiler ayrılmaya davet edildi."
    }
  },
  // --- VERBS OF PERCEPTION ---
  {
    ...
    level: "C2",
    type: "choice",
    question: "I saw him _____ the key and open the box.",
    options: ["turn", "turning", "turned", "to turn"],
    answer: "turn",
    explanation: {
      title: "Verbs of Perception (See someone do)",
      rule: "Eğer eylemin tamamına şahit olduysak (anahtarı çevirdi ve açtı), fiilin yalın hali (turn) kullanılır. Sadece bir kısmını görseydik 'turning' olurdu.",
      tips: "I saw him cross the road (Hepsini) | I saw him crossing (Bir kısmını)",
      examples: ["I watched her paint the picture."],
      translation: "Anahtarı çevirip kutuyu açtığını gördüm."
    }
  },
  // --- PREPOSITION (AT STAKE) ---
  {
    id: 634,
    level: "C2",
    type: "choice",
    question: "Thousands of lives are _____ stake.",
    options: ["in", "on", "at", "under"],
    answer: "at",
    explanation: {
      title: "At stake (Tehlikede)",
      rule: "'At stake', risk altında, tehlikede, söz konusu anlamına gelen bir deyimdir.",
      tips: "Benzeri: At risk.",
      examples: ["My reputation is at stake."],
      translation: "Binlerce yaşam tehlikede (söz konusu)."
    }
  },
  // --- ADVANCED COMPARISON (NOT SO MUCH) ---
  {
    id: 635,
    level: "C2",
    type: "choice",
    question: "I'm not angry. It's _____ much that I'm disappointed.",
    options: ["not so", "rather", "more", "less"],
    answer: "not so",
    explanation: {
      title: "Not so much X as Y",
      rule: "'It is not so much X as Y': X'ten ziyade Y. Durumun öfkeden çok hayal kırıklığı olduğunu belirtir.",
      tips: "I'm not so much tired as bored.",
      examples: ["It wasn't so much a request as a command."],
      translation: "Kızgın değilim. Daha ziyade hayal kırıklığına uğradım."
    }
  }
];
QUESTIONS_DB.push(...C2_QUESTIONS);
const EXTRA_C1_QUESTIONS = [
  // --- INVERSION (HARDLY / SCARCELY) ---
  {
    id: 536,
    level: "C1",
    type: "choice",
    question: "Hardly _____ the house when it started to pour with rain.",
    options: ["I had left", "did I leave", "had I left", "was I leaving"],
    answer: "had I left",
    explanation: {
      title: "Inversion (Hardly ... When)",
      rule: "'Hardly' cümle başına geldiğinde Past Perfect yapı devrik olur (Had + Özne + V3). 'Tam çıkmıştım ki...' anlamı verir.",
      tips: "Hardly + Had + Subject + V3 ... when ...",
      examples: ["Hardly had we started when the lights went out."],
      translation: "Yağmur bardaktan boşalırcasına yağmaya başladığında evden daha yeni çıkmıştım."
    }
  },
  // --- SUBJUNCTIVE (DEMAND) ---
  {
    ...
    level: "C1",
    type: "input",
    question: "The boss demanded that he _____ (be) present at the meeting.",
    answer: "be",
    explanation: {
      title: "Subjunctive Mood (Demand)",
      rule: "'Demand that' yapısından sonra gelen fiil, özne 'he/she/it' olsa bile yalın (base form) kalır. 'Is' kullanılmaz.",
      tips: "Demand that + Subject + V1 (Yalın)",
      examples: ["I demand that he apologize."],
      translation: "Patron, onun toplantıda hazır bulunmasını talep etti."
    }
  },
  // --- PARTICIPLE CLAUSE (PASSIVE) ---
  {
    ...
    level: "C1",
    type: "choice",
    question: "_____ in gold, the ancient sword was priceless.",
    options: ["Covering", "Covered", "To cover", "Having covered"],
    answer: "Covered",
    explanation: {
      title: "Past Participle Clause",
      rule: "Cümlenin öznesi (sword) eylemi yapan değil, eyleme maruz kalan olduğu için V3 (Past Participle) ile başlanır.",
      tips: "(Being) Covered in gold...",
      examples: ["Written by a famous poet, the poem is beautiful."],
      translation: "Altınla kaplanmış olan antik kılıç paha biçilemezdi."
    }
  },
  // --- ADVANCED CONDITIONAL (SHOULD) ---
  {
    id: 539,
    level: "C1",
    type: "choice",
    question: "_____ you change your mind, here is my card.",
    options: ["If", "Should", "Were", "Had"],
    answer: "Should",
    explanation: {
      title: "Inverted Conditional (Type 1)",
      rule: "'If you should change' yapısının devrik halidir. Olasılığın düşük olduğunu nezaketle belirtir.",
      tips: "Should + Özne + V1 (If yerine Should gelir)",
      examples: ["Should you need help, call me."],
      translation: "Olur da fikrini değiştirirsen, işte kartım."
    }
  },
  // --- EMPHASIS (DO) ---
  {
    ...
    level: "C1",
    type: "choice",
    question: "I rarely eat sweets, but I _____ enjoy a good chocolate cake.",
    options: ["did", "do", "am", "have"],
    answer: "do",
    explanation: {
      title: "Emphatic 'Do'",
      rule: "Olumlu cümlede vurgu yapmak için yardımcı fiil 'do/does/did' kullanılır. 'Gerçekten de severim' anlamı katar.",
      tips: "I do love you! (Seni gerçekten seviyorum!)",
      examples: ["He does look tired."],
      translation: "Nadiren tatlı yerim ama iyi bir çikolatalı keki gerçekten severim."
    }
  },
  // --- FUTURE IN THE PAST ---
  {
    ...
    level: "C1",
    type: "choice",
    question: "I was _____ to leave, but the phone rang.",
    options: ["due", "bound", "about", "set"],
    answer: "about",
    explanation: {
      title: "Be About To (Tam yapacakken)",
      rule: "'Be about to' bir eylemin hemen gerçekleşmek üzere olduğunu anlatır.",
      tips: "Was about to = Tam yapacaktım",
      examples: ["We were about to eat."],
      translation: "Tam çıkmak üzereydim ki telefon çaldı."
    }
  },
  // --- FIXED EXPRESSION (TIME) ---
  {
    ...
    level: "C1",
    type: "choice",
    question: "It's about time you _____ a job.",
    options: ["find", "found", "have found", "will find"],
    answer: "found",
    explanation: {
      title: "It's About Time",
      rule: "'It's time' veya 'It's about time' kalıbından sonra gelen fiil Past Simple olur (anlam şimdiki zaman olsa bile).",
      tips: "It's time + Subject + V2",
      examples: ["It's time we went home."],
      translation: "Bir iş bulmanin vakti geldi de geçiyor."
    }
  },
  // --- CONNECTOR (MUCH AS) ---
  {
    ...
    level: "C1",
    type: "choice",
    question: "_____ as I like him, I can't agree with his politics.",
    options: ["Even", "Although", "Much", "Despite"],
    answer: "Much",
    explanation: {
      title: "Much As (Her ne kadar...)",
      rule: "'Much as', 'Although' anlamına gelen vurgulu bir yapıdır. Genelde 'like, admire, respect' gibi fiillerle kullanılır.",
      tips: "Much as I love you... (Seni ne kadar sevsem de...)",
      examples: ["Much as I want to help, I can't."],
      translation: "Ondan ne kadar hoşlansam da, politik görüşlerine katılamam."
    }
  },
  // --- MODAL (NEEDN'T HAVE) ---
  {
    ...
    level: "C1",
    type: "choice",
    question: "You _____ cooked dinner; we are eating out tonight.",
    options: ["mustn't have", "didn't need to", "needn't have", "couldn't have"],
    answer: "needn't have",
    explanation: {
      title: "Needn't Have V3",
      rule: "Geçmişte yapılmış ama aslında gereksiz olan bir eylemi anlatır. 'Yapmana gerek yoktu (ama yaptın)' demektir.",
      tips: "Needn't have done = Boşuna yaptın.",
      examples: ["You needn't have brought gifts."],
      translation: "Akşam yemeği yapmana gerek yoktu; bu akşam dışarıda yiyoruz."
    }
  },
  // --- CLEFT SENTENCE (IT) ---
  {
    ...
    level: "C1",
    type: "choice",
    question: "It was _____ who solved the problem.",
    options: ["he", "him", "his", "himself"],
    answer: "he",
    explanation: {
      title: "Cleft Sentence Pronoun",
      rule: "Resmi İngilizcede 'It was...' kalıbından sonra özne zamiri (I, he, she) gelir. Günlük dilde 'him' dense de gramer olarak 'he' doğrudur.",
      tips: "It was HE who did it.",
      examples: ["It was she who called."],
      translation: "Problemi çözen kişi oydu."
    }
  },
  // --- VOCABULARY (BOUND TO) ---
  {
    ...
    level: "C1",
    type: "choice",
    question: "Don't worry, mistakes are _____ to happen.",
    options: ["bound", "due", "set", "about"],
    answer: "bound",
    explanation: {
      title: "Bound To (Kaçınılmaz)",
      rule: "'Bound to', olması kesin veya kaçınılmaz olaylar için kullanılır.",
      tips: "Bound to happen = Olması muhakkak.",
      examples: ["It is bound to rain."],
      translation: "Endişelenme, hata olması kaçınılmazdır."
    }
  },
  // --- RELATIVE CLAUSE (WHOM) ---
  {
    ...
    level: "C1",
    type: "choice",
    question: "The person to _____ you are speaking is the CEO.",
    options: ["who", "whom", "that", "whose"],
    answer: "whom",
    explanation: {
      title: "Relative Clause (Preposition + Whom)",
      rule: "Edatlardan (to, for, with) sonra 'who' kullanılmaz, 'whom' kullanılması zorunludur.",
      tips: "To whom, For whom, With whom.",
      examples: ["With whom did you go?"],
      translation: "Şu an konuştuğun kişi CEO."
    }
  },
  // --- PASSIVE (REPORTING VERBS) ---
  {
    ...
    level: "C1",
    type: "choice",
    question: "The company is rumoured _____ bankrupt.",
    options: ["going", "to go", "to be going", "go"],
    answer: "to be going",
    explanation: {
      title: "Passive Reporting Verbs",
      rule: "'It is rumoured that...' yapısının kişiselleştirilmiş halidir. Şimdiki zaman/gelecek için 'to + infinitive' veya 'to be -ing' kullanılır.",
      tips: "He is said to be rich.",
      examples: ["She is thought to be living in Paris."],
      translation: "Şirketin iflas etmekte olduğu söylentisi var."
    }
  },
  // --- INVERSION (ONLY AFTER) ---
  {
    ...
    level: "C1",
    type: "choice",
    question: "Only after reading the letter _____ the truth.",
    options: ["I understood", "did I understand", "I did understand", "understood I"],
    answer: "did I understand",
    explanation: {
      title: "Inversion (Only After)",
      rule: "'Only after' zaman zarfı cümle başında ise ana cümle devrik (soru formatında) olur.",
      tips: "Only after ... DID I ...",
      examples: ["Only after years did they meet again."],
      translation: "Ancak mektubu okuduktan sonra gerçeği anladım."
    }
  },
  // --- WISH (REGRET) ---
  {
    ...
    level: "C1",
    type: "input",
    question: "I wish I _____ (listen) to you earlier.",
    answer: "had listened",
    explanation: {
      title: "Wish + Past Perfect",
      rule: "Geçmişe dair pişmanlıkları anlatırken 'I wish'ten sonra Past Perfect (had V3) kullanılır.",
      tips: "I wish I had done X.",
      examples: ["I wish I hadn't eaten so much."],
      translation: "Keşke seni daha önce dinleseydim."
    }
  },
  // --- PHRASAL VERB (LOOK FORWARD TO) ---
  {
    ...
    level: "C1",
    type: "choice",
    question: "We look forward to _____ you soon.",
    options: ["see", "seeing", "seen", "be seeing"],
    answer: "seeing",
    explanation: {
      title: "Look Forward To + V-ing",
      rule: "'To' burada bir edattır, mastar eki değildir. Edatlardan sonra fiil gelirse -ing alır.",
      tips: "Look forward to DOING.",
      examples: ["I look forward to hearing from you."],
      translation: "Sizi yakında görmeyi dört gözle bekliyoruz."
    }
  },
  // --- QUANTIFIERS (A GREAT DEAL) ---
  {
    id: 552,
    level: "C1",
    type: "choice",
    question: "He spent a great _____ of time on this project.",
    options: ["amount", "deal", "number", "quantity"],
    answer: "deal",
    explanation: {
      title: "A Great Deal Of",
      rule: "Sayılamayan isimlerle (time, money) 'a great deal of' kalıbı kullanılır.",
      tips: "A great deal of money.",
      examples: ["It required a great deal of effort."],
      translation: "Bu projeye çok fazla zaman harcadı."
    }
  },
  // --- CONDITIONALS (PROVIDED) ---
  {
    ...
    level: "C1",
    type: "choice",
    question: "You can borrow the car _____ that you bring it back by 10.",
    options: ["providing", "unless", "supposing", "as long"],
    answer: "providing",
    explanation: {
      title: "Provided/Providing That",
      rule: "'If' yerine kullanılan resmi bir şart bağlacıdır. 'Şartıyla, kaydıyla' anlamına gelir.",
      tips: "Provided that = Only if.",
      examples: ["I will go providing you come too."],
      translation: "10'a kadar geri getirmek şartıyla arabayı ödünç alabilirsin."
    }
  },
  // --- VERB PATTERNS (OBJECT TO) ---
  {
    ...
    level: "C1",
    type: "choice",
    question: "Most people object to _____ treated unfairly.",
    options: ["be", "being", "been", "to be"],
    answer: "being",
    explanation: {
      title: "Object To + V-ing",
      rule: "'Object to' (itiraz etmek) kalıbında 'to' edattır, bu yüzden devamında Gerund (-ing) gelir.",
      tips: "Object to doing something.",
      examples: ["He objected to paying extra."],
      translation: "Çoğu insan haksız muamele görmeye itiraz eder."
    }
  },
  // --- ADJECTIVES (ALIKE) ---
  {
    ...
    level: "C1",
    type: "choice",
    question: "The two sisters are very _____ in character.",
    options: ["same", "likely", "alike", "liked"],
    answer: "alike",
    explanation: {
      title: "Alike (Benzer)",
      rule: "'Alike' yüklem olarak kullanılır (cümlenin sonunda veya fiilden sonra). 'Similar' gibi isimden önce gelmez.",
      tips: "They look alike. (Benzerler)",
      examples: ["My mother and I are alike."],
      translation: "İki kız kardeş karakter olarak birbirine çok benzer."
    }
  },
  // --- IDIOMS (BLUE) ---
  {
    ...
    level: "C1",
    type: "choice",
    question: "The news came out of the _____.",
    options: ["red", "blue", "green", "black"],
    answer: "blue",
    explanation: {
      title: "Out of the Blue",
      rule: "'Out of the blue', 'damdan düşer gibi, aniden, hiç beklenmedik bir anda' anlamına gelen bir deyimdir.",
      tips: "Unexpectedly = Out of the blue.",
      examples: ["She called me out of the blue."],
      translation: "Haber hiç beklenmedik bir anda (gökten düşer gibi) geldi."
    }
  },
  // --- FUTURE PERFECT CONTINUOUS ---
  {
    ...
    explanation: {
      title: "Future Perfect Continuous",
      rule: "Gelecekteki bir noktada, bir eylemin ne kadar süredir devam ediyor olacağını vurgular.",
      tips: "By + Zaman ... for + Süre -> Will have been V-ing",
      examples: ["By 5 PM, I will have been driving for 6 hours."],
      translation: "Gelecek yıl itibarıyla, burada 20 yıldır çalışıyor olacağım."
    }
  },
  // --- INVERSION (SO ... THAT) ---
  {
    ...
    level: "C1",
    type: "choice",
    question: "So angry _____ that he slammed the door.",
    options: ["he was", "was he", "did he", "he did"],
    answer: "was he",
    explanation: {
      title: "Inversion with So + Adjective",
      rule: "'He was so angry' cümlesi vurgu için 'So angry was he' şeklinde devrik yapılabilir.",
      tips: "So + Sıfat + Yardımcı Fiil + Özne",
      examples: ["So beautiful was the view..."],
      translation: "O kadar sinirliydi ki kapıyı çarptı."
    }
  },
  // --- MIXED CONDITIONAL ---
  {
    ...
    level: "C1",
    type: "input",
    question: "If I _____ (take) that job, I would be living in Paris now.",
    answer: "had taken",
    explanation: {
      title: "Mixed Conditional (Past Cause, Present Effect)",
      rule: "Geçmişte yapılan bir eylemin (Type 3 - had taken) şu anki sonucunu (Type 2 - would be) anlatır.",
      tips: "If + Past Perfect ... Would + V1",
      examples: ["If I had eaten breakfast, I wouldn't be hungry now."],
      translation: "O işi kabul etseydim, şu an Paris'te yaşıyor olurdum."
    }
  },
  // --- PREPOSITIONAL PHRASE ---
  {
    ...
    level: "C1",
    type: "choice",
    question: "He succeeded _____ dint of hard work.",
    options: ["by", "in", "with", "on"],
    answer: "by",
    explanation: {
      title: "By Dint Of",
      rule: "'By dint of', 'sayesinde, vasıtasıyla' anlamına gelen ileri düzey bir kalıptır.",
      tips: "By dint of = By means of.",
      examples: ["She won by dint of determination."],
      translation: "Sıkı çalışması sayesinde başardı."
    }
  },
  // --- CAUSATIVE (HAVE) ---
  {
    ...
    level: "C1",
    type: "choice",
    question: "I had the mechanic _____ my car.",
    options: ["check", "to check", "checked", "checking"],
    answer: "check",
    explanation: {
      title: "Causative (Have someone DO)",
      rule: "'Have someone DO something' kalıbında fiil yalın (bare infinitive) kullanılır. 'Get someone TO DO' ile karıştırılmamalıdır.",
      tips: "Have + Person + V1",
      examples: ["I had him fix the leak."],
      translation: "Tamirciye arabamı kontrol ettirdim."
    }
  },
  // --- CONJUNCTION (WHILE) ---
  {
    ...
    level: "C1",
    type: "choice",
    question: "_____ I understand your point, I disagree.",
    options: ["Since", "While", "Despite", "However"],
    answer: "While",
    explanation: {
      title: "While (Rağmen/Oysa)",
      rule: "'While' cümle başında 'Although' (her ne kadar) anlamında zıtlık bildirmek için kullanılır.",
      tips: "While X is true, Y is also true.",
      examples: ["While I like the color, the size is wrong."],
      translation: "Ne demek istediğini anlasam da (anlamama rağmen), katılmıyorum."
    }
  },
  // --- MODAL (DARE) ---
  {
    ...
    type: "choice",
    question: "How _____ you speak to me like that?",
    options: ["dare", "do", "did", "are"],
    answer: "dare",
    explanation: {
      title: "How Dare You",
      rule: "'How dare you' kalıbı öfke ve şok belirtir. 'Dare' burada yarı-modal (semi-modal) gibi davranır.",
      tips: "How dare you + V1",
      examples: ["Don't you dare!"],
      translation: "Benimle bu şekilde konuşmaya nasıl cüret edersin?"
    }
  },
  // --- VOCABULARY (VERGE) ---
  {
    ...
    explanation: {
      ...
      rule: "'On the verge of', 'eşiğinde, olmak üzere' anlamına gelir. Genellikle olumsuz veya dramatik durumlarda kullanılır.",
      tips: "On the verge of tears/collapse/war.",
      examples: ["She was on the verge of crying."],
      translation: "Şirket çöküşün eşiğinde."
    }
  },
  // --- ELLIPSIS (IF ANY) ---
  {
    ...
    level: "C1",
    type: "choice",
    question: "There are few, if _____, mistakes in your essay.",
    options: ["any", "some", "ever", "not"],
    answer: "any",
    explanation: {
      title: "Few, if any",
      rule: "'Few, if any' kalıbı 'varsa bile çok az' anlamına gelir. Miktarın azlığını vurgular.",
      tips: "Little, if any / Few, if any.",
      examples: ["He has little, if any, chance."],
      translation: "Makalende hata varsa bile çok az (neredeyse hiç yok)."
    }
  }
];
QUESTIONS_DB.push(...EXTRA_C1_QUESTIONS);
const EXTRA_C2_QUESTIONS = [
  // --- FIXED PHRASES / SUBJUNCTIVE ---
  {
    id: 636,
    level: "C2",
    type: "choice",
    question: "_____ it may, I will still support you.",
    options: ["Be that as", "Be as", "That be as", "As it"],
    answer: "Be that as",
    explanation: {
      title: "Fixed Phrase: Be that as it may",
      rule: "'Be that as it may' kalıplaşmış, edebi bir bağlaçtır. 'Öyle olsa bile', 'Durum ne olursa olsun', 'Yine de' anlamına gelir.",
      tips: "Ezberlenmesi gereken bir kalıptır.",
      examples: ["It's going to be difficult. Be that as it may, we must try."],
      translation: "Durum ne olursa olsun (öyle olsa bile), seni yine de destekleyeceğim."
    }
  },
  {
    ...
    answer: "When",
    explanation: {
      title: "Idiom: Needs must",
      rule: "'Needs must when the devil drives' atasözünün kısaltılmış halidir. 'Mecburiyet insana her şeyi yaptırır' veya 'Başka çare yok' anlamında kullanılır.",
      tips: "Sadece 'Needs must' olarak da kullanılır.",
      examples: ["I don't want to sell the house, but needs must."],
      translation: "Mecburiyet işte (başka çare yok)."
    }
  },
  // --- ELLIPTICAL CLAUSES ---
  {
    ...
    level: "C2",
    type: "choice",
    question: "He was determined to finish, _____ the cost.",
    options: ["what", "whatever", "however", "whichever"],
    answer: "whatever",
    explanation: {
      title: "Elliptical Clause",
      rule: "'Whatever the cost' (may be) yapısının kısaltmasıdır. 'Bedeli ne olursa olsun' demektir.",
      tips: "Whatever the consequences... (Sonuçları ne olursa olsun)",
      examples: ["I will do it, whatever the risk."],
      translation: "Bedeli ne olursa olsun bitirmeye kararlıydı."
    }
  },
  // --- INVERTED CONDITIONAL (WERE IT NOT FOR) ---
  {
    ...
    level: "C2",
    type: "input",
    question: "Were it not _____ your help, I would fail.",
    answer: "for",
    explanation: {
      title: "Inverted Conditional (Type 2)",
      rule: "'Were it not for...' (Olmasaydı...), 'If it weren't for' yapısının çok resmi ve edebi halidir. 'For' edatı olmadan kullanılamaz.",
      tips: "Were it not for X, Y would happen.",
      examples: ["Were it not for the sun, there would be no life."],
      translation: "Senin yardımın olmasaydı, başarısız olurdum."
    }
  },
  // --- LITERARY INVERSION (LITTLE DID HE KNOW) ---
  {
    ...
    explanation: {
      title: "Literary Inversion",
      rule: "'Little did he know' (Hiç bilmiyordu ki / Haberi yoktu ki...) hikaye anlatımında sıkça kullanılır. 'Little' olumsuzluk kattığı için cümle devriktir.",
      tips: "Little did I suspect...",
      examples: ["Little did she know the truth."],
      translation: "Ünlü olmak üzere olduğundan hiç haberi yoktu."
    }
  },
  // --- INVERSION WITH 'SUCH' ---
  {
    ...
    explanation: {
      title: "Inversion with Such",
      rule: "'Such was...' kalıbı, 'So great was...' anlamına gelir. Bir şeyin şiddetini vurgulamak için kullanılır.",
      tips: "Such was his anger that... (Öfkesi o kadar büyüktü ki...)",
      examples: ["Such was the confusion that no one moved."],
      translation: "Patlamanın şiddeti o kadardı ki pencereler tuzla buz oldu."
    }
  },
  // --- MANDATIVE SUBJUNCTIVE ---
  {
    ...
    explanation: {
      title: "Mandative Subjunctive",
      rule: "'Order', 'demand', 'insist' gibi fiillerden sonra gelen 'that' cümleciğinde fiil çekimsiz (yalın) kalır. Pasif yapıda 'be V3' olur.",
      tips: "It is essential that he BE told.",
      examples: ["I demand that he apologize."],
      translation: "Yargıç, mahkumun serbest bırakılmasını emretti."
    }
  },
  // --- PHRASE: COME WHAT MAY ---
  {
    ...
    level: "C2",
    type: "choice",
    question: "_____ what may, I shall never surrender.",
    options: ["Come", "Go", "Be", "Let"],
    answer: "Come",
    explanation: {
      title: "Fixed Phrase: Come what may",
      rule: "'Come what may' (Ne olursa olsun / İnceldiği yerden kopsun) deyimsel bir yapıdır.",
      tips: "Cümle başında veya sonunda kullanılabilir.",
      examples: ["I will tell the truth, come what may."],
      translation: "Ne olursa olsun, asla teslim olmayacağım."
    }
  },
  ...
  // --- PHRASAL VERB: BOIL DOWN TO ---
  {
    ...
    explanation: {
      title: "Boil down to",
      rule: "'Boil down to', 'sonuçta ...'ya dayanmak, mesele ...'dan ibaret olmak' demektir.",
      tips: "Özetle mesele şudur...",
      examples: ["The argument boils down to a misunderstanding."],
      translation: "Sonuçta her şey paraya dayanıyor."
    }
  ...
  // --- ABSOLUTE PHRASE (THERE BEING) ---
  {
    ...
    level: "C2",
    type: "choice",
    question: "There _____ no taxis available, we had to walk.",
    options: ["were", "being", "been", "to be"],
    answer: "being",
    explanation: {
      title: "Absolute Phrase (There being)",
      rule: "İki cümle arasında sebep-sonuç ilişkisi varsa ve özneler farklıysa, 'Because there were...' yerine 'There being...' yapısı kullanılabilir.",
      tips: "Weather permitting (Hava izin verirse) / There being no time...",
      examples: ["The weather being fine, we went for a picnic."],
      translation: "Hiç taksi olmadığı için yürümek zorunda kaldık."
    }
  },
  // --- INVERSION (ON NO ACCOUNT) ---
  {
    ...
    explanation: {
      title: "Negative Inversion (On no account)",
      rule: "'On no account' (hiçbir sebeple/asla) başta ise cümle devrik olur. Yasaklama içerdiği için 'must' uygundur.",
      tips: "On no account MUST/SHOULD + Subject...",
      examples: ["On no account are you to open the door."],
      translation: "Bu düğmeye hiçbir koşulda dokunulmamalıdır."
    }
  ...
  // --- IDIOM (TO NAME BUT A FEW) ---
  {
    ...
    explanation: {
      ...
      rule: "'To name but a few', 'Sadece birkaçını saymak gerekirse' veya 've daha niceleri' anlamında kullanılan resmi bir kalıptır.",
      tips: "Genellikle bir listenin sonunda kullanılır.",
      examples: ["Shakespeare wrote Hamlet and Othello, to name but a few."],
      translation: "Elma, portakal ve muz satıyoruz; sadece birkaçını saymak gerekirse."
    }
  },
  // --- SUBJUNCTIVE (IF NEED BE) ---
  ...
  // --- NOUN CLAUSE (WHAT WITH) ---
  {
    ...
    level: "C2",
    type: "choice",
    question: "_____ with the cold and the rain, we stayed indoors.",
    options: ["What", "As", "Since", "Because"],
    answer: "What",
    explanation: {
      title: "What with... (Sebebiyle)",
      ...
      tips: "What with X and Y... (X ve Y yüzünden)",
      examples: ["What with work and the kids, I'm exhausted."],
      translation: "Soğuk ve yağmur da eklenince (yüzünden), içeride kaldık."
    }
  },
  // --- PARTICIPLE (NOT HAVING) ---
  {
    ...
    level: "C2",
    type: "choice",
    question: "Not _____ the instructions, he failed to assemble it.",
    options: ["read", "reading", "having read", "to read"],
    answer: "having read",
    explanation: {
      title: "Negative Perfect Participle",
      rule: "Eylem ana eylemden önce gerçekleşmediği için (okumamış olduğu için), 'Not having + V3' kullanılır.",
      tips: "Not having done X...",
      examples: ["Not having eaten, I was hungry."],
      translation: "Talimatları okumamış olduğu için birleştiremedi."
    }
  },
  // --- IDIOM (TAKE FOR GRANTED) ---
  {
  ...
  // --- CLEFT SENTENCE (ALL THAT) ---
  {
    ...
    explanation: {
      title: "Pseudo-cleft (All that)",
      rule: "'All' kelimesinden sonra 'what' değil 'that' kullanılır (veya relative pronoun tamamen atılabilir). 'All what' yanlıştır.",
      tips: "All (that) I want... | All (that) matters...",
      examples: ["All I know is that he left."],
      translation: "Önemli olan tek şey senin güvende olman."
    }
  ...
  // --- ADJECTIVE POSITION ---
  {
    ...
    explanation: {
      title: "Postpositive Adjectives",
      rule: "Bazı sıfatlar (concerned, involved, present) isimden sonra gelince anlamı değişir veya o ana özgü durumu belirtir. Burada hepsi gramatik olarak uyabilir.",
      tips: "People present (Oradaki insanlar) | Person concerned (İlgili kişi)",
      examples: ["The person responsible will be punished."],
      translation: "İlgili/Oradaki/Karışan kişiler ayrılmaya davet edildi."
    }
  },
  // --- VERBS OF PERCEPTION ---
  {
    ...
    answer: "turn",
    explanation: {
      title: "Verbs of Perception (Complete Action)",
      rule: "Eğer eylemin tamamına şahit olduysak (anahtarı çevirdi ve açtı), fiilin yalın hali (turn) kullanılır. Sadece bir kısmını görseydik 'turning' olurdu.",
      tips: "I saw him do it (Hepsini) | I saw him doing it (Bir kısmını)",
      examples: ["I watched her paint the picture."],
      translation: "Anahtarı çevirip kutuyu açtığını gördüm."
    }
  },
  ...
  // --- ADVANCED COMPARISON ---
  {
    ...
    level: "C2",
    type: "choice",
    question: "It's not _____ much that I'm angry as disappointed.",
    options: ["so", "too", "very", "as"],
    answer: "so",
    explanation: {
      title: "Not so much X as Y",
      rule: "'It is not so much X as Y': X'ten ziyade Y. Durumun öfkeden çok hayal kırıklığı olduğunu belirtir.",
      tips: "I'm not so much tired as bored.",
      examples: ["It wasn't so much a request as a command."],
      translation: "Kızgın olmaktan ziyade hayal kırıklığına uğradım."
    }
  },
  // --- NEGATIVE INVERSION (UNDER NO CIRCUMSTANCES) ---
  {
    ...
    level: "C2",
    type: "choice",
    question: "Under no circumstances _____ you to tell him.",
    options: ["are", "do", "should", "must"],
    answer: "are",
    explanation: {
      title: "Under no circumstances are you to...",
      rule: "'Are/Is to' yapısı zorunluluk/emir belirtir. 'Under no circumstances' ile birleşince devrik olur: 'Are you to...'",
      tips: "You are not to tell him -> Under no circumstances are you to tell him.",
      examples: ["You are to stay here."],
      translation: "Hiçbir koşulda ona söylemeyeceksin (Söylememen emrediliyor)."
    }
  },
  // --- PASSIVE (GET) ---
  {
    ...
    level: "C2",
    type: "choice",
    question: "The window got _____ while the kids were playing.",
    options: ["broken", "broke", "break", "breaking"],
    answer: "broken",
    explanation: {
      title: "Get Passive",
      rule: "'Get + V3' yapısı, 'Be + V3' yerine kullanılan, genellikle kaza, ani olay veya istenmeyen durumları anlatan pasif yapıdır.",
      tips: "It got broken. (Kırıldı)",
      examples: ["He got fired yesterday."],
      translation: "Çocuklar oynarken pencere kırıldı."
    }
  },
  // --- VOCABULARY (PRONE TO) ---
  {
    ...
    level: "C2",
    type: "choice",
    question: "He is _____ to exaggeration.",
    options: ["prone", "bound", "due", "liable"],
    answer: "prone",
    explanation: {
      title: "Prone to",
      rule: "'Prone to', bir şeye (genellikle olumsuz) eğilimli olmak demektir.",
      tips: "Prone to injury / Prone to lying.",
      examples: ["This area is prone to flooding."],
      translation: "O, abartmaya eğilimlidir."
    }
  },
  // --- DOUBLE COMPARATIVE ---
  {
    ...
    level: "C2",
    type: "input",
    question: "The sooner you start, the _____ (soon) you finish.",
    answer: "sooner",
    explanation: {
      title: "Double Comparative",
      rule: "'The + comparative, the + comparative' yapısı. 'Ne kadar erken... o kadar erken...'",
      tips: "The more, the merrier.",
      examples: ["The harder you work, the luckier you get."],
      translation: "Ne kadar erken başlarsan, o kadar erken bitirirsin."
    }
  },
  // --- PASSIVE CAUSATIVE (HAVE) ---
  {
    ...
    level: "C2",
    type: "choice",
    question: "I'll have my assistant _____ you the details.",
    options: ["send", "to send", "sent", "sending"],
    answer: "send",
    explanation: {
      title: "Causative: Have someone DO",
      rule: "'Have someone do something' (birine bir şey yaptırmak) kalıbında fiil yalın haldedir.",
      tips: "Have him call me.",
      examples: ["I had the waiter bring water."],
      translation: "Asistanıma detayları sana göndertirim."
    }
  },
  // --- CONJUNCTION (ALBEIT) ---
  {
    ...
    level: "C2",
    type: "choice",
    question: "He accepted the offer, _____ with some hesitation.",
    options: ["albeit", "despite", "although", "even"],
    answer: "albeit",
    explanation: {
      title: "Albeit",
      rule: "'Albeit', 'although it be' kısaltmasıdır ve 'olsa da' anlamına gelir. Genelde sıfat veya zarf öbekleriyle kullanılır.",
      tips: "Small, albeit expensive. (Küçük ama pahalı)",
      examples: ["It was a difficult, albeit necessary, decision."],
      translation: "Teklifi, biraz tereddütle de olsa kabul etti."
    }
  }
];
QUESTIONS_DB.push(...EXTRA_C2_QUESTIONS);
...
QUESTIONS_DB.push(...EXTRA_B1_QUESTIONS);
...
QUESTIONS_DB.push(...EXTRA_B2_QUESTIONS);
...
QUESTIONS_DB.push(...EXTRA_A2_QUESTIONS);
...
QUESTIONS_DB.push(...EXTRA_A1_QUESTIONS);
const API_URL_BASE = API_BASE_URL;
const useGrammarQuiz = /* @__PURE__ */ __name(() => {
  const navigate = useNavigate();
  const [view, setView] = reactExports.useState("level-select");
  ...
  const [knownQuestions, setKnownQuestions] = reactExports.useState([]);
  ...
  reactExports.useEffect(() => {
    const loadKnownQuestions = /* @__PURE__ */ __name(async () => {
  ...
  const activeQuestions = reactExports.useMemo(() => {
  ...
  const startQuiz = /* @__PURE__ */ __name((levelId) => {
  ...
  const handleCheck = /* @__PURE__ */ __name(() => {
    let userAns = "";
  ...
  const handleMarkKnown = /* @__PURE__ */ __name(async () => {
  ...
  const resetQuiz = /* @__PURE__ */ __name(() => {
...
const LevelSelect = /* @__PURE__ */ __name(({ knownQuestions, startQuiz }) => {
  ...
  const renderLevelCard = /* @__PURE__ */ __name((lvl) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        onClick: /* @__PURE__ */ __name(() => remaining > 0 ? startQuiz(lvl.id) : toast.success("Tebrikler! Bu seviyedeki tüm soruları tamamladın."), "onClick"),
        style: {
          ...styles.levelCard,
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.levelIcon, children: lvl.icon }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.levelName, children: lvl.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.levelCount, children: remaining === 0 ? "Tamamlandı! 🎉" : `${knownInLevel} / ${totalInDb} Tamamlandı` })
        ]
      },
      lvl.id
    );
  }, "renderLevelCard");
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.scrollWrapper, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.container, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.headerArea, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/eng-learn", style: styles.backLink, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(FaArrowLeft, {}),
        " Merkez"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { style: styles.mainTitle, children: "Seviyeni Seç" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: styles.subTitle, children: "Kendini test etmek için bir zorluk seviyesi seç." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.columnsWrapper, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.column, children: colA.map((lvl) => renderLevelCard(lvl)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.column, children: colB.map((lvl) => renderLevelCard(lvl)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.column, children: colC.map((lvl) => renderLevelCard(lvl)) })
    ] })
  ] }) });
}, "LevelSelect");
const QuizResult = /* @__PURE__ */ __name(({ score, totalQuestions, resetQuiz }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.scrollWrapper, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.container, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.resultCard, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(FaTrophy, { size: 60, color: "#faa61a", style: { marginBottom: "20px" } }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { style: styles.resultTitle, children: "Oturum Tamamlandı!" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: styles.resultScore, children: [
      "Skorun: ",
      score,
      " / ",
      totalQuestions
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: styles.resultMessage, children: message }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.resultBtnGroup, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: resetQuiz, style: styles.primaryBtn, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(FaRedo, { style: { marginRight: "8px" } }),
        " Menüye Dön"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/eng-learn", style: styles.secondaryBtn, children: "Merkeze Dön" })
    ] })
  ] }) }) });
}, "QuizResult");
const QuizView = /* @__PURE__ */ __name(({
  currentQuestion,
  currentQuestionIndex,
  totalQuestions,
  progress,
  ...
  if (!currentQuestion) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.container, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.resultCard, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Harika! 🎉" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Bu seviyedeki tüm soruları bitirdin." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: resetQuiz, style: styles.primaryBtn, children: "Geri Dön" })
    ] }) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.scrollWrapper, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.container, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.topBar, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: resetQuiz, style: styles.smallBackBtn, children: [
        "✕",
        " ",
        "Çık"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.progressBarBg, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { ...styles.progressBarFill, width: `${progress}%` } }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.quizBox, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.questionSection, children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { style: styles.questionText, children: currentQuestion.question.split("_____").map((part, i, arr) => /* @__PURE__ */ jsxRuntimeExports.jsxs(React.Fragment, { children: [
        part,
        i < arr.length - 1 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: {
          ...styles.blankSpace,
          borderColor: isAnswered ? isCorrect ? "#43b581" : "#f04747" : "#7289da"
        }, children: isAnswered ? (currentQuestion.type === "choice" ? selectedOption : inputText) || "___" : "_____" })
      ] }, i)) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.interactionArea, children: [
        currentQuestion.type === "choice" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.optionsGrid, children: currentQuestion.options.map((opt, idx) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: /* @__PURE__ */ __name(() => !isAnswered && setSelectedOption(opt), "onClick"), style: btnStyle, disabled: isAnswered, children: opt }, idx);
        }) }),
        currentQuestion.type === "input" && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            type: "text",
            value: inputText,
            onChange: /* @__PURE__ */ __name((e) => setInputText(e.target.value), "onChange"),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.footer, children: !isAnswered ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.actionButtonGroup, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: handleMarkKnown, style: styles.knownBtn, title: "Bunu biliyorum, bir daha sorma", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(FaCheckDouble, {}),
          " Biliyorum (Geç)"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: handleCheck, style: styles.checkBtn, disabled: currentQuestion.type === "choice" ? !selectedOption : !inputText, children: "KONTROL ET" })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: "10px", marginBottom: "15px" }, children: [
          isCorrect ? /* @__PURE__ */ jsxRuntimeExports.jsx(FaCheckCircle, { size: 28, color: "#43b581" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(FaTimesCircle, { size: 28, color: "#f04747" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { style: { fontSize: "1.2em", color: isCorrect ? "#43b581" : "#f04747", display: "block" }, children: isCorrect ? "Doğru Cevap!" : "Yanlış Cevap" }),
            !isCorrect && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { color: "#dbdee1", fontSize: "0.9em" }, children: [
              "Doğrusu: ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { style: { color: "#43b581" }, children: currentQuestion.answer })
            ] })
          ] })
        ] }),
        currentQuestion.explanation && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.explanationContainer, children: [
          currentQuestion.explanation.title && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.expTitle, children: [
            "📖",
            " ",
            currentQuestion.explanation.title
          ] }),
          currentQuestion.explanation.translation && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.expTranslation, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("em", { children: [
            '"',
            currentQuestion.explanation.translation,
            '"'
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.separator }),
          currentQuestion.explanation.rule && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.expSection, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { style: { color: "#f0b232" }, children: "Kural:" }),
            " ",
            currentQuestion.explanation.rule
          ] }),
          currentQuestion.explanation.tips && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.expSection, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("strong", { style: { color: "#00a8fc" }, children: [
              "İ",
              "pucu:"
            ] }),
            " ",
          ...
          currentQuestion.explanation.examples && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { ...styles.expSection, marginTop: "10px" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("strong", { style: { color: "#dbdee1", display: "block", marginBottom: 3 }, children: [
              "Ö",
              "rnekler:"
            ] }),
            currentQuestion.explanation.examples.map((ex, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.exampleItem, children: [
              "•",
              " ",
              ex
            ] }, i))
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", gap: "10px" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: handleNext, style: isCorrect ? styles.nextBtnCorrect : styles.nextBtnWrong, children: currentQuestionIndex + 1 === totalQuestions ? "BİTİR VE SONUÇLARI GÖR" : "DEVAM ET" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: handleMarkKnown, style: styles.feedbackKnownBtn, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(FaCheckDouble, {}),
            " Bunu aslında biliyordum (Öğrenildi Say)"
          ] })
        ] })
      ] }) })
    ] })
...
const GrammarQuizPage = /* @__PURE__ */ __name(() => {
  const quiz = useGrammarQuiz();
  if (quiz.isLoading) return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.container, children: "Yükleniyor..." });
  if (quiz.view === "level-select") return /* @__PURE__ */ jsxRuntimeExports.jsx(LevelSelect, { knownQuestions: quiz.knownQuestions, startQuiz: quiz.startQuiz });
  if (quiz.view === "result") return /* @__PURE__ */ jsxRuntimeExports.jsx(QuizResult, { score: quiz.score, totalQuestions: quiz.totalQuestions, resetQuiz: quiz.resetQuiz });
  return /* @__PURE__ */ jsxRuntimeExports.jsx(QuizView, { ...quiz });
}, "GrammarQuizPage");
export {
  GrammarQuizPage as default
};
