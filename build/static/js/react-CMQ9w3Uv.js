...
const _SpotifyAudioElement = class _SpotifyAudioElement extends (globalThis.HTMLElement ?? class {
}) {
  constructor() {
    super();
...
__name(_SpotifyAudioElement, "SpotifyAudioElement");
__publicField(_SpotifyAudioElement, "getTemplateHTML", getTemplateHTML);
__publicField(_SpotifyAudioElement, "shadowRootOptions", { mode: "open" });
__publicField(_SpotifyAudioElement, "observedAttributes", [
  "controls",
  "loop",
  "src"
]);
let SpotifyAudioElement = _SpotifyAudioElement;
...
async function loadScript(src, globalName, readyFnName) {
  ...
  return loadScriptCache[src] = new Promise(function(resolve, reject) {
    ...
    script.src = src;
    const ready = /* @__PURE__ */ __name((api) => resolve(api), "ready");
