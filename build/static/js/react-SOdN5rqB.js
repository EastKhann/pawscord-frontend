...
import { M as MediaTracksMixin, C as CustomVideoElement } from "./mixin-CIU_olEC.js";
const _DashVideoElement = class _DashVideoElement extends MediaTracksMixin(CustomVideoElement) {
  constructor() {
    super(...arguments);
  ...
  async _initThumbnails(representation) {
    const generateAllCues = /* @__PURE__ */ __name(async (totalThumbnails2, thumbnailDuration2) => {
      const promises = [];
  ...
  async load() {
    ...
    const Dash = await __vitePreload(() => import("./dash.all.min-DisamRsx.js"), true ? [] : void 0);
...
__name(_DashVideoElement, "DashVideoElement");
__publicField(_DashVideoElement, "shadowRootOptions", { ...CustomVideoElement.shadowRootOptions });
__publicField(_DashVideoElement, "getTemplateHTML", /* @__PURE__ */ __name((attrs) => {
  const { src, ...rest } = attrs;
  return CustomVideoElement.getTemplateHTML(rest);
}, "getTemplateHTML"));
let DashVideoElement = _DashVideoElement;
...
__name(calculateThumbnailTimes, "calculateThumbnailTimes");
...
__name(calculateThumbnailStartTime, "calculateThumbnailStartTime");
...
__name(createThumbnailTrack, "createThumbnailTrack");
...
__name(cuesToVttBlobUrl, "cuesToVttBlobUrl");
