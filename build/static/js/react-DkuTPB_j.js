...
function _regeneratorRuntime() {
  ...
  function AsyncIterator(generator, PromiseImpl) {
    ...
    defineProperty(this, "_invoke", {
      value: /* @__PURE__ */ __name(function(method, arg) {
...
__name(isVimeoUrl, "isVimeoUrl");
function isVimeoEmbed(url) {
  var expr = /^https:\/\/player\.((vimeo\.com)|([a-zA-Z0-9-]+\.(videoji\.(hk|cn)|vimeo\.work)))\/video\/\d+/;
  return expr.test(url);
}
__name(isVimeoEmbed, "isVimeoEmbed");
...
__name(getOembedDomain, "getOembedDomain");
...
__name(getVimeoUrl, "getVimeoUrl");
var subscribe = /* @__PURE__ */ __name(function subscribe2(target, eventName, callback) {
...
(function(self2) {
  ...
  var defineProperty = /* @__PURE__ */ __name(function(object, name, value) {
    if (hasDefine) {
...
var npo_src = createCommonjsModule(function(module) {
  (/* @__PURE__ */ __name((function UMD(name, context, definition) {
    context[name] = context[name] || definition();
    if (module.exports) {
      module.exports = context[name];
    }
  }), "UMD"))("Promise", typeof commonjsGlobal != "undefined" ? commonjsGlobal : commonjsGlobal, /* @__PURE__ */ __name(function DEF() {
    var builtInProp, cycle, scheduling_queue, ToString = Object.prototype.toString, timer = typeof setImmediate != "undefined" ? /* @__PURE__ */ __name(function timer2(fn) {
      return setImmediate(fn);
    }, "timer") : setTimeout;
    try {
      Object.defineProperty({}, "x", {});
      builtInProp = /* @__PURE__ */ __name(function builtInProp2(obj, name, val, config) {
      ...
      builtInProp = /* @__PURE__ */ __name(function builtInProp2(obj, name, val) {
        obj[name] = val;
        return obj;
      }, "builtInProp");
    }
    scheduling_queue = (/* @__PURE__ */ __name(function Queue() {
      var first, last, item;
      ...
      __name(Item, "Item");
      return {
        add: /* @__PURE__ */ __name(function add(fn, self2) {
        ...
        drain: /* @__PURE__ */ __name(function drain() {
          var f = first;
    ...
    __name(notifyIsolated, "notifyIsolated");
      ...
      try {
        if (_then = isThenable(msg)) {
          schedule(function() {
            ...
            try {
              _then.call(msg, /* @__PURE__ */ __name(function $resolve$() {
                resolve.apply(def_wrapper, arguments);
              }, "$resolve$"), /* @__PURE__ */ __name(function $reject$() {
    ...
    function iteratePromises(Constructor, arr, resolver, rejecter) {
      for (var idx = 0; idx < arr.length; idx++) {
        (/* @__PURE__ */ __name((function IIFE(idx2) {
          Constructor.resolve(arr[idx2]).then(/* @__PURE__ */ __name(function $resolver$(msg) {
            resolver(idx2, msg);
          }, "$resolver$"), rejecter);
        }), "IIFE"))(idx);
      }
    }
    __name(iteratePromises, "iteratePromises");
    function MakeDefWrapper(self2) {
      this.def = self2;
      this.triggered = false;
    }
    __name(MakeDefWrapper, "MakeDefWrapper");
    ...
    function Promise2(executor) {
      ...
      this["then"] = /* @__PURE__ */ __name(function then(success, failure) {
        var o = {
          success: typeof success == "function" ? success : true,
          failure: typeof failure == "function" ? failure : false
        };
        o.promise = new this.constructor(/* @__PURE__ */ __name(function extractChain(resolve2, reject2) {
      ...
      this["catch"] = /* @__PURE__ */ __name(function $catch$(failure) {
        return this.then(void 0, failure);
      }, "$catch$");
      try {
        executor.call(void 0, /* @__PURE__ */ __name(function publicResolve(msg) {
          resolve.call(def, msg);
        }, "publicResolve"), /* @__PURE__ */ __name(function publicReject(msg) {
          reject.call(def, msg);
        }, "publicReject"));
      } catch (err) {
        reject.call(def, err);
    ...
    builtInProp(Promise2, "resolve", /* @__PURE__ */ __name(function Promise$resolve(msg) {
      var Constructor = this;
      if (msg && typeof msg == "object" && msg.__NPO__ === 1) {
        return msg;
      }
      return new Constructor(/* @__PURE__ */ __name(function executor(resolve2, reject2) {
        if (typeof resolve2 != "function" || typeof reject2 != "function") {
          throw TypeError("Not a function");
        }
        resolve2(msg);
    ...
    builtInProp(Promise2, "reject", /* @__PURE__ */ __name(function Promise$reject(msg) {
      return new this(/* @__PURE__ */ __name(function executor(resolve2, reject2) {
        if (typeof resolve2 != "function" || typeof reject2 != "function") {
          throw TypeError("Not a function");
        }
        reject2(msg);
    ...
    builtInProp(Promise2, "all", /* @__PURE__ */ __name(function Promise$all(arr) {
      var Constructor = this;
      ...
      return new Constructor(/* @__PURE__ */ __name(function executor(resolve2, reject2) {
        ...
        iteratePromises(Constructor, arr, /* @__PURE__ */ __name(function resolver(idx, msg) {
          msgs[idx] = msg;
          if (++count === len) {
            resolve2(msgs);
          }
    ...
    builtInProp(Promise2, "race", /* @__PURE__ */ __name(function Promise$race(arr) {
      var Constructor = this;
      if (ToString.call(arr) != "[object Array]") {
        return Constructor.reject(TypeError("Not an array"));
      }
...
__name(getCallbacks, "getCallbacks");
...
__name(shiftCallbacks, "shiftCallbacks");
function swapCallbacks(oldElement, newElement) {
  var playerCallbacks = callbackMap.get(oldElement);
  callbackMap.set(newElement, playerCallbacks);
  callbackMap.delete(oldElement);
}
__name(swapCallbacks, "swapCallbacks");
...
__name(getOEmbedParameters, "getOEmbedParameters");
...
__name(getOEmbedData, "getOEmbedData");
function initializeEmbeds() {
  var parent = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : document;
  var elements = [].slice.call(parent.querySelectorAll("[data-vimeo-id], [data-vimeo-url]"));
  var handleError = /* @__PURE__ */ __name(function handleError2(error) {
...
__name(initializeEmbeds, "initializeEmbeds");
function resizeEmbeds() {
  ...
  var onMessage = /* @__PURE__ */ __name(function onMessage2(event) {
...
__name(resizeEmbeds, "resizeEmbeds");
...
__name(initAppendVideoMetadata, "initAppendVideoMetadata");
...
__name(checkUrlTimeParam, "checkUrlTimeParam");
function initializeScreenfull() {
  ...
  var screenfull2 = {
    request: /* @__PURE__ */ __name(function request(element) {
      return new Promise(function(resolve, reject) {
        var onFullScreenEntered = /* @__PURE__ */ __name(function onFullScreenEntered2() {
    ...
    exit: /* @__PURE__ */ __name(function exit() {
      return new Promise(function(resolve, reject) {
        if (!screenfull2.isFullscreen) {
          resolve();
          return;
        }
        var onFullScreenExit = /* @__PURE__ */ __name(function onFullScreenExit2() {
    ...
    on: /* @__PURE__ */ __name(function on(event, callback) {
      var eventName = eventNameMap[event];
      if (eventName) {
        document.addEventListener(eventName, callback);
      }
    }, "on"),
    off: /* @__PURE__ */ __name(function off(event, callback) {
      var eventName = eventNameMap[event];
      if (eventName) {
...
__name(initializeScreenfull, "initializeScreenfull");
var defaultOptions = {
  role: "viewer",
  autoPlayMuted: true,
  allowedDrift: 0.3,
...
var TimingSrcConnector = /* @__PURE__ */ (function(_EventTarget) {
  ...
  function TimingSrcConnector2(_player, timingObject) {
    ...
    _defineProperty(_assertThisInitialized(_this), "adjustSpeed", /* @__PURE__ */ (function() {
      var _ref = _asyncToGenerator(/* @__PURE__ */ _regeneratorRuntime().mark(/* @__PURE__ */ __name(function _callee(player, newAdjustment) {
        var newPlaybackRate;
  ...
  __name(TimingSrcConnector2, "TimingSrcConnector");
  _createClass(TimingSrcConnector2, [{
    key: "disconnect",
    value: /* @__PURE__ */ __name(function disconnect() {
    ...
    key: "init",
    value: (function() {
      var _init = _asyncToGenerator(/* @__PURE__ */ _regeneratorRuntime().mark(/* @__PURE__ */ __name(function _callee2(timingObject, player, options) {
        var _this2 = this;
    ...
    value: (function() {
      var _updateTimingObject = _asyncToGenerator(/* @__PURE__ */ _regeneratorRuntime().mark(/* @__PURE__ */ __name(function _callee3(timingObject, player) {
      ...
      __name(updateTimingObject, "updateTimingObject");
    ...
    key: "updatePlayer",
    value: (function() {
      var _updatePlayer = _asyncToGenerator(/* @__PURE__ */ _regeneratorRuntime().mark(/* @__PURE__ */ __name(function _callee5(timingObject, player, options) {
          ...
          while (1) switch (_context5.prev = _context5.next) {
            ...
            case 14:
              ...
              return player.play().catch(/* @__PURE__ */ (function() {
                var _ref2 = _asyncToGenerator(/* @__PURE__ */ _regeneratorRuntime().mark(/* @__PURE__ */ __name(function _callee4(err) {
    ...
    value: /* @__PURE__ */ __name(function maintainPlaybackPosition(timingObject, player, options) {
      var _this3 = this;
      ...
      var check = /* @__PURE__ */ (function() {
        var _ref3 = _asyncToGenerator(/* @__PURE__ */ _regeneratorRuntime().mark(/* @__PURE__ */ __name(function _callee6() {
    ...
    value: (
       ...
       * @return {Promise<void>}
       */
      /* @__PURE__ */ __name(function waitForTOReadyState(timingObject, state) {
        return new Promise(function(resolve) {
          var check = /* @__PURE__ */ __name(function check2() {
...
var Player = /* @__PURE__ */ (function() {
  function Player2(element) {
    ...
    if (screenfull.isEnabled) {
      var exitFullscreen = /* @__PURE__ */ __name(function exitFullscreen2() {
  ...
  _createClass(Player2, [{
    key: "callMethod",
    value: /* @__PURE__ */ __name(function callMethod(name) {
      var _this2 = this;
    ...
    key: "get",
    value: /* @__PURE__ */ __name(function get(name) {
      var _this3 = this;
      return new npo_src(function(resolve, reject) {
    ...
    key: "set",
    value: /* @__PURE__ */ __name(function set(name, value) {
      var _this4 = this;
      return new npo_src(function(resolve, reject) {
    ...
    key: "on",
    value: /* @__PURE__ */ __name(function on(eventName, callback) {
      if (!eventName) {
    ...
    key: "off",
    value: /* @__PURE__ */ __name(function off(eventName, callback) {
      if (!eventName) {
        throw new TypeError("You must pass an event name.");
      }
    ...
    key: "loadVideo",
    value: /* @__PURE__ */ __name(function loadVideo(options) {
    ...
    key: "addCuePoint",
    value: /* @__PURE__ */ __name(function addCuePoint(time) {
    ...
    key: "removeCuePoint",
    value: /* @__PURE__ */ __name(function removeCuePoint(id) {
    ...
    key: "enableTextTrack",
    value: /* @__PURE__ */ __name(function enableTextTrack(language, kind) {
      if (!language) {
    ...
    value: /* @__PURE__ */ __name(function disableTextTrack() {
    ...
    value: /* @__PURE__ */ __name(function requestFullscreen() {
      if (screenfull.isEnabled) {
    ...
    key: "exitFullscreen",
    value: /* @__PURE__ */ __name(function exitFullscreen() {
      if (screenfull.isEnabled) {
        return screenfull.exit();
      }
    ...
    key: "getFullscreen",
    value: /* @__PURE__ */ __name(function getFullscreen() {
      if (screenfull.isEnabled) {
    ...
    value: /* @__PURE__ */ __name(function requestPictureInPicture() {
    ...
    value: /* @__PURE__ */ __name(function exitPictureInPicture() {
    ...
    value: /* @__PURE__ */ __name(function getPictureInPicture() {
    ...
    value: /* @__PURE__ */ __name(function remotePlaybackPrompt() {
    ...
    key: "unload",
    value: /* @__PURE__ */ __name(function unload() {
    ...
    key: "getAutopause",
    value: /* @__PURE__ */ __name(function getAutopause() {
    ...
    key: "setAutopause",
    value: /* @__PURE__ */ __name(function setAutopause(autopause) {
    ...
    key: "getBuffered",
    value: /* @__PURE__ */ __name(function getBuffered() {
    ...
    key: "getCameraProps",
    value: /* @__PURE__ */ __name(function getCameraProps() {
    ...
    key: "setCameraProps",
    value: /* @__PURE__ */ __name(function setCameraProps(camera) {
    ...
    key: "getChapters",
    value: /* @__PURE__ */ __name(function getChapters() {
    ...
    value: /* @__PURE__ */ __name(function getCurrentChapter() {
    ...
    key: "getColor",
    value: /* @__PURE__ */ __name(function getColor() {
    ...
    key: "setColor",
    value: /* @__PURE__ */ __name(function setColor(color) {
    ...
    key: "setColors",
    value: /* @__PURE__ */ __name(function setColors(colors) {
    ...
    key: "getCuePoints",
    value: /* @__PURE__ */ __name(function getCuePoints() {
    ...
    key: "setCurrentTime",
    value: /* @__PURE__ */ __name(function setCurrentTime(currentTime) {
    ...
    key: "getEnded",
    value: /* @__PURE__ */ __name(function getEnded() {
    ...
    key: "getLoop",
    value: /* @__PURE__ */ __name(function getLoop() {
    ...
    key: "setMuted",
    value: /* @__PURE__ */ __name(function setMuted(muted) {
    ...
    key: "getMuted",
    value: /* @__PURE__ */ __name(function getMuted() {
    ...
    key: "getPaused",
    value: /* @__PURE__ */ __name(function getPaused() {
    ...
    key: "getPlaybackRate",
    value: /* @__PURE__ */ __name(function getPlaybackRate() {
    ...
    key: "setPlaybackRate",
    value: /* @__PURE__ */ __name(function setPlaybackRate(playbackRate) {
    ...
    key: "getPlayed",
    value: /* @__PURE__ */ __name(function getPlayed() {
    ...
    key: "getQualities",
    value: /* @__PURE__ */ __name(function getQualities() {
    ...
    key: "getQuality",
    value: /* @__PURE__ */ __name(function getQuality() {
    ...
    key: "setQuality",
    value: /* @__PURE__ */ __name(function setQuality(quality) {
    ...
    value: /* @__PURE__ */ __name(function getRemotePlaybackAvailability() {
    ...
    value: /* @__PURE__ */ __name(function getRemotePlaybackState() {
    ...
    key: "getSeekable",
    value: /* @__PURE__ */ __name(function getSeekable() {
    ...
    key: "getSeeking",
    value: /* @__PURE__ */ __name(function getSeeking() {
    ...
    key: "getTextTracks",
    value: /* @__PURE__ */ __name(function getTextTracks() {
    ...
    value: /* @__PURE__ */ __name(function getVideoEmbedCode() {
    ...
    key: "getVideoId",
    value: /* @__PURE__ */ __name(function getVideoId() {
    ...
    key: "getVideoTitle",
    value: /* @__PURE__ */ __name(function getVideoTitle() {
    ...
    key: "getVideoWidth",
    value: /* @__PURE__ */ __name(function getVideoWidth() {
    ...
    key: "getVideoHeight",
    value: /* @__PURE__ */ __name(function getVideoHeight() {
    ...
    key: "getVideoUrl",
    value: /* @__PURE__ */ __name(function getVideoUrl() {
    ...
    key: "getVolume",
    value: /* @__PURE__ */ __name(function getVolume() {
    ...
    key: "setVolume",
    value: /* @__PURE__ */ __name(function setVolume(volume) {
    ...
    key: "setTimingSrc",
    value: (function() {
      var _setTimingSrc = _asyncToGenerator(/* @__PURE__ */ _regeneratorRuntime().mark(/* @__PURE__ */ __name(function _callee(timingObject, options) {
        var _this6 = this;
        var connector;
        return _regeneratorRuntime().wrap(/* @__PURE__ */ __name(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
      ...
      __name(setTimingSrc, "setTimingSrc");
      return setTimingSrc;
    })()
  }]);
  return Player2;
...
__name(serializeIframeUrl, "serializeIframeUrl");
const _VimeoVideoElement = class _VimeoVideoElement extends (globalThis.HTMLElement ?? class {
}) {
  constructor() {
    super();
  ...
  async load() {
    ...
    const onLoaded = /* @__PURE__ */ __name(async () => {
    ...
    const onceLoaded = /* @__PURE__ */ __name(() => {
...
__name(_VimeoVideoElement, "VimeoVideoElement");
__publicField(_VimeoVideoElement, "getTemplateHTML", getTemplateHTML);
__publicField(_VimeoVideoElement, "shadowRootOptions", { mode: "open" });
__publicField(_VimeoVideoElement, "observedAttributes", [
  "autoplay",
  "controls",
  "crossorigin",
  "loop",
...
let VimeoVideoElement = _VimeoVideoElement;
...
__name(boolToBinary, "boolToBinary");
...
__name(createTimeRanges, "createTimeRanges");
function createTimeRangesObj(ranges) {
  Object.defineProperties(ranges, {
    start: {
      value: /* @__PURE__ */ __name((i) => ranges[i][0], "value")
    },
    end: {
      value: /* @__PURE__ */ __name((i) => ranges[i][1], "value")
    }
  });
  return ranges;
}
__name(createTimeRangesObj, "createTimeRangesObj");
